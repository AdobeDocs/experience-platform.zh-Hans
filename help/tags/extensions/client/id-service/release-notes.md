...
本文档介绍了Adobe Experience Cloud Identity服务标签扩展的发行说明。 有关Experience CloudIdentity服务本身的发行说明，请参阅 [Identity Service文档](https://experienceleague.adobe.com/docs/id-service/using/release-notes/release-notes.html).

## 2022年10月17日

### Experience Cloud ID 扩展 5.5.0

* 扩展现在支持版本5.5.0的 [访客JS客户端](https://github.com/Adobe-Marketing-Cloud/id-service). 请参阅 [访客发行说明](https://github.com/Adobe-Marketing-Cloud/id-service/releases/tag/5.5.0) 以获取特定更新。
...
* 此版本包含最新的访客5.4.0，该版本具有以下更新：
   ...
   * 能够配置以下项的生命周期： `s_ecid` 使用cookieLifetime配置的Cookie
...
* 此版本包含最新的访客5.3.0，该版本具有以下新更新：
   ...
   * 更新了生成本地ECID的算法
   * 最新的选择加入，包含 `Secure` 和 `SameSite` 隐私Cookie的标记
...
* 在收到同意时，无法更新到VisitorJS 5.2.0修补程序并修复了ECID DataElement。
