...
Adobe Experience Platform Web SDK扩展通过Adobe Experience PlatformEdge Network，从Web资产向Adobe Experience Cloud发送数据。 Platform Web SDK扩展允许将数据流式传输到平台、同步身份、选择加入和自动收集上下文数据。
