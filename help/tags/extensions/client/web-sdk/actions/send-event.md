...
* **呈现可视化个性化决策：**&#x200B;一个复选框，启用后可让您在页面上呈现个性化内容。 有关详细信息，请参阅[渲染个性化内容](/help/collection/use-cases/personalization/rendering-personalization-content.md#automatically-rendering-content)。
