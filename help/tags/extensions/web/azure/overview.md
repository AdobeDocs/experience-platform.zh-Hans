...
![的 [!UICONTROL 安装] 按钮 [!UICONTROL Microsoft Azure] 扩展。](../../../images/extensions/azure/install.png)
...
![的 [!UICONTROL 将数据发送到事件中心] 在数据收集UI中为规则选择的操作类型。](../../../images/extensions/azure/select-action-type.png)

右侧面板会进行更新，以显示应如何发送数据的配置选项。 具体而言，您必须分配 [数据元素](../../../ui/managing-resources/data-elements.md) 到代表您 [!DNL Event Hub] 配置。

![的配置选项 [!UICONTROL 将数据发送到事件中心] UI中显示的操作类型。](../../../images/extensions/azure/event-hub-details.png)
