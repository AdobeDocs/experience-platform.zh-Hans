...
![的 [!UICONTROL 发送事件] 操作类型。](../../../images/extensions/google-ads-enhanced-conversions/select-client-action.png)
...
![的 [!UICONTROL 发送转化] 操作类型。](../../../images/extensions/google-ads-enhanced-conversions/select-server-action.png)
