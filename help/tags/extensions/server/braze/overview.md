...
| 键类型 | 描述 | 示例 |
| --- | --- | --- |
| [!DNL Braze] 实例 | 与关联的REST端点 [!DNL Braze] 帐户。 请参阅 [!DNL Braze] 相关文档 [实例](https://www.braze.com/docs/user_guide/administrative/access_braze/sdk_endpoints) 以获取指导。 | `https://rest.iad-03.braze.com` |
