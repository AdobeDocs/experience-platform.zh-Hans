...
使用[!DNL Algolia]事件转发扩展通过[!DNL Algolia]向[!DNL Insights API]发送用户行为事件。 此行为数据支持由AI提供支持的推荐、个性化体验和智能搜索功能。

## 先决条件 {#prerequisites}

在安装扩展之前，请确保您拥有有权访问[!DNL Algolia]的[!DNL Insights API]帐户。 如果您没有帐户，请[注册](https://dashboard.algolia.com/users/sign_up)并启用对API的访问权限。
...
在&#x200B;**[!UICONTROL Data Collection]**&#x200B;中导航到[!DNL Adobe Experience Platform]。 选择 **[!UICONTROL Extensions]** 选项卡。

打开&#x200B;**[!UICONTROL Catalog]**&#x200B;并找到&#x200B;**[!UICONTROL Algolia Event Forwarding]**&#x200B;扩展，然后选择&#x200B;**[!UICONTROL Install]**。
...
要配置[!DNL Algolia]事件转发扩展，请导航到&#x200B;**[!UICONTROL Extensions]**&#x200B;选项卡，选择&#x200B;**[!UICONTROL Algolia]**&#x200B;扩展，然后选择&#x200B;**[!UICONTROL Configure]**。

Adobe Experience Platform中的Algolia事件转发扩展的![配置屏幕](../../../images/extensions/server/algolia/configure.png)

| 属性 | 描述 |
|----------|-------------|
| **[!UICONTROL Application ID]** | 输入在Algolia仪表板的[!UICONTROL Application ID]API密钥[部分中找到的](https://www.algolia.com/account/api-keys/all)。 |
| **[!UICONTROL Search API Key]** | 输入在Algolia仪表板的[!UICONTROL Search API Key]API密钥[部分中找到的](https://www.algolia.com/account/api-keys/all)。 |
| **[!UICONTROL Index Name]** | 输入包含您的产品或内容的[!UICONTROL Index Name]。 此索引用作默认值。 |
...
配置&#x200B;**[!UICONTROL Send event]**&#x200B;操作以将事件转发到[!DNL Algolia]：

选择&#x200B;**[!UICONTROL Rules]** > **[!UICONTROL Add Rule]**&#x200B;或选择现有规则。 在规则的&#x200B;**[!UICONTROL Then]**&#x200B;部分中，添加操作并选择&#x200B;**[!UICONTROL Extension]**： [!DNL Algolia]事件转发> **[!UICONTROL Action Type]**： **[!UICONTROL Send Events]**。
...
### 使用[!UICONTROL Data Collection]标记映射和发送数据
...
1. 使用[!UICONTROL Data Element]创建&#x200B;**[!DNL Adobe Experience Platform Web SDK]**。
2. 选择&#x200B;**[!UICONTROL XDM object]**&#x200B;作为数据元素类型。
...
4. 选择&#x200B;**[!UICONTROL Send event]**&#x200B;作为操作类型。
...
导航到您的[!DNL Algolia]仪表板并转到&#x200B;**[!UICONTROL Data Sources > Events > Debugger]**。
...
- **验证API凭据**：确保&#x200B;**[!UICONTROL Application ID]**&#x200B;和&#x200B;**[!UICONTROL API Key]**&#x200B;与[!DNL Algolia]仪表板中的值匹配。
...
本指南介绍了如何使用[!DNL Algolia]将数据发送到[!DNL Algolia Event Forwarding Extension]。 有关[!DNL Adobe Experience Platform]中事件转发功能的详细信息，请阅读[事件转发概述](../../../ui/event-forwarding/overview.md)。
