...
| [!UICONTROL OAuth2] | 包含多个属性以支持 [OAuth2](https://datatracker.ietf.org/doc/html/rfc6749) 验证规范。 系统会要求您提供所需信息，然后在指定的间隔内为您处理这些令牌的续订。 当前仅 [客户端凭据](https://datatracker.ietf.org/doc/html/rfc6749#section-1.3.4) 支持OAuth2版本。 |
...
要创建OAuth2密钥，请选择 **[!UICONTROL OAuth2]** 从 **[!UICONTROL 类型]** 下拉列表。 在下面显示的字段中，提供 [[!UICONTROL 客户端ID] 和 [!UICONTROL 客户端密钥]](https://www.oauth.com/oauth2-servers/client-registration/client-id-secret/)，以及 [授权URL](https://www.oauth.com/oauth2-servers/access-tokens/client-credentials/) 的OAuth集成。 的 [!UICONTROL 授权URL] 数据收集UI中的字段是授权服务器主机和令牌路径之间的串联。

![OAuth2密钥](../../images/ui/event-forwarding/secrets/oauth-secret-1.png)
...
![保存OAuth2偏移](../../images/ui/event-forwarding/secrets/oauth-secret-4.png)
