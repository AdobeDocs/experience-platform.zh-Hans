...
>[!NOTE]
>
>有关如何使用Admin Console配置用户权限的步骤，请参阅关于的教程 [管理数据收集的权限](../../../collection/permissions.md).
...
| **管理扩展** | 这允许您执行以下操作： <ul><li>将新扩展安装到资产</li><li>修改已安装扩展的配置</li><li>删除扩展</li></ul>请参阅扩展概述文档，了解 [有关扩展的更多信息](../managing-resources/extensions/overview.md). 此角色通常属于 IT 或营销组，具体取决于您的组织。 |
| **管理环境** | 这允许您创建和修改环境。 请参阅 [环境文档](../publishing/environments.md) 了解更多信息。 此角色通常属于 IT 组。 |
...
| 公司权限 | 描述 |
| --- | --- |
| **管理资产** | 这允许您执行以下操作：<ul><li>创建新属性</li><li>修改属性级别的元数据和设置</li><li>删除属性</li></ul>管理员通常执行此角色。请参阅 [属性文档](companies-and-properties.md) 了解更多信息。 |
...
1. 如果该顾问需要新扩展或准备就绪，贵组织的代表（拥有适当的权限）将执行这些操作。
...
| IT 团队 | 实际上不会修改任何标记，但他们可以完全控制暂存环境和生产环境以及其中的内容。 | 自动包含 | (None) | <ul><li>批准</li><li>发布</li><li>管理环境</li></ul> |
...
本文档概述了Experience Platform中标记可用的权限。 有关如何为Adobe Admin Console中的标记配置产品配置文件的步骤，请参阅 [管理数据收集的用户权限](../../../collection/permissions.md).
