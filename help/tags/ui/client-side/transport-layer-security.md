...
传输层安全性(TLS)是一种加密协议，为通过Internet在应用程序之间发送的数据提供端到端的安全性。 有关TLS的更多详细信息，请参阅 [TLS基础知识](https://www.internetsociety.org/deploy360/tls/basics/) 文档。

Adobe Experience Platform中的标记是一个标记管理系统，旨在动态地在您的网站上加载脚本。 TLS保护Adobe主机之间的通信 `assets.adobedtm.com` 和您的网站上的源代码。
...
如果您是 [自托管](../publishing/hosts/self-hosting-libraries.md) 到您的库，则支持的TLS版本将取决于您自己的托管服务。
