...
* [扩展教程视频](https://youtu.be/rxjtC9o4rl0)是一个非常好的入手点。
...
您可以使用此[请求表单](https://docs.google.com/forms/d/e/1FAIpQLScq1m63YkDrRpvPLhzUqtfoleWiDDTTXZsSivIXRfFdlSMzpQ/viewform)来请求访问Slack社区工作区，扩展作者可以在该工作区中相互提供支持。

**请注意**：尽管此Slack工作区中有Adobe成员，但它不是由Adobe赞助或管理的Community资源。
