...
* 事件转发 {#event-forwarding}
   ...
   * [监控（测试版）](./ui/event-forwarding/monitoring.md)
* 管理 {#admin}
...
* 扩展 {#extensions}
   ...
   * Adobe 扩展 {#adobe}
      ...
      * AdobeContextHub {#contexthub}
         * [概述](./extensions/web/contexthub/overview.md)
      ...
      * 常用Web SDK插件 {#web-sdk-plugins}
         * [概述](./extensions/web/web-sdk-plugins/overview.md)
         * [发行说明](./extensions/web/web-sdk-plugins/release-notes.md)
      * 核心 {#core}
...
* 扩展开发 {#extension-dev}
   ...
   * 提交流程 {#submit}
      ...
      * [公司设置](./extension-dev/submit/setup.md)
...
* Reactor API {#api}
   ...
   * 指南 {#guides}
      ...
      * [将响应分页](./api/guides/pagination.md)
