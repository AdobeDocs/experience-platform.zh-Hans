...
* 事件转发 {#event-forwarding}
   ...
   * [引导式设置](./ui/event-forwarding/guided-setup.md)
...
* 扩展 {#extensions}
   ...
   * 标记扩展（客户端） {#client}
      ...
      * Adobe Content Analytics {#content-analytics}
         ...
         * [发行说明](./extensions/client/content-analytics/release-notes.md)
      ...
      * Adobe Experience Platform Web SDK {#web-sdk}
         ...
         * 配置 {#configure}
            ...
            * [构建选项](extensions/client/web-sdk/configure/custom-build-components.md)
      ...
      * [!DNL Algolia]分析 {#algolia-insights}
         * [概述](./extensions/client/algolia/overview.md)
   ...
   * 事件转发扩展（服务器端） {#server}
      ...
      * Adobe Experience Platform云连接器 {#cloud-connector}
         ...
         * [mTLS证书](./extensions/server/cloud-connector/mtls.md)
      ...
      * [!DNL Nextdoor] {#nextdoor}
         * [概述](./extensions/server/nextdoor/overview.md)
...
* 扩展开发 {#extension-dev}
   ...
   * [共享专用扩展](./extension-dev/shared-private-extensions.md)
* Reactor API {#api}
   * [概述](./api/overview.md)
