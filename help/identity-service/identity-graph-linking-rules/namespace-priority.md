...
* 有关详细信息，请阅读[Adobe Experience Platform和应用程序体系结构图](https://experienceleague.adobe.com/zh-hans/docs/blueprints-learn/architecture/architecture-overview/platform-applications#detailed-architecture-diagram)和[Edge Network和中心比较](/help/landing/edge-and-hub-comparison.md)页。
...
* 有关如何在Web SDK上配置主标识的更多信息，请阅读有关数据收集中[数据元素类型](/help/tags/extensions/client/web-sdk/data-element-types.md)和[标识](/help/collection/identity/overview.md)的文档。
