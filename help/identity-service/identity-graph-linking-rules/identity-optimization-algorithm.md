...
![图形层和命名空间优先级。](../images/namespace-priority/graph-layers.png "图形层和命名空间优先级。"){zoomable="yes"}
...
![可视化身份优化算法的图表。](../images/ido_algorithm.png "可视化标识优化算法的图表。"){zoomable="yes"}
...
![共享设备的一个案例。](../images/identity-settings/shared-device-case-one.png "共享设备的一个案例。"){zoomable="yes"}
...
![案例二共享设备。](../images/identity-settings/shared-device-case-two.png "共享设备的案例二。"){zoomable="yes"}
...
![错误电子邮件引入的图表。](../images/identity-settings/bad-email.png "错误电子邮件引入的图表。"){zoomable="yes"}
...
![匿名事件关联图。](../images/identity-settings/anon-event-association.png "匿名事件关联图。"){zoomable="yes"}
