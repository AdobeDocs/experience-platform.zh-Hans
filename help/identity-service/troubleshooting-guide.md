...
当请求路径中为`graph-type`查询参数提供了无效值时，将显示此错误消息。 请参阅[概述中有关](./home.md)身份图[!DNL Identity Service]的部分，了解支持的图形类型。
...
当您的访问令牌不是从[!DNL Experience Platform]集成中生成时，显示此错误消息。 有关为[集成生成新访问令牌的说明，请参阅](https://www.adobe.com/go/platform-api-authentication-en)身份验证教程[!DNL Experience Platform]。
...
以下是使用[!DNL Identity Service]批次摄取API[时可能遇到的与](https://developer.adobe.com/experience-platform-apis/references/batch-ingestion/)相关的错误消息列表。
