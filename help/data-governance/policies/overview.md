...
* **[!UICONTROL Consent policy]**：根据客户的同意或偏好筛选可激活到[目标](../../destinations/home.md)的用户档案

>[!NOTE]
>
>不应将数据使用策略与[访问控制策略](../../access-control/abac/end-to-end-guide.md#policy)混淆，后者用于确定组织中的某些Experience Platform用户是否可以访问某些数据字段，并且是通过[!UICONTROL Permissions]选项卡配置的。
...
| 电子邮件目标选择 | 一个在电子邮件目标选择活动中使用数据的操作。 |
