---
keywords: Experience Platform；主页；热门主题；map csv;map csv;map csv file;map csv文件到xdm;map csv到xdm;ui指南；mapper;date函数；date函数；date函数
solution: Experience Platform
title: 数据准备日期函数
topic: 概述
description: 本文档介绍了数据准备中使用的日期函数。
