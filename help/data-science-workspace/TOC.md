...
* 模型和菜谱教程{#models-recipes}
   ...
   * [导入打包菜谱(API)](models-recipes/import-packaged-recipe-api.md)
   ...
   * [对模型(API)评分](models-recipes/score-model-api.md)
   ...
   * [计划在服务(UI)上自动进行培训和评分](models-recipes/schedule-models-ui.md)
