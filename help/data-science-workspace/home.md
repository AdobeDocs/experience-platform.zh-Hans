...
| 术语 | 定义 |
|---------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [!DNL Data Science Workspace] | [!DNL Data Science Workspace]中的[!DNL Experience Platform]使客户能够利用跨[!DNL Experience Platform]和Adobe解决方案的数据创建机器学习模型，以生成智能见解和预测，从而编织美妙的最终用户数字体验。 |
...
- 使用[!DNL Data Science Workspace]和[!DNL Git]之间可用的身份验证和集成，将在Adobe Experience Platform外部创作的方法上载到[!DNL Git]或从存储库（如[!DNL Data Science Workspace]）导入方法代码。
...
如果您已找到满足所有需求的处方，则可以继续试验。 或者，您可以修改方法一点或从头开始创建方法 — 利用[!DNL Data Science Workspace]中的[!DNL Jupyter Notebook]创作运行时。 使用创作运行时可确保您既可以使用[!DNL Data Science Workspace]培训和评分工作流，又可以稍后转换方法，以便组织中的其他人可以存储并重用它。
