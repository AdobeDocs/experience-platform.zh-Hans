...
在[!DNL JupyterLab]中，您可以终止会话以阻止使用其他资源。 开始，选择&#x200B;**电源图标**，然后从显示以终止您的会话的快门中选择&#x200B;**[!UICONTROL 关闭]**。 笔记本会话在12小时未活动后自动终止。

要重新启动[!DNL JupyterLab]，请选择位于电源图标左侧的&#x200B;**重新启动图标**，然后从显示的跨距中选择&#x200B;**[!UICONTROL 重新启动]**。
