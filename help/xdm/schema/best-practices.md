...
[!DNL Experience Data Model] (XDM)是通过提供在下游Adobe Experience Platform服务中使用的通用结构和定义来标准化客户体验数据的核心框架。 通过遵守XDM标准，所有客户体验数据都可以纳入到通用表示法中，从而使您可以从客户操作中获得有价值的见解，通过区段定义客户受众，以及表达客户属性以进行个性化。
