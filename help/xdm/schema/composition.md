...
| 支持的更改 | 中断更改（不支持） |
| --- | --- |
| <ul><li>向资源添加新字段</li><li>使必填字段为可选字段</li><li>更改资源的显示名称和描述</li></ul> | <ul><li>删除以前定义的字段</li><li>引入新的必填字段</li><li>重命名或重定义现有字段</li><li>删除或限制以前支持的字段值</li><li>将属性移动到树中的其他位置</li></ul> |
