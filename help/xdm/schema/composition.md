...
例如，要捕获详细信息，例如“[!UICONTROL 名字]&quot;和&quot;[!UICONTROL 家庭地址]“”[!UICONTROL 忠诚会员]“架构中，您将能够使用标准字段组来定义这些常用概念。 但是，标准字段组可能未涵盖的对贵组织更具体的概念（例如自定义忠诚度计划详细信息或产品属性）。 在这种情况下，您必须定义自己的字段组才能捕获此信息。
