---
keywords: Experience Platform；主页；热门主题；模式;模式;XDM；个人用户档案；字段；模式;模式;模式设计；混音；人物；人物详细信息；用户档案人物详细信息；人物；
solution: Experience Platform
title: 人口统计详细信息混合
topic-legacy: overview
description: 此文档概述了“人口统计详细信息”混合。
...
[!UICONTROL Demographic Details] 是班级的标准混 [[!DNL XDM Individual Profile] 音](../../classes/individual-profile.md)。mixin提供一个根级别`person`对象，其子字段描述有关个人的信息。
...
| `person.birthDate` | Date | 以ISO 8601时间戳形式出生的完整日期。 |
...
* [全舍](https://github.com/adobe/xdm/blob/master/components/mixins/profile/profile-person-details.schema.json)
默奥
