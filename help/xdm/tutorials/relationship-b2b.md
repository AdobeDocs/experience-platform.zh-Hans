...
# 在Real-time Customer Data Platform B2B Edition中定义两个架构之间的关系

>[!NOTE]
>
>如果您没有使用Real-time Customer Data Platform B2B Edition，请参阅 [创建非B2B关系](./relationship-ui.md) 中。
...
要建立关系，两个架构都必须定义了主标识，并启用 [!DNL Real-time Customer Profile]. 在为B2B实体设置主标识时，请记住，如果您跨不同系统或位置收集基于字符串的实体ID，则它们可能会重叠，这可能会导致平台中的数据冲突。
