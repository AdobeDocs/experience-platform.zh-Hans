...
| `lists` | 对象 | 捕获最多三个[列表](https://experienceleague.adobe.com/docs/analytics/implementation/vars/page-vars/list.html)的对象。 此对象的属性被设置为`list1`到`list3`的键值。 每个属性都包含一个`list`数组，其中包含[[!UICONTROL 键值对]](../../data-types/key-value-pair.md)数据类型。 |
