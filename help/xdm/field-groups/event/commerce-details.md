...
# [!UICONTROL 商务详细信息] 架构字段组

>[!NOTE]
>
>多个架构字段组的名称已更改。 请参阅 [字段组名称更新](../name-updates.md) 以了解更多信息。

[!UICONTROL 商务详细信息] 是的标准架构字段组 [[!DNL XDM ExperienceEvent] 类](../../classes/experienceevent.md)，用于描述商务数据，例如产品信息（SKU、名称、数量）和标准购物车操作（订单、结帐、放弃）。

![](../../images/field-groups/commerce-details.png)

| 属性 | 数据类型 | 描述 |
| --- | --- | --- |
| `commerce` | [Commerce](../../data-types/commerce.md) | 描述产品退货、保修注册和购物车/订购流程的对象。 |
| `productListItems` | 数组 [产品列表项](../../data-types/product-list-item.md) | 代表客户选择的产品的项目列表，在特定时间点（可能与产品记录不同）提供特定选项和定价。 |
