...
![字段组结构](../../images/field-groups/healthcare-goal/goal.png)
...
| [!UICONTROL 开始可编码的概念] | `startCodeableConcept` | [[!UICONTROL 可编码的概念]](../../data-types/healthcare/codeable-concept.md) | 随后应说服目标完成的事件。 |
