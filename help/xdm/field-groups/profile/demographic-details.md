...
[!UICONTROL 人口统] 计详细信息是类的标准架构字 [[!DNL XDM Individual Profile] 段组](../../classes/individual-profile.md)。字段组提供一个根级别`person`对象，其子字段描述有关个人的信息。
...
* [填充的示例](https://github.com/adobe/xdm/blob/master/components/mixins/profile/profile-person-details.example.1.json)
