...
![字段组结构](../../images/field-groups/healthcare-practitioner/practitioner.png)

| 显示名称 | 属性 | 数据类型 | 描述 |
| --- | --- | --- | --- |
| [!UICONTROL 地址] | `address` | [[!UICONTROL 地址]](../../data-types/healthcare/address.md)的数组 | 从业人员在工作场所以外的地址，如家庭地址。 |
| [!UICONTROL 通信] | `communication` | 对象数组 | 可用于与从业人员通信的语言。 有关详细信息，请参阅下面的[部分](#communication) |
| [!UICONTROL 标识符] | `identifier` | [[!UICONTROL 标识符]](../../data-types/healthcare/identifier.md)的数组 | 适用于此角色中人员的标识符。 |
| [!UICONTROL 名称] | `name` | [[!UICONTROL 人工名称]](../../data-types/healthcare/human-name.md)的数组 | 与从业者关联的名称。 |
| [!UICONTROL 资格] | `qualification` | 对象数组 | 正式资格、认证、认证、培训、执照或类似情况，这些授权或以其他方式与从业者提供的护理相关。 有关详细信息，请参阅下面](#qualification)的[部分。 |
| [!UICONTROL 联系人详细信息] | `telecom` | [[!UICONTROL 联系点]](../../data-types/healthcare/contact-point.md)的数组 | 从业者的联系详细信息。 |
...
![通信结构](../../images/field-groups/healthcare-practitioner/communication.png)
...
![资格结构](../../images/field-groups/healthcare-practitioner/qualification.png)

| 显示名称 | 属性 | 数据类型 | 描述 |
| --- | --- | --- | --- |
| [!UICONTROL 代码] | `code` | [[!UICONTROL 可编码的概念]](../../data-types/healthcare/codeable-concept.md) | 资格的编码表示形式。 |
| [!UICONTROL 标识符] | `identifier` | [[!UICONTROL 标识符]](../../data-types/healthcare/identifier.md)的数组 | 资格的标识符。 |
