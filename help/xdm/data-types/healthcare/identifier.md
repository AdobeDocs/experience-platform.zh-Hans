...
![标识符数据类型结构](../../images/data-types/healthcare/identifier.png)

| 显示名称 | 属性 | 数据类型 | 描述 |
| --- | --- | --- | --- |
| [!UICONTROL 周期] | `period` | [[!UICONTROL 周期]](../healthcare/period.md) | ID处于或有效使用的时段。 |
| [!UICONTROL 类型] | `type` | [[!UICONTROL 可编码的概念]](../healthcare/codeable-concept.md) | 标识符的描述。 |
