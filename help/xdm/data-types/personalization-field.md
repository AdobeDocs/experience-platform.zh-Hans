...
# [!UICONTROL Generic Personalization Preference Field] 数据类型

[!UICONTROL Generic Personalization Preference Field] 是一种标准XDM数据类型，用于描述客户针对特定个性化首选项的选择。
...
| 属性 | 数据类型 | 描述 |
| --- | --- | --- |
| `val` | 字符串 | 此个性化用例由客户提供的首选项选择。 有关已接受的值和定义，请参阅下表。 |
...
* [已填充示例](https://github.com/adobe/xdm/blob/master/components/datatypes/consent/personalization-field.example.1.json)
