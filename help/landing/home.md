...
以多种格式为各种功能和应用程序提供了[!DNL Experience Platform]文档。 要了解有关可用文档类型的更多信息，请访问[Platform文档概述](documentation/overview.md)。

要开始了解有关特定[!DNL Platform]服务的更多信息，请返回[文档登陆页面](https://experienceleague.adobe.com/docs/experience-platform.html)并选择适当的指南。
...
通过学习分步教程（涵盖从准备数据以进行摄取到高级机器学习算法的所有内容），您可以快速轻松地开始使用[!DNL Platform]。 这些教程旨在补充在[!DNL Experience Platform]文档中找到的信息，因此，为获得最佳结果，请在完成教程的同时保留现有文档。
...
* [**API参考文档**](https://www.adobe.com/go/platform-api-reference-en)\
  发现[!DNL Experience Platform]个API，包括标头、参数、示例请求和响应。<br/>*这些文档在Adobe I/O上托管。*
