...
* Experience Platform文档 {#documentation}
   ...
   * [Experience Platform Web SDK（测试版）](https://docs.adobe.com/content/help/en/experience-platform/edge/home.html)
   ...
   * [源（连接器）](https://docs.adobe.com/content/help/en/experience-platform/source-connectors/home.html)
   * [XDM（体验数据模型）](https://docs.adobe.com/content/help/en/experience-platform/xdm/home.html)
* [Experience Platform教程](https://docs.adobe.com/content/help/en/experience-platform/tutorials/home.html)
* [发行说明](https://docs.adobe.com/content/help/en/experience-platform/release-notes/latest.html)
* [术语表](glossary.md)
