...
**Adobe Experience Platform决策服务** 利用实时客户用户档案根据用户档案从启用数据集中提取的行为数据，确定客户从一组选项中最可能做出的选择。
...
**AdobeI/O:** AdobeI/O是开发人员集 [!DNL Experience Platform] 成、扩展和自定义Adobe Experience Platform所需的一切功能(包括API、事件、开发人员控制台和有用的工具)的一部分。
