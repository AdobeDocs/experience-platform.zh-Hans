...
description: 了解在Microsoft Azure上运行Experience Platform与在Amazon Web Services上运行有何区别。
...
>[!AVAILABILITY]
>
>在Amazon Web Services (AWS)上运行的Adobe Experience Platform当前仅对有限数量的客户可用。 要详细了解AWS上的Experience Platform，请联系您的Adobe客户团队。

本页提供了两种可用云基础架构的高级概述，并包含有关如何为您的企业选择合适云基础架构的指导。

## 哪个云实施适合我？ {#which-cloud-is-right}

在Azure上的Experience Platform或AWS之间进行选择取决于您业务特有的几个因素：

* **业务和技术需求**：评估您组织的需求和长期云策略。
* **现有基础架构**：考虑您当前的云基础架构和集成需求。
* **云技术依赖**：如果您的业务严重依赖于Microsoft技术，则Azure可能更适合。 如果您更依靠Amazon服务，AWS可能是更好的选择。
...
下表显示了托管Experience Platform的Microsoft Azure区域。
...
下表显示了托管Experience Platform的AWS地区。 请定期回来查看是否添加了其他位置。
...
### 在Microsoft Azure上运行Experience Platform与AWS之间的区别 {#azure-aws-differences}

下表重点介绍了在Microsoft Azure上运行Experience Platform与在AWS上运行之间的主要区别。

| 特性/功能 | Microsoft Azure | Amazon Web Services |
| --- | --- | --- |
| [HIPAA合规性](https://www.adobe.com/cn/trust/compliance/hipaa-ready.html) | 受支持 | 不受支持 |
...
Experience Platform为您提供了在Microsoft Azure或Amazon Web Services上运行的选项，从而提供了灵活性和选择性。 评估您的业务需求和现有基础架构，以便针对使用哪个云平台做出明智的决策。
