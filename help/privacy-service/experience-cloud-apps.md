...
| Adobe Primetime身份验证 | ✓ | 不适用 | 数据主体所存储的数据将从系统中删除。 | <ul><li>[访问/删除文档](http://tve.helpdocsonline.com/how-to-make-a-privacy-request)</li><li>[!DNL Primetime] 无法传输数据，因此选择退出销售请求不适用。</li></ul> |
