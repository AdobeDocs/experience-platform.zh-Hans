...
以下是 [!DNL Experience Cloud] 与 [!DNL Privacy Service]，包括 [!DNL Privacy Service] 与兼容的功能，以及指向文档的链接以获取更多信息。
...
| Adobe Analytics | ✓ | ✓ | <ul><li>[访问/删除文档](https://experienceleague.adobe.com/docs/analytics/admin/data-governance/an-gdpr-overview.html?lang=zh-Hans)</li><li>[!DNL Analytics] 使用 [隐私报表变量](https://experienceleague.adobe.com/docs/analytics/admin/data-governance/consent-variables.html)</li></ul> |
