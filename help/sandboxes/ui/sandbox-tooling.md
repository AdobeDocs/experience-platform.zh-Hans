...
![选定了[!UICONTROL Create new package]并突出显示[!UICONTROL Add]的[!UICONTROL Add to package]对话框。](../images/ui/sandbox-tooling/create-new-package.png)
...
您返回到[!UICONTROL Sandboxes]环境中的&#x200B;**[!UICONTROL Packages]**&#x200B;选项卡，您可以在其中查看新发布的包。
...
![显示依赖对象选项[!UICONTROL Create new]和[!UICONTROL Use existing]的[!UICONTROL Package object and dependencies]页面。](../images/ui/sandbox-tooling/use-existing-object.png)
...
![突出显示[!UICONTROL Create package]的[!UICONTROL Sandboxes] **[!UICONTROL Packages]**&#x200B;选项卡。](../images/ui/sandbox-tooling/create-sandbox-package.png)

在[!UICONTROL Create package]对话框中选择[!UICONTROL Type of package]的&#x200B;**[!UICONTROL Entire sandbox]**。 为您的新包提供[!UICONTROL Package name]，然后从下拉列表中选择&#x200B;**[!UICONTROL Sandbox]**。 最后，选择&#x200B;**[!UICONTROL Create]**&#x200B;以确认您的条目。

![显示已完成字段并突出显示[!UICONTROL Create]的[!UICONTROL Create package]对话框。](../images/ui/sandbox-tooling/create-package-dialog.png)
...
您可以从对象清单页面访问快速复制。 例如，要查看可用架构的列表，请从左侧导航中选择&#x200B;**[!UICONTROL Schemas]**，然后选择&#x200B;**[!UICONTROL Browse]**&#x200B;选项卡。接下来，选择所选架构旁边的省略号(`...`)，以在下拉菜单中查看控制选项。 从下拉列表中选择&#x200B;**[!UICONTROL Add to package]**。
...
在沙盒环境的&#x200B;**[!UICONTROL Jobs]**&#x200B;选项卡的右侧详细信息窗格中选择&#x200B;**[!UICONTROL View import summary]**。
