...
在Experience Platform UI中，在左侧导航中选择&#x200B;**[!UICONTROL Sandboxes]**，然后选择&#x200B;**[!UICONTROL Browse]**&#x200B;选项卡以打开[!UICONTROL Sandboxes]仪表板。 仪表板列出了您组织的所有可用沙盒，包括其各自的类型（生产或开发）。
...
>[!WARNING]
>
>创建新沙盒需要先将其添加到[[!UICONTROL Permissions]](../../access-control/abac/ui/permissions.md)中的角色，然后才能开始使用。 要了解如何为角色配置沙盒，请参阅[为角色管理沙盒](../../access-control/abac/ui/permissions.md#managing-sandboxes-for-role)文档。
...
出现&#x200B;**[!UICONTROL Create sandbox]**&#x200B;对话框。 选择&#x200B;**[!UICONTROL Type]**&#x200B;下拉列表，然后选择[!UICONTROL Development]或[!UICONTROL Production]沙盒类型。

![选中了沙盒类型选择器的“创建沙盒”对话框。](../images/ui/sandbox-type.png)

选择类型后，在&#x200B;**[!UICONTROL Name]**&#x200B;字段中提供沙盒的名称。 沙盒名称是用于API调用的全小写标识符，因此应唯一且简洁。 沙盒名称必须以字母开头，最多可包含256个字符，并且仅由字母数字字符和连字符(-)组成。 接下来，在&#x200B;**[!UICONTROL Title]**&#x200B;字段中提供沙盒的标题。 标题应该易于用户识别，并且应该具有足够的描述性以便轻松识别。

完成后，选择&#x200B;**[!UICONTROL Create]**。

![已填写名称和标题并突出显示创建选项的“创建沙盒”对话框。](../images/ui/sandbox-info.png)

创建完沙盒后，刷新页面，新沙盒将出现在&#x200B;**[!UICONTROL Sandboxes]**&#x200B;仪表板中，状态为“[!UICONTROL Creating]”。 系统配置新沙盒大约需要30秒，之后其状态将更改为“[!UICONTROL Active]”。
...
从左侧导航的&#x200B;**[!UICONTROL Audiences]**&#x200B;部分中选择&#x200B;**[!UICONTROL Customers]**，然后选择&#x200B;**[!UICONTROL Compositions]**&#x200B;选项卡。

![已选择并突出显示“合成”选项卡的“受众”仪表板。](../images/ui/audiences.png)

接下来，选择第一个受众旁边的省略号(`...`)，然后选择&#x200B;**[!UICONTROL Delete]**。

![突出显示[!UICONTROL Delete]选项的受众菜单。](../images/ui/delete-composition.png)

将显示成功删除的确认信息，并返回到&#x200B;**[!UICONTROL Compositions]**&#x200B;选项卡。
...
从沙盒列表中选择要重置的沙盒。 在显示的右侧导航面板中，选择&#x200B;**[!UICONTROL Sandbox reset]**。
...
在最终确认窗口中，在对话框中输入沙盒名称并选择&#x200B;**[!UICONTROL Reset]**。
...
从沙盒列表中选择要删除的沙盒。 在显示的右侧导航面板中，选择&#x200B;**[!UICONTROL Delete]**。
...
在最终确认窗口中，在对话框中输入沙盒名称并选择&#x200B;**[!UICONTROL Continue]**。
