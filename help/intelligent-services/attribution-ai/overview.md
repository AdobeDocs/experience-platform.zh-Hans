...
Attribution AI还提供与其他Adobe解决方案（如[!DNL Adobe Analytics]）的集成。 这使您能够使用这些解决方案来利用可自定义的算法模型来评估媒体性能并提供分析分析分析。

## 后续步骤

您可以从[入门](./getting-started.md)指南开始。 本指南将指导您设置所有必需的预请求Attribution AI。 如果您的凭据和数据已准备就绪，请访问[Attribution AI用户指南](./user-guide.md)。 本指南将指导您创建实例并提交该实例以进行培训和评分。
