...
Attribution AI还与其他Adobe解决方案（如[!DNL Adobe Analytics]）集成。 这使您能够使用这些解决方案来利用可自定义的算法模型来评估媒体性能并提供分析见解。

## 后续步骤

您可以按照[入门指南](./getting-started.md)开始。 本指南将指导您设置所有必需的Attribution AI预请求。 如果您的凭据和数据已准备就绪，请访问[Attribution AI用户指南](./user-guide.md)。 本指南将指导您创建实例并提交它以进行培训和评分。