...
Attribution AI的访问控制是通过Adobe Experience Platform在以下位置提供的： [Adobe Admin Console](https://adminconsole.adobe.com/). 此功能利用Admin Console中的产品配置文件，它将用户与权限和沙盒关联起来。
...
在Attribution AI工作区顶部 **分析页面**，侧边栏中显示的详细信息具有受限访问权限。

![突出显示受限架构字段的Attribution AI工作区。](../images/user-guide/access-restricted.png)

如果您选择的数据集在 **[!UICONTROL 创建模型工作流]** 页面上，数据集名称旁边会显示一个警告标记，并显示消息： [!UICONTROL 排除受限制的信息].
...
![模型结果中受限制字段突出显示的Attribution AI工作区。](../images/user-guide/information-not-displayed-save-and-exit.png)
