...
为了提高系统中执行活动的透明度和可见性，现在可以在审核日志中捕获Attribution AI工作流中的用户活动，以了解用户对Attribution AI模型的任何更改。 这些日志形成了审核跟踪，可帮助解决问题，并帮助您的企业有效遵守公司数据管理策略和法规要求。  如果您受《健康保险便携性和责任法案》(HIPAA)的约束，并且要通过Attribution AI或客户人工智能创建、接收、维护或传输允许的敏感个人数据，则您负责执行具有Adobe和许可的医疗保健盾牌的BAA。
