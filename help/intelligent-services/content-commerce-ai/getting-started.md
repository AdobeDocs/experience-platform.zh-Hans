...
在Adobe Developer控制台中设置项目和API后，您可以选择下载适用于Postman的环境文件。 在 **[!UICONTROL API]** 在项目的左边栏中，选择 **[!UICONTROL 内容和商务人工智能]**. 此时会打开一个新选项卡，其中包含一个标有“[!DNL Try it out]&quot; 选择 **下载Postman版** 下载用于配置Postman环境的JSON文件。
