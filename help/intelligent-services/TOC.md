...
- [智能服务概述](home.md)
- [准备数据以用于Intelligent Services](data-preparation.md)
- 归因人工智能 {#attribution-ai}
   ...
   - [探索见解](attribution-ai/discover-insights.md)
   ...
   - 数据治理 {#aai-data-governance}
      ...
      - [数据治理](attribution-ai/aai-data-governance/data-governance.md)
...
- 客户人工智能 {#customer-ai}
   ...
   - UI指南{#user-guide}
      ...
      - [探索见解](customer-ai/user-guide/discover-insights.md)
      - [使用Customer AI评分创建区段](customer-ai/user-guide/create-segment.md)
