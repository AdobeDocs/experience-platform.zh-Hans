...
此外，要访问客户AI的得分，您需要有一个运行状态成功的服务实例。 要创建新的服务实例，请访问客 [户人工智能用户指南](./user-guide.md)。 如果您最近创建了一个服务实例，但该实例仍在培训和评分中，请允许24小时以便它完成运行。
...
在您的客户AI洞察服务实例中，单击右上导航中的 *更多操作* ，然后选择 **访问得分**。
