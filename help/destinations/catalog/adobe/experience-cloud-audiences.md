...
为了帮助您更好地了解您应如何以及何时使用[!UICONTROL Experience Cloud Audiences]目标，以下是Real-Time CDP客户可以使用此目标解决的示例用例。
...
要选择要导出到Audience Manager及其他受众的受众，请通过Experience Cloud受众目标使用新的自助受众共享集成。  这允许您确定要与其他Experience Cloud解决方案共享的受众，以及专门保留在Real-Time CDP中的受众。
...
>[!IMPORTANT]
>
>要通过Real-Time CDP Audiences目标将受众从Experience Cloud发送到Adobe Analytics，您必须具有Audience Manager许可证。

### 与其他Real-Time CDP解决方案共享Experience Cloud受众 {#share-segments-with-other-solutions}

您可以使用Real-Time CDP受众目标卡与其他Experience Cloud解决方案共享受众。
...
> * 您&#x200B;*不需要* Audience Manager许可证即可与以上[部分中提到的Adobe Advertising Cloud、Adobe Target、Marketo和其他Experience Cloud解决方案共享Real-Time CDP受众](#share-segments-with-other-solutions)。
