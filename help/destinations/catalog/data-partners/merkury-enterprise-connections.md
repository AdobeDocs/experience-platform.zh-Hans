...
按照此文档页面中的步骤操作，使用[!DNL Merkury Connections]用户界面创建[!DNL Adobe Experience Platform]目标连接并激活受众。
...
您已成功创建数据流以将配置文件数据从Experience Platform导出到[!DNL Merkury]托管的S3位置。 接下来，您需要联系[!DNL Merkury]代表，提供帐户名称、文件名和存储段路径，以便能够设置处理。
