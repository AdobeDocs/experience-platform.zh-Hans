...
[!DNL Bizible]是[!DNL Adobe Experience Platform]中的电子邮件扩展。 有关Bizible的详细信息，请阅读Bizible概述资源中的[营销归因](https://experienceleague.adobe.com/docs/bizible/using/introduction-to-bizible/overview-resources/marketing-attribution.html)。
