...
description: Marketo Munchkin扩展是Adobe Experience Platform中的个性化目标。 有关扩展功能的更多信息，请参阅Adobe Exchange上的扩展页面。
...
从商机管理到基于帐户的营销，[!DNL Marketo Engagement Platform]简化了您在客户和潜在客户体验的每个阶段规划、编排和衡量与客户互动的方式。

[!DNL Marketo’s Munchkin] JavaScript允许跟踪最终用户对[!DNL Marketo]登陆页面和外部网页的访问次数和点击次数。

[!DNL Marketo Munchkin]是[!DNL Adobe Experience Platform]中的电子邮件扩展。 有关Marketo Munchkin的更多信息，请参阅Marketo文档中的[潜在客户跟踪](https://developers.marketo.com/javascript-api/lead-tracking/)。
...
要安装[!DNL Marketo Munchkin]扩展，请执行以下操作：
