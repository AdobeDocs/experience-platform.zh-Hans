...
[!DNL Marketo Munchkin]是Adobe Experience Platform中的电子邮件扩展。 有关Marketo Munchkin的更多信息，请参阅Marketo文档中的[潜在客户跟踪](https://developers.marketo.com/javascript-api/lead-tracking/)。
