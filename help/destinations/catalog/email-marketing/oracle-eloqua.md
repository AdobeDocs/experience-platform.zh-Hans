...
要将受众数据发送到，请执行以下操作 [!DNL Oracle Eloqua]，您必须首先 [连接目标](#connect-destination) 在Adobe Experience Platform中，然后 [设置数据导入](#import-data-into-eloqua) 从存储位置到 [!DNL Oracle Eloqua].
