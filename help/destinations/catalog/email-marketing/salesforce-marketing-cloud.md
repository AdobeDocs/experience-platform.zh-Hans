...
在&#x200B;**[!UICONTROL 连接]** > **[!UICONTROL 目标]**&#x200B;中，选择[!DNL Salesforce Marketing Cloud]，然后选择&#x200B;**[!UICONTROL 配置]**。

![连接到Salesforce](../../assets/catalog/email-marketing/salesforce/catalog.png)

在&#x200B;**[!UICONTROL 帐户]**&#x200B;步骤中，如果您之前已设置到云存储目标的连接，请选择&#x200B;**[!UICONTROL 现有帐户]**&#x200B;并选择现有连接之一。 或者，您可以选择&#x200B;**[!UICONTROL 新建帐户]**&#x200B;来设置新连接。 填写帐户身份验证凭据，然后选择&#x200B;**[!UICONTROL 连接到目标]**。 对于[!DNL Salesforce Marketing Cloud]，您可以在&#x200B;**[!UICONTROL 带密码]**&#x200B;的SFTP和&#x200B;**[!UICONTROL 带SSH密钥]**&#x200B;的SFTP之间进行选择。

![连接SalesforceMarketing Cloud帐户](../../assets/catalog/email-marketing/salesforce/connection-type.png)

根据连接类型，填写以下信息，然后选择&#x200B;**[!UICONTROL 配置]**。
...
对于[!DNL Salesforce Marketing Cloud]目标，平台会在您提供的存储位置创建制表符分隔的`.csv`文件。 有关这些文件的详细信息，请参阅区段存储教程中的[电子邮件营销目标和云激活目标](../../ui/activate-destinations.md#esp-and-cloud-storage)。

## 将数据导入到[!DNL Salesforce Marketing Cloud] {#import-data-into-salesforce}

将[!DNL Platform]连接到[!DNL SFTP]存储后，必须将存储位置中的数据导入设置为[!DNL Salesforce Marketing Cloud]。 要了解如何实现此操作，请参阅[!DNL Salesforce Help Center]中的[将订阅者从文件](https://help.salesforce.com/articleView?id=mc_es_import_subscribers_from_file.htm&amp;type=5)导入Marketing Cloud。
