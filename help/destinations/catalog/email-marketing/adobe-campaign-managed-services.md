...
![Adobe Campaign Managed Cloud Services目标详细信息表单，其中显示了“名称”、“描述”、“实例选择”、“目标映射”和“同步类型”等字段。](../../assets/catalog/email-marketing/adobe-campaign-managed-services/destination-details.png)
...
1. 确定必需属性和重复数据删除键。 请注意，标记为“必需”或“重复数据删除键”的属性中的值不能为空。
   ...
   * [重复数据删除键](../../ui/activate-batch-profile-destinations.md#mandatory-attributes)是一个主键，它决定了用户希望为其配置文件进行重复数据删除的身份。
   ...
   ![属性映射屏幕，显示映射到Adobe Campaign目标字段的XDM源字段，以及必需和重复数据删除关键指示器。](../../assets/catalog/email-marketing/adobe-campaign-managed-services/mapping.png)
...
![Adobe Campaign受众加载作业屏幕显示从Adobe Experience Platform激活的导出作业。](../../assets/catalog/email-marketing/adobe-campaign-managed-services/campaign-jobs.png)

### 访问导出的数据 {#data}

对于&#x200B;**[!UICONTROL Audience sync]**，您可以通过导航到&#x200B;**[!UICONTROL Profile and target]** > **[!UICONTROL List]** > **[!UICONTROL AEP audiences]**&#x200B;菜单来检查导出的受众。

![Adobe Campaign AEP受众列表视图显示从Experience Platform导出的受众，该视图可在“配置文件”和“目标”下使用。](../../assets/catalog/email-marketing/adobe-campaign-managed-services/campaign-audiences.png)
