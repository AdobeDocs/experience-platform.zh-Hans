...
* 您可以 [激活](#activate) 此目标的最多25个受众。

  您可以通过更新 **NmsCdp_Aep_Audience_List_Limit** 中的选项 **[!UICONTROL 管理]** > **[!UICONTROL 平台]** > **[!UICONTROL 选项]** Campaign资源管理器的文件夹。

* 对于每个受众，您最多可以添加20个字段到 [映射](#map) Adobe Campaign。

  您可以通过更新 **NmsCdp_Aep_Destinations_Max_Columns** 中的选项 **[!UICONTROL 管理]** > **[!UICONTROL 平台]** > **[!UICONTROL 选项]** Campaign资源管理器的文件夹。
...
对象 **[!UICONTROL 配置文件同步（仅更新）]**，则目标中激活的受众定位的每个用户档案的数据会自动更新到Campaign数据库中。
