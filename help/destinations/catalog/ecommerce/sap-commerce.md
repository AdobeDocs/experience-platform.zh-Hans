...
在&#x200B;**[!UICONTROL 目标]** > **[!UICONTROL 目录]**&#x200B;中，搜索[!DNL SAP Commerce]。 或者，您可以在&#x200B;**[!UICONTROL 电子商务]**&#x200B;类别下找到它。
...
| 字段 | 描述 |
| --- | --- |
| **[!UICONTROL 客户端ID]** | 服务键中`clientId`的值。 |
| **[!UICONTROL 客户端密码]** | 服务键中`clientSecret`的值。 |
| **[!UICONTROL 终结点]** | 服务键中`url`的值类似于`https://subscriptionbilling.authentication.eu10.hana.ondemand.com`。 |
...
* **[!UICONTROL 客户类型]**：根据受众中的实体，选择&#x200B;***个人***&#x200B;或&#x200B;***公司***。 [!DNL SAP Subscription Billing] [架构](https://api.sap.com/api/BusinessPartner_APIs/schema)根据映射到`customerType`属性的该选择切换必填字段。 如果选择的是&#x200B;***公司***，则单个客户所需的强制映射（如`firstName`和`lastName`）将被忽略，`company`将变为强制映射，反之亦然。
...
必需的属性映射取决于您选择的&#x200B;**[!UICONTROL 客户类型]**。 要映射必需属性，请从下面选择：
