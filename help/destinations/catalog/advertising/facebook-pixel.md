...
title: Facebook像素扩展
description: Facebook Pixel扩展是Adobe Experience Platform中的广告目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
...
[!DNL Facebook Pixel] 是Adobe Experience Platform的广告扩展。有关扩展功能的详细信息，请参阅[Facebook Pixel网站](https://developers.facebook.com/docs/facebook-pixel/)。
