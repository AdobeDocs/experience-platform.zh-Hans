...
[!DNL Awin Advertiser Mastertag]是Adobe Experience Platform中的广告扩展。 有关扩展功能的详细信息，请参阅[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103176.awin-advertiser-mastertag.html)上的扩展页面。
