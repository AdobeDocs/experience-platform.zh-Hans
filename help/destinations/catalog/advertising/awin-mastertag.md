---
keywords: Awin广告商母版标签扩展；母版标签标签；Awin；AWIN；AWIN
title: Awin广告商母版标记扩展
description: Awin Advertiser Mastertag扩展是Adobe Experience Platform中的一个广告目标。 有关扩展功能的更多信息，请参阅Adobe交换上的扩展页面。
...
此 [!DNL MasterTag] 是一个JavaScript库，它包含Awin跟踪解决方案所需的所有函数，应无条件地附加到网站上的每个页面，包括确认页面，但不包括任何显示或处理付款信息的页面。

[!DNL Awin Advertiser Mastertag] 是Adobe Experience Platform中的广告扩展。 有关扩展功能的更多信息，请参阅上的扩展页面 [Adobe交换](https://exchange.adobe.com/experiencecloud.details.103176.awin-advertiser-mastertag.html).

此目标是标记扩展。 有关扩展如何在Platform中工作的更多信息，请参阅 [标记扩展概述](../launch-extensions/overview.md).

![UI中的Awin Advertiser Mastertag扩展](../../assets/catalog/advertising/awin-mastertag/catalog.png)
...
安装 [!DNL Awin Advertiser Mastertag] 扩展名：
...
有关扩展配置选项和安装支持的信息，请参阅 [Adobe交换上的“Awin广告商母版标签”页面](https://exchange.adobe.com/experiencecloud.details.103176.awin-advertiser-mastertag.html).
