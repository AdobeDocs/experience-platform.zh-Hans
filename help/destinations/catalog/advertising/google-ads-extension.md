...
[!DNL Google Ads] 是Adobe Experience Platform的广告推广。有关扩展功能的详细信息，请参见[AdobeExchange](https://www.adobeexchange.com/experiencecloud.details.101383.google-ads.html)上的扩展页。
...
有关扩展配置选项和安装支持的信息，请参见AdobeExchange](https://www.adobeexchange.com/experiencecloud.details.101383.google-ads.html)上的[Google Ads页。
