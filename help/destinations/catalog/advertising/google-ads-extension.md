---
keywords: Google广告；Google广告；Google广告扩展；Google广告扩展
title: Google广告扩展
description: Google Ads扩展是Adobe Experience Platform中的广告目的地。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
...
此扩展跟踪单击[!DNL Google Ads]的用户的转换。 您还需要安装gtag.js扩展并将它添加到您的库，因为[!DNL Google Ads]依赖它。

[!DNL Google Ads] 是Adobe Experience Platform的广告扩展。有关扩展功能的详细信息，请参阅[AdobeExchange](https://www.adobeexchange.com/experiencecloud.details.101383.google-ads.html)上的扩展页。
...
![Google广告扩展](../../assets/catalog/advertising/google-ads-extension/catalog.png)
...
有关扩展配置选项和安装支持的信息，请参阅Adobe Exchange](https://www.adobeexchange.com/experiencecloud.details.101383.google-ads.html)上的[Google Ads页面。
