...
description: 了解如何使用多种身份类型与Adobe Advertising Cloud Demand-Side Platform (DSP)共享经过身份验证和未经身份验证的第一方受众。
...
Adobe Advertising Cloud Demand-Side Platform (DSP)目标允许用户与DSP帐户或帐户内的特定广告商共享经过身份验证的第一方受众和未经身份验证的第一方受众。
...
此连接取代了仅支持哈希电子邮件地址的[旧版Adobe Advertising Cloud DSP连接](adobe-advertising-cloud-connection-legacy.md)。

>[!IMPORTANT]
>
>此页面由Adobe Advertising [!DNL DSP]团队创建。 如有任何查询或更新请求，请直接通过`adcloud_support@adobe.com`联系Advertising Cloud支持。
...
* DSP[中用于接收营销活动激活受众的](https://experienceleague.adobe.com/docs/advertising-cloud/dsp/audiences/sources/source-create.html?lang=zh-Hans)Real-Time CDP源。 您的Adobe客户团队将使用您的Experience Cloud组织ID创建源。

* 在[!DNL DSP][中创建 [!DNL DSP]Real-Time CDP源时生成的](https://experienceleague.adobe.com/docs/advertising-cloud/dsp/audiences/sources/source-create.html?lang=zh-Hans)帐户或广告商的源密钥。 您的[!DNL DSP]帐户团队将与您共享此密钥。 您将在Experience Platform中使用它来创建与Advertising Cloud DSP目标的目标连接，如下所述。
...
| `Everesttech cookie` | 适用于Adobe Advertising的第三方Cookie | 需要创建基于Cookie的区段。 |
...
* **[!UICONTROL Account or Advertiser Key]**：在DSP用户界面[!UICONTROL Source Key]中创建[Real-Time CDP源时生成此](https://experienceleague.adobe.com/docs/advertising-cloud/dsp/audiences/sources/source-create.html?lang=zh-Hans)。 您的Adobe客户团队将在创建源后与您共享此密钥。
...
您可以选择要发送到Adobe Advertising DSP的ID。 默认情况下，将为广告商选择Cookie标识符。 您还可以选择添加[!UICONTROL Hashed Email]、[!UICONTROL IDFA]和[!UICONTROL GAID]。
...
要验证受众数据是否已与Advertising Cloud共享，请检查以下各项：
