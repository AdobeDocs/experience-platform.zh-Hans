...
| 导出频率 | **[!UICONTROL Batch]** | 由于用户档案是根据受众评估在Experience Platform中进行更新的，因此用户档案（身份）会进行更新，并能够以每日、每周或每月的频率下游交付到目标平台。 阅读有关[基于批处理文件的目标](/help/destinations/destination-types.md#file-based)的详细信息。 |
...
| 发行月份 | 更新类型 | 描述 |
|---|---|---|
| 2025 年 2 月 | 功能和文档更新 | <ul><li> 添加了对每周和每月投放节奏的支持。 |
