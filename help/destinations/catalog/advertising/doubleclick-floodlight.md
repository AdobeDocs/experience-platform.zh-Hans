...
description: DoubleClick Floodlight（测试版）扩展是Adobe Experience Platform中的一个广告目标。 有关扩展功能的更多信息，请参阅Adobe交换上的扩展页面。
...
此扩展允许快速轻松地部署 [!DNL DoubleClick Floodlight] 标记使用传统的Floodlight格式（不是全局站点标记）。 注意：此扩展处于测试阶段。

[!DNL DoubleClick Floodlight] (Beta)是Adobe Experience Platform中的一项广告扩展。 有关扩展功能的更多信息，请参阅 [!DNL Google] 的支持文档 [双击Floodlight](https://support.google.com/dcm/answer/2823388?hl=en).
