...
description: DoubleClick Floodlight（测试版）扩展是Adobe Experience Platform中的广告目的地。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
...
[!DNL DoubleClick Floodlight] （测试版）是Adobe Experience Platform的广告扩展。有关扩展功能的详细信息，请参阅[DoubleClick Floodlight](https://support.google.com/dcm/answer/2823388?hl=en)的[!DNL Google]支持文档。
...
要安装DoubleClick Floodlight（测试版）扩展：
