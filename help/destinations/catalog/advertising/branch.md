...
title: 分支扩展
description: 分支扩展是Adobe Experience Platform中的广告目的地。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
...
Branch提供强大的链接和解决方案，帮助您跨所有设备、渠道和平台获取、参与和衡量。

Branch是Adobe Experience Platform的广告扩展。 有关扩展功能的详细信息，请参阅Branch网站上的[功能页面](https://branch.io/features/)。
