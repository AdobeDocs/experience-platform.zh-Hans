...
title: 分支扩展
description: Branch扩展是Adobe Experience Platform的一个广告目的地。 有关扩展功能的更多信息，请参阅Exchange上的扩展页面Adobe。
...
Branch提供了功能强大的链接和解决方案，可帮助您获取、参与和衡量所有设备、渠道和平台。

Branch是Adobe Experience Platform中的一项广告扩展。 有关扩展功能的更多信息，请参阅Branch网站上的[功能页面](https://branch.io/features/)。

此目标是一个标记扩展。 有关标记扩展如何在Platform中工作的更多信息，请参阅[标记扩展概述](../launch-extensions/overview.md)。

![分支扩展](../../assets/catalog/advertising/branch/catalog.png)
