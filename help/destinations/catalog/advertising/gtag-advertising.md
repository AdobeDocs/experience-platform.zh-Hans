...
>[!IMPORTANT]
>
>此处描述的Google gtag扩展已弃用，并由[!DNL Acronym]开发的[[!DNL Google Global Site Tag (gtag)]](https://exchange.adobe.com/apps/ec/101437/google-global-site-tag-gtag)扩展替换。 您可以在数据收集UI或Experience PlatformUI的[[!UICONTROL 标记]](../../../tags/home.md)工作区中找到[!DNL Google Global Site Tag (gtag)]扩展。
...
Google gtag是Adobe Experience Platform中的一个广告扩展。 有关扩展功能的详细信息，请参阅[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.102805.google-gtag.html)上的扩展页面。
...
有关扩展配置选项和安装支持的信息，请参阅Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.102805.google-gtag.html)上的[Google gtag页。
