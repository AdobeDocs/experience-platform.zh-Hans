...
>[!IMPORTANT]
>
>此处描述的Google gtag扩展已弃用，并由[[!DNL Google Global Site Tag (gtag)]开发的](https://exchange.adobe.com/apps/ec/101437/google-global-site-tag-gtag)[!DNL Acronym]扩展替换。 在数据收集UI或Experience Platform UI的[!DNL Google Global Site Tag (gtag)]工作区中，您可以找到[[!UICONTROL Tags]](../../../tags/home.md)扩展。
...
Google gtag是[!DNL Adobe Experience Platform]中的广告扩展。 有关扩展功能的更多信息，请参阅[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.102805.google-gtag.html)上的扩展页面。
...
有关扩展配置选项和安装支持的信息，请参阅Adobe Exchange[上的](https://exchange.adobe.com/experiencecloud.details.102805.google-gtag.html)Google gtag页面。
