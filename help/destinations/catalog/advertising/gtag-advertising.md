...
title: Google Gtag扩展
description: Google gtag扩展是Adobe Experience Platform中的一个广告目的地。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
...
将Google的`gtag.js`加载到您的网站中，将事件数据发送到[!DNL Google Analytics]、Google Ads和[!DNL Google Marketing Platform]。 此扩展仅将gtag代码添加到您的站点。 您需要使用其他Google扩展来添加将使用gtag的事件和操作。

Google Gtag是Adobe Experience Platform的广告扩展。 有关扩展功能的详细信息，请参阅[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.102805.google-gtag.html)上的扩展页。
