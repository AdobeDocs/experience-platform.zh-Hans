...
此目标允许营销人员将Experience Platform中创建的用户受众导入到Snapchat广告中，并使用这些受众定位其广告。
...
* 无法为受众区段的成员定义保留期。 所有成员都具有生命周期保留期，在被删除之前都将位于受众中。
...
* **[!UICONTROL 帐户ID]**：与要将受众导入到的广告帐户关联的广告帐户ID。 有关如何查找此内容的更多信息，请参阅 [此文档位于Snapchat商务帮助中心](https://businesshelp.snapchat.com/s/article/biz-acct-id?language=en_US).
...
将受众激活到 *Snap Inc* 目标，您将能够在快照广告管理器的 [**受众** 部分](https://businesshelp.snapchat.com/s/article/audience-sharing). 要导航到此部分，请执行以下步骤：
