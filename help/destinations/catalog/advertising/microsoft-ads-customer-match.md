...
使用[!DNL Microsoft Ads Customer Match]目标按电子邮件地址匹配客户，并在[!DNL Microsoft Advertising Network]中与客户重新互动，包括搜索和受众广告。 将您的[!DNL Microsoft Advertising]帐户关联到[!DNL Real-Time CDP]，以直接从Experience Platform自动创建和管理客户匹配列表。
...
有关更多信息，请参阅[Microsoft Advertising帮助中心](https://help.ads.microsoft.com/)。
