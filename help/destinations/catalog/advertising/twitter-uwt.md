...
description: Twitter通用网站标签扩展是Adobe Experience Platform中的广告目的地。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
...
[!DNL Twitter Universal Website Tag] 是Adobe Experience Platform的广告扩展。有关扩展功能的详细信息，请参阅[高级转换跟踪](https://business.twitter.com/en/solutions/twitter-ads/website-clicks/advanced-conversion-tracking.html)。
...
![Twitter通用网站标签扩展](../../assets/catalog/advertising/twitter-uwt/catalog.png)
...
安装[!DNL Twitter Universal Website Tag]扩展：
