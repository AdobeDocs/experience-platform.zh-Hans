...
>[!IMPORTANT]
>
>此目标由Pinterest团队构建。 如有任何查询或更新请求，请直接通过https://help.pinterest.com/en/contact联系他们。
...
| EMAIL | 电子邮件地址（纯文本或使用SHA256算法进行哈希处理） | [!DNL Adobe Experience Platform]支持纯文本和SHA256哈希电子邮件地址。 <br>将&#x200B;*Email*&#x200B;或&#x200B;*Email_LC_SHA256*&#x200B;源身份命名空间映射到目标身份字段&#x200B;*pinterest_audience*。 |
...
| 项目 | 类型 | 注释 |
|---------|----------|---------|
| 导出类型 | **[!UICONTROL Audience export]** | 您正在导出具有Pinterest客户列表目标中所用标识符（姓名、电话号码或其他）的受众所有成员。 |
...
为了帮助您更好地了解您应如何以及何时使用[!DNL Pinterest Customer List]目标，以下是[!DNL Adobe Experience Platform]客户可以通过使用此目标解决的示例用例。
...
* **[!UICONTROL Ad Account ID]**：您的Pinterest广告商ID。

### 刷新身份验证凭据 {#refresh-authentication-credentials}

Pinterest令牌每30天过期一次。 您可以从&#x200B;**[!UICONTROL Account expiration date]**&#x200B;或&#x200B;**[[!UICONTROL Accounts]](../../ui/destinations-workspace.md#accounts)**&#x200B;选项卡中的&#x200B;**[[!UICONTROL Browse]](../../ui/destinations-workspace.md#browse)**&#x200B;列监视令牌过期日期。
...
4. 在模式窗口中，选择&#x200B;**[!UICONTROL Reconnect OAuth]**并使用您的Pinterest凭据重新进行身份验证。
...
有关详细信息，请参阅[Pinterest帮助中心页面](https://help.pinterest.com/en/business/article/audience-targeting)。
...
| 发行月份 | 更新类型 | 描述 |
|---|---|---|
| 2023 年 11 月 | 功能和文档更新 | [!DNL Real-Time CDP]中的Pinterest目标现在使用v5广告商API。 |
