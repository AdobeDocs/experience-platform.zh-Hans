...
>
>此目标连接器和文档页面由&#x200B;*[!DNL Trade Desk]*&#x200B;团队创建和维护。 有关任何查询或更新请求，请与您的[!DNL Trade Desk]代表联系。
...
根据您摄取到[!DNL Adobe Experience Platform]中的ID类型，您必须遵循其相应的要求。 有关详细信息，请阅读[身份命名空间概述](/help/identity-service/features/namespaces.md)。

## 支持的身份 {#supported-identities}

[!DNL The Trade Desk]支持激活下表中描述的标识。 了解有关[标识](/help/identity-service/features/namespaces.md)的更多信息。

[!DNL Adobe Experience Platform]同时支持未散列和散列电子邮件地址和电话号码。 按照ID匹配要求部分中的说明进行操作，并分别将适当的命名空间用于纯文本和经过哈希处理的电子邮件地址。
...
您可以在将电子邮件地址摄取到[!DNL Adobe Experience Platform]中之前对其进行哈希处理，或者使用原始电子邮件地址。
...
2. 选择&#x200B;**[!UICONTROL Adobe 1PD]**，它将列出激活到[!DNL The Trade Desk]的所有受众。
