...
description: Flashtalking OneTag扩展是Adobe Experience Platform中的广告目的地。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
...
[!DNL Flashtalking OneTag]扩展用于Experience Platform Launch，可轻松对显示、视频和移动广告活动的站点操作进行归因。 使用启动项将[!DNL Flashtalking OneTag]部署到Web属性。

[!DNL Flashtalking OneTag] 是Adobe Experience Platform的广告扩展。有关扩展功能的详细信息，请参阅[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html)上的扩展页。
...
有关扩展配置选项和安装支持的信息，请参阅Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html)上的[ Flashtalking OneTag页。
