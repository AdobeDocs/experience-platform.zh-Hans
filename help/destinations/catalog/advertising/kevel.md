...
### 支持自定义身份命名空间 {#custom-identity-namespaces}
...
### 身份映射行为 {#identity-mapping-behavior}
...
要将受众发送到[!DNL Kevel]，请按照[将受众激活到流式目标](/help/destinations/ui/activate-segment-streaming-destinations.md)中的工作流操作。
...
### [!DNL Kevel] UserDB收到的样本有效负载 {#sample-payload}
...
#### [!DNL Kevel]如何解释此配置文件 {#kevel-profile-interpretation}
