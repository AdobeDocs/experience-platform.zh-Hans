...
>[!IMPORTANT]
>
>此目标连接器和文档页面由标准创建和维护。 此产品目前为测试版，其功能可能会有变动。 如有任何查询或更新请求，请直接在[此处](mailto:criteoTechnicalPartnerships@criteo.com)联系Criteo。
...
| 导出频率 | 流式处理 | 流目标为基于API的“始终运行”连接。 一旦根据受众评估在Experience Platform中更新了用户档案，连接器就会将更新发送到下游目标平台。 阅读有关[流式目标](../../destination-types.md#streaming-destinations)的更多信息。 |
