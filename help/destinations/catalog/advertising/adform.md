...
| 项目 | 类型 | 注释 |
---------|----------|---------|
| 导出类型 | **[!UICONTROL 区段导出]** | 您正在导出区段（受众）的所有成员，其中包含&#x200B;*YourDestination*&#x200B;目标中使用的标识符（姓名、电话号码或其他）。 |
...
* **[!UICONTROL 帐户名]**：输入一个帐户名，以便将来识别此目标连接。
* **[!UICONTROL S3访问密钥ID]**：填写Adform提供的S3访问密钥。
* **[!UICONTROL S3访问密钥]**：填写Adform提供的S3访问密钥。
...
* **[!UICONTROL 提供程序名称]**： Adform提供的Adform帐户名称。
