...
title: Bing Ads Universal 事件 Tracking(UET)扩展
description: Bing Ads Universal事件跟踪(UET)扩展是Adobe Experience Platform中的一个广告目的地。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
...
[!DNL Bing Ads Universal Event Tracking] (UET)for是 [!DNL Experience Platform Launch] 跟踪某人点击您的搜索广告后发生情况的有用方法。通过使用单个UET标签记录客户在您网站上的行为，您可以利用该数据，从而使用再营销列表跟踪转化率或目标受众。

[!DNL Bing Ads Universal Event Tracking] (UET)是Adobe Experience Platform的广告扩展。有关扩展功能的详细信息，请参阅[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100154.html)上的扩展页。
...
有关扩展配置选项和安装支持的信息，请参阅Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100154.html)上的[Bing Ads Universal 事件 Tracking(UET)页。
