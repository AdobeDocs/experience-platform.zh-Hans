...
* [旧版Adobe Advertising Cloud连接](adobe-advertising-cloud-connection-legacy.md)
...
要将受众发送到营销活动的广告目标，Experience Platform必须首先连接到目标。 有关设置新目标的详细信息，请参阅[目标创建教程](../../ui/connect-destination.md)。
