...
title: linkedIn Insight Tag扩展
description: LinkedIn Insight Tag扩展是Adobe Experience Platform中的一个广告目标。 有关扩展功能的更多信息，请参阅Exchange上的扩展页面Adobe。
...
安装[!DNL LinkedIn Insight Tag]以使用转化跟踪、重定位和网站人口统计功能。

[!DNL LinkedIn Insight Tag] 是Adobe Experience Platform的一项广告扩展。有关扩展功能的更多信息，请参阅[LinkedIn Insight标记](https://business.linkedin.com/marketing-solutions/insight-tag)。

此目标是一个标记扩展。 有关标记扩展如何在Platform中工作的更多信息，请参阅[标记扩展概述](../launch-extensions/overview.md)。

![linkedIn Insight Tag扩展](../../assets/catalog/advertising/linkedin/catalog.png)
...
要安装[!DNL LinkedIn Insight Tag]扩展，请执行以下操作：
...
有关扩展配置选项和安装支持的信息，请参阅[LinkedIn Insight标记](https://business.linkedin.com/marketing-solutions/insight-tag)。
