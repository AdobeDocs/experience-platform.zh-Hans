...
description: linkedIn Insight Tag扩展是Adobe Experience Platform中的一个广告目标。 有关扩展功能的更多信息，请参阅Adobe交换上的扩展页面。
...
安装 [!DNL LinkedIn Insight Tag] 使用转化跟踪、重新定位和网站人口统计功能。

[!DNL LinkedIn Insight Tag] 是Adobe Experience Platform中的广告扩展。 有关扩展功能的更多信息，请参阅 [linkedIn Insight标记](https://business.linkedin.com/marketing-solutions/insight-tag).
...
安装 [!DNL LinkedIn Insight Tag] 扩展名：
