...
description: linkedIn Insight Tag扩展是Adobe Experience Platform中的一个广告目标。 有关扩展功能的更多信息，请参阅Adobe Exchange上的扩展页面。
...
[!DNL LinkedIn Insight Tag]是Adobe Experience Platform中的广告扩展。 有关扩展功能的详细信息，请参阅[LinkedIn Insight Tag](https://business.linkedin.com/marketing-solutions/insight-tag)。
