---
keywords: LinkedIn；Linkedin；Linkedin；LinkedIn Insight标签；insight标签；Insight标签
title: LinkedIn Insight标记扩展
description: LinkedIn Insight标记扩展是Adobe Experience Platform中的一个广告目标。 有关扩展功能的更多信息，请参阅Adobe Exchange上的扩展页面。
...
安装[!DNL LinkedIn Insight Tag]以使用转化跟踪、重新定位和网站人口统计功能。

[!DNL LinkedIn Insight Tag]是[!DNL Adobe Experience Platform]中的Advertising扩展。 有关扩展功能的详细信息，请参阅[LinkedIn Insight标记](https://business.linkedin.com/marketing-solutions/insight-tag)。
