...
description: LinkedIn Insight标记扩展是Adobe Experience Platform中的广告目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
...
[!DNL LinkedIn Insight Tag] 是Adobe Experience Platform的广告扩展。有关扩展功能的详细信息，请参阅[LinkedIn Insight标记](https://business.linkedin.com/marketing-solutions/insight-tag)。
