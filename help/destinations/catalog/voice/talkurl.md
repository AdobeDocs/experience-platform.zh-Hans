...
[!DNL Talk URL Inbox]是Adobe Experience Platform中客户分机的声音。 有关扩展功能的详细信息，请参阅[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100583.html)上的扩展页面。
