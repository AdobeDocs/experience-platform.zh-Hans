...
title: 确认数字反馈扩展
description: Confirmit Digital Feedback扩展是Adobe Experience Platform中的客户语音目标。 有关扩展功能的更多信息，请参阅Adobe Exchange上的扩展页面。
...
[!DNL Confirmit Digital Feedback]解决方案可帮助您将网站流量转化为实时见解。 使用[!DNL Confirmit]，可以根据您的要求显示低调且目标明确的调查，鼓励访客提供反馈，例如：
...
[!DNL Confirmit]数字反馈是[!DNL Adobe Experience Platform]中客户分机的声音。 有关扩展功能的更多信息，请参阅[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103247.confirmit-digital-feedback-for-adobe-launch.html)上的扩展页面。

此目标是标记扩展。 有关标记扩展如何在Experience Platform中工作的更多信息，请参阅[标记扩展概述](../launch-extensions/overview.md)。

![确认数字反馈扩展](../../assets/catalog/voice/confirmit-digital-feedback/catalog.png)
...
有关扩展配置选项和安装支持的信息，请参阅Adobe Exchange[上的](https://exchange.adobe.com/experiencecloud.details.103247.confirmit-digital-feedback-for-adobe-launch.html)确认数字反馈页面。
