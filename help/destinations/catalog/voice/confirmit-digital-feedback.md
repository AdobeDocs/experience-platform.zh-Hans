...
title: 确认数字反馈扩展
description: “确认数字反馈”扩展是Adobe Experience Platform中客户目标的语音。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
...
[!DNL Confirmit Digital Feedback] 解决方案可帮助您将网站流量转化为实时洞察。对于[!DNL Confirmit]，可以根据您的要求显示不显眼且目标明确的调查，鼓励访客提供反馈，例如：
...
[!DNL Confirmit] Digital Feedback是Adobe Experience Platform中客户扩展的喉舌。有关扩展功能的详细信息，请参阅[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.103247.confirmit-digital-feedback-for-adobe-launch.html)上的扩展页。
...
有关扩展配置选项和安装支持的信息，请参阅Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103247.confirmit-digital-feedback-for-adobe-launch.html)上的“确认数字反馈”页。[
