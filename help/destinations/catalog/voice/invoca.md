...
title: Invoca标记扩展
description: Invoca标记扩展是Adobe Experience Platform中客户目标的语音。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
...
[!DNL Invoca] 将通话数据和语音洞察引入数字客户旅程中。借助[!DNL Invoca’s]呼叫智能平台，营销人员最终可以分析以衡量呼叫结果并将线下转化率与数字支出挂钩。

[!DNL Invoca Tags] 是Adobe Experience Platform客户扩展的声音。有关扩展功能的详细信息，请参阅[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100067.invoca.html)上的扩展页。
...
![Invoca扩展](../../assets/catalog/voice/invoca/catalog.png)
...
有关扩展配置选项和安装支持的信息，请参阅Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100067.invoca.html)上的[ Invoca Tags页。
