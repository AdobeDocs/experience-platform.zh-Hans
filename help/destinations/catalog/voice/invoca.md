...
title: Invoca标记扩展
description: Invoca Tags扩展是客户目标在Adobe Experience Platform中的声音。 有关扩展功能的更多信息，请参阅Exchange上的扩展页面Adobe。
...
[!DNL Invoca] 将电话数据和语音分析引入数字客户历程。借助[!DNL Invoca’s]呼叫智能平台，营销人员最终可以借助分析来测量呼叫结果并将离线转化与数字支出挂钩。

[!DNL Invoca Tags] 是Adobe Experience Platform中客户扩展的声音。有关扩展功能的更多信息，请参阅[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100067.invoca.html)上的扩展页面。
...
有关扩展配置选项和安装支持的信息，请参阅AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100067.invoca.html)上的[Invoca Tags页面。
