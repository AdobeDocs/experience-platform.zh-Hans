...
description: AdobeLivefyre扩展是Adobe Experience Platform中的一个社交目标。 有关扩展功能的更多信息，请参阅Adobe交换上的扩展页面。
...
通过AdobeLivefyre，您可以发现、整理用户生成的内容并将其发布到您的网站上，以创建真实且高度个性化的体验。

AdobeLivefyre是Adobe Experience Platform中的社交扩展。 有关AdobeLivefyre的更多信息，请阅读 [Livefyre实施指南](https://experienceleague.adobe.com/docs/livefyre/implementation/home.html?lang=en).
