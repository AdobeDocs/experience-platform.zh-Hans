...
[!DNL QuestionPro Intercept Surveys] 是Adobe Experience Platform的调查延伸。有关扩展功能的详细信息，请参见[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.90096.questionpro-surveys.html)上的扩展页。
...
有关扩展配置选项和安装支持的信息，请参见AdobeExchange](https://exchange.adobe.com/experiencecloud.details.90096.questionpro-surveys.html)上的[QuestionPro Intercept调查页。
