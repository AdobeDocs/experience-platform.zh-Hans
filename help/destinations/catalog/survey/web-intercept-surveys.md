...
description: QuestionPro Intercept调查扩展是Adobe Experience Platform中的调查目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
...
[!DNL QuestionPro Intercept Surveys] 是Adobe Experience Platform的调查扩展。有关扩展功能的详细信息，请参阅[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.90096.questionpro-surveys.html)上的扩展页。
...
安装[!DNL QuestionPro Intercept Surveys]扩展：
...
有关扩展配置选项和安装支持的信息，请参阅Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.90096.questionpro-surveys.html)上的[QuestionPro Intercept调查页。
