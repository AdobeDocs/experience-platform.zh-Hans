---
keywords: QuestionPro截取调查；questionpro截取调查；Questionpro；questionpro
title: QuestionPro截取调查扩展
description: QuestionPro Intercept Surveies扩展是Adobe Experience Platform中的调查目标。 有关扩展功能的更多信息，请参阅Adobe Exchange上的扩展页面。
...
[!DNL QuestionPro Intercept Surveys]是一个平台，用于在事务点或用户进入/退出您的网站时部署调查和收集态度数据。

[!DNL QuestionPro Intercept Surveys]是[!DNL Adobe Experience Platform]中的调查扩展。 有关扩展功能的更多信息，请参阅[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.90096.questionpro-surveys.html)上的扩展页面。

此目标是标记扩展。 有关标记扩展如何在Experience Platform中工作的更多信息，请参阅[标记扩展概述](../launch-extensions/overview.md)。

![QuestionPro Intercept调查扩展](../../assets/catalog/survey/web-intercept-surveys/catalog.png)
...
要安装[!DNL QuestionPro Intercept Surveys]扩展，请执行以下操作：
...
有关扩展配置选项和安装支持的信息，请参阅Adobe Exchange[上的](https://exchange.adobe.com/experiencecloud.details.90096.questionpro-surveys.html)QuestionPro Intercept Surveies页。
