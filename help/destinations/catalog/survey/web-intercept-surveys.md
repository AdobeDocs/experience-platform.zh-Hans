...
[!DNL QuestionPro Intercept Surveys]是Adobe Experience Platform中的调查扩展。 有关扩展功能的详细信息，请参阅[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.90096.questionpro-surveys.html)上的扩展页面。
