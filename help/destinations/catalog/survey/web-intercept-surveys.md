---
keywords: QuestionPro截距调查；Questionpro截距调查；QuestionPro;Questionpro
title: QuestionPro截距调查扩展
description: QuestionPro Intercept Surveys扩展是Adobe Experience Platform中的调查目标。 有关扩展功能的更多信息，请参阅Exchange上的扩展页面Adobe。
...
[!DNL QuestionPro Intercept Surveys] 是Adobe Experience Platform中的一项调查扩展。有关扩展功能的更多信息，请参阅[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.90096.questionpro-surveys.html)上的扩展页面。

此目标是一个标记扩展。 有关标记扩展如何在Platform中工作的更多信息，请参阅[标记扩展概述](../launch-extensions/overview.md)。

![QuestionPro截距调查扩展](../../assets/catalog/survey/web-intercept-surveys/catalog.png)
...
有关扩展配置选项和安装支持的信息，请参阅AdobeExchange](https://exchange.adobe.com/experiencecloud.details.90096.questionpro-surveys.html)上的[QuestionPro截距调查页面。
