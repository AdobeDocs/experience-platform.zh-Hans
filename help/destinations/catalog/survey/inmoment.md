...
title: InMoment扩展
description: InMoment扩展是Adobe Experience Platform中的调查目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
...
使用[!DNL InMoment] Launch集成，您可以通过Digital Intercept产品快速轻松地启用在线反馈。 在应用程序中，可以通过CXI云管理员配置和管理截获，使CX经理能够更好地控制其项目。

[!DNL InMoment] 是Adobe Experience Platform的调查扩展。有关扩展功能的详细信息，请参阅[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100847.html)上的扩展页。
...
有关扩展配置选项的信息，请参阅Adobe Exchange上的[Google Universal Analytics扩展页面](https://exchange.adobe.com/experiencecloud.details.100847.html)。
