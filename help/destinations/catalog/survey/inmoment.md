...
[!DNL InMoment]是Adobe Experience Platform中的调查扩展。 有关扩展功能的详细信息，请参阅[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100847.html)上的扩展页面。

此目标是标记扩展。 有关标记扩展如何在Platform中工作的更多信息，请参阅[标记扩展概述](../launch-extensions/overview.md)。

![即时分机](../../assets/catalog/survey/inmoment/catalog.png)
...
有关扩展配置选项的信息，请参阅Adobe Exchange上的[Google Universal Analytics扩展页](https://exchange.adobe.com/experiencecloud.details.100847.html)。
