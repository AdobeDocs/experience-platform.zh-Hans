...
title: InMoment扩展
description: InMoment扩展是Adobe Experience Platform中的一个调查目标。 有关扩展功能的更多信息，请参阅Exchange上的扩展页面Adobe。
...
通过[!DNL InMoment] Launch集成，您可以通过Digital Intercept产品快速轻松地启用在线反馈。 在应用程序中，可以通过CXI云管理员配置和管理截获，从而允许CX经理更好地控制其程序。

[!DNL InMoment] 是Adobe Experience Platform中的一项调查扩展。有关扩展功能的更多信息，请参阅[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100847.html)上的扩展页面。
...
有关扩展配置选项的信息，请参阅Exchange上的[Google Universal Analytics扩展页面](https://exchange.adobe.com/experiencecloud.details.100847.html)Adobe。
