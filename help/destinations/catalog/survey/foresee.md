...
title: Foresee扩展目标
description: Foresee扩展是Adobe Experience Platform中的一个调查目标。 有关扩展功能的更多信息，请参阅Exchange上的扩展页面Adobe。
...
使用标记配置[!DNL ForeSee]产品部署。

[!DNL Foresee] 是Adobe Experience Platform中的一项调查扩展。有关扩展功能的更多信息，请参阅[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100164.html)上的扩展页面。
...
有关扩展配置选项的信息，请参阅Exchange上的[Foresee扩展页面](https://exchange.adobe.com/experiencecloud.details.100164.html)Adobe。
