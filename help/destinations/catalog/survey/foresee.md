...
title: Foresee扩展目标
description: Foresee扩展是Adobe Experience Platform中的一个调查目标。 有关扩展功能的更多信息，请参阅Adobe Exchange上的扩展页面。
...
[!DNL Foresee]是[!DNL Adobe Experience Platform]中的调查扩展。 有关扩展功能的更多信息，请参阅[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100164.html)上的扩展页面。
...
有关扩展配置选项的信息，请参阅Adobe Exchange上的[Foresee扩展页](https://exchange.adobe.com/experiencecloud.details.100164.html)。
