...
keywords: 可预测；可预测
title: Foresee扩展目标
description: Foresee扩展是Adobe Experience Platform的调查目的地。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
...
[!DNL Foresee] 是Adobe Experience Platform的调查扩展。有关扩展功能的详细信息，请参阅[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100164.html)上的扩展页。
