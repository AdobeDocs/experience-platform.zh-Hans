...
[!DNL Foresee] 是Adobe Experience Platform的调查延伸。有关扩展功能的详细信息，请参见[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100164.html)上的扩展页。
...
有关扩展配置选项的信息，请参见AdobeExchange上的[Foresee扩展页](https://exchange.adobe.com/experiencecloud.details.100164.html)。
