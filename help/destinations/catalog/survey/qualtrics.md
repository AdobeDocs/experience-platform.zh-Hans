...
description: Qualtrics网站反馈扩展是Adobe Experience Platform中的调查目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
...
[!DNL Qualtrics Website Feedback] 使您能够在恰当的时间用恰当的信息吸引网站访客。无论您是希望通过网站反馈调查改善访客体验还是提高转化率，[!DNL Qualtrics Website Feedback]都能满足您的需求。

使用直观的指向并单击界面，在几分钟内创建和部署目标明确、具有品牌的Web消息。 您从网站收集到的数据和洞察会与所有渠道的客户反馈数据一起呈现，这些数据提供了客户体验的完整视图 — 所有这一切都在一个平台上实现。

[!DNL Qualtrics Website Feedback] 是Adobe Experience Platform的调查扩展。有关扩展功能的详细信息，请参阅[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html)上的扩展页。
...
安装[!DNL Qualtrics Website Feedback]扩展：
...
有关扩展配置选项和安装支持的信息，请参阅Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html)上的[ Qualtrics网站反馈页。
