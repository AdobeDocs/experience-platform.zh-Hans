---
keywords: Qualtrics；Qualtrics；Qualtrics网站反馈；Qualtrics网站反馈；Qualtricks网站反馈
title: Qualtrics网站反馈扩展
description: Qualtrics网站反馈扩展是Adobe Experience Platform中的调查目标。 有关扩展功能的更多信息，请参阅Adobe Exchange上的扩展页面。
...
[!DNL Qualtrics Website Feedback]允许您在正确的时间通过正确的消息吸引网站访客。 无论您是要通过网站反馈调查来改善访客体验，还是要提高转化率，[!DNL Qualtrics Website Feedback]都可以为您提供内容。

使用直观的点击式界面，只需几分钟即可创建和部署具有高度针对性的品牌化Web消息。 您从网站收集的数据和见解与所有渠道的客户反馈数据一起显示，完整地反映了您的客户体验 — 所有这些都在一个平台上。

[!DNL Qualtrics Website Feedback]是[!DNL Adobe Experience Platform]中的调查扩展。 有关扩展功能的更多信息，请参阅[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html)上的扩展页面。

此目标是标记扩展。 有关标记扩展如何在Experience Platform中工作的更多信息，请参阅[标记扩展概述](../launch-extensions/overview.md)。

![Qualtrics网站反馈扩展](../../assets/catalog/survey/qualtrics/catalog.png)
...
要安装[!DNL Qualtrics Website Feedback]扩展，请执行以下操作：
...
有关扩展配置选项和安装支持的信息，请参阅Adobe Exchange[上的](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html)Qualtrics网站反馈页面。
