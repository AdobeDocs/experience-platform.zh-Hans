...
[!DNL Qualtrics Website Feedback]是Adobe Experience Platform中的调查扩展。 有关扩展功能的详细信息，请参阅[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html)上的扩展页面。
...
有关扩展配置选项和安装支持的信息，请参阅Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html)上的[Qualtrics网站反馈页面。
