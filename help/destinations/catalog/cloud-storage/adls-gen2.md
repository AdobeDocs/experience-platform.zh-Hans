...
在&#x200B;**[!UICONTROL 计划]**&#x200B;步骤中，您可以[为[!DNL Azure Data Lake Storage Gen2]目标设置导出计划](/help/destinations/ui/activate-batch-profile-destinations.md#scheduling)，还可以[配置导出文件的名称](/help/destinations/ui/activate-batch-profile-destinations.md#file-names)。
