...
有关如何连接到云存储目标（包括[!DNL Amazon]支持的目标）的说明，请参阅[云存储目标工作流](./workflow.md)。
...
![验证步骤中的输入字段](../../assets/catalog/cloud-storage/amazon-kinesis/authentication.png)
...
请参阅[将配置文件和区段激活到目标](../../ui/activate-destinations.md) ，以了解有关区段激活工作流的信息。
