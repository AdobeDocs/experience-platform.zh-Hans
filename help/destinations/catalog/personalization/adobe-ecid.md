...
[!DNL Experience Cloud] ID服务是Adobe Experience Platform中的一个个性化扩展。有关扩展功能的更多信息，请参阅[!DNL Experience Platform Launch]文档中的[Experience CloudID服务扩展页面](../../../tags/extensions/web/id-service/overview.md)。
...
有关扩展配置选项和安装支持的信息，请参阅[!DNL Experience Launch]文档中的[Experience CloudID服务扩展页面](../../../tags/extensions/web/id-service/overview.md)。
