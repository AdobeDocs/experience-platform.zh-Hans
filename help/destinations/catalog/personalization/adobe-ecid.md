...
description: Experience CloudID服务扩展是Adobe Experience Platform的个性化目标。 有关扩展功能的详细信息，请参阅AdobeExchange上的扩展页。
seo-description: Experience CloudID服务扩展是Adobe Experience Platform的个性化目标。 有关扩展功能的详细信息，请参阅AdobeExchange上的扩展页。
...
此扩展实现[!DNL Experience Cloud] ID服务，它标识所有[!DNL Experience Cloud]解决方案中的访客。

[!DNL Experience Cloud] ID服务是Adobe Experience Platform的个性化扩展。有关扩展功能的详细信息，请参阅[!DNL Experience Platform Launch]文档中的[Experience CloudID服务扩展页面](https://experienceleague.adobe.com/docs/launch/using/extensions-ref/adobe-extension/id-service-extension/overview.html)。
...
此扩展位于已购买平台的所有客户的目标目录中。

要使用此扩展，您需要访问[!DNL Experience Platform Launch]。 [!DNL Experience Platform Launch] 作为附带的增值功能提供给Adobe Experience Cloud客户。请与您的组织管理员联系以获取对[!DNL Launch]的访问权限，并要求他们授予您&#x200B;**[!UICONTROL manage_properties]**&#x200B;权限，以便您可以安装扩展。
...
有关扩展配置选项和安装支持的信息，请参阅[!DNL Experience Launch]文档中的[Experience CloudID服务扩展页](https://experienceleague.adobe.com/docs/launch/using/extensions-ref/adobe-extension/id-service-extension/overview.html)。
