---
keywords: Foresee;Foresee扩展；Foreseedestination
title: Gainsight扩展
description: Gainsight扩展是Adobe Experience Platform中的一个个性化目标。 有关扩展功能的更多信息，请参阅Exchange上的扩展页面Adobe。
...
[!DNL Gainsight] 可让产品所有者使用工具深入了解用户行为、推动产品采用并收集用户反馈。

[!DNL Gainsight] 是Adobe Experience Platform中的一个个性化扩展。有关扩展功能的更多信息，请参阅[AdobeExchange](https://www.adobeexchange.com/experiencecloud.details.103343.html)上的扩展页面。
...
有关扩展配置选项和安装支持的信息，请参阅AdobeExchange](https://www.adobeexchange.com/experiencecloud.details.103343.html)上的[Gainsight页面。
