...
keywords: 可预测；可预测
title: Gainsight扩展
description: Gainsight扩展是Adobe Experience Platform中的个性化目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
...
[!DNL Gainsight] 是Adobe Experience Platform的个性化扩展。有关扩展功能的详细信息，请参阅[AdobeExchange](https://www.adobeexchange.com/experiencecloud.details.103343.html)上的扩展页。
