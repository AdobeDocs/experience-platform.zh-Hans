...
description: Gainsight扩展是实时客户数据平台中的个性化目标。 有关扩展功能的详细信息，请参阅AdobeExchange上的扩展页。
seo-description: Gainsight扩展是实时客户数据平台中的个性化目标。 有关扩展功能的详细信息，请参阅AdobeExchange上的扩展页。
...
[!DNL Gainsight] 是实时客户数据平台中的个性化扩展。 有关扩展功能的详细信息，请参阅Adobe交换上的扩 [展页](https://www.adobeexchange.com/experiencecloud.details.103343.html)。
...
有关扩展配置选项和安装支持的信息，请参 [阅AdobeExchange的Gainsight页](https://www.adobeexchange.com/experiencecloud.details.103343.html)。
