...
title: Gainsight扩展
seo-title: Gainsight扩展
description: Gainsight扩展是Adobe Experience Platform的个性化目标。 有关扩展功能的详细信息，请参阅AdobeExchange上的扩展页。
seo-description: Gainsight扩展是Adobe Experience Platform的个性化目标。 有关扩展功能的详细信息，请参阅AdobeExchange上的扩展页。
...
# [!DNL Gainsight] 扩展 {#gainsight-extension}

## 概述 {#overview}

[!DNL Gainsight] 使产品所有者能够借助这些工具深入理解用户行为、推动产品采用并收集用户反馈。

[!DNL Gainsight] 是Adobe Experience Platform的个性化扩展。有关扩展功能的详细信息，请参见[AdobeExchange](https://www.adobeexchange.com/experiencecloud.details.103343.html)上的扩展页。
...
![Gainsight扩展](../../assets/catalog/personalization/gainsight/catalog.png)
...
有关扩展配置选项和安装支持的信息，请参见AdobeExchange](https://www.adobeexchange.com/experiencecloud.details.103343.html)上的[ Gainsight页。
