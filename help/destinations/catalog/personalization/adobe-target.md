...
有关扩展配置选项的信息，请参阅Experience [!DNL Launch]文档中的[Adobe Target扩展页面](https://experienceleague.adobe.com/docs/launch/using/extensions-ref/adobe-extension/target-extension/overview.html)。
