...
有关扩展配置选项的信息，请参阅体验 [文档中的Adobe Target](https://experienceleague.adobe.com/docs/launch/using/extensions-ref/adobe-extension/target-extension/overview.html) 扩展 [!DNL Launch] 页面。
