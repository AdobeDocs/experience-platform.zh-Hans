...
title: KickFire扩展
description: KickFire扩展是Adobe Experience Platform中的个性化目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
...
[!DNL KickFire's] IP地址智能和B2B云数据使您能够将IP地址转换为公司，识别匿名Web访客，并将帐户数据集成到技术堆栈中 — 所有这一切都取决于公司的IP地址。

[!DNL KickFire] 是Adobe Experience Platform的个性化扩展。有关扩展功能的详细信息，请参阅[Kickfire网站](https://www.kickfire.com/)。
