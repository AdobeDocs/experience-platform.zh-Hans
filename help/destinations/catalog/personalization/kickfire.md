...
title: KickFire扩展
description: KickFire扩展是Adobe Experience Platform中的个性化目标。 有关扩展功能的更多信息，请参阅Exchange上的扩展页面Adobe。
...
[!DNL KickFire's] IP地址智能和B2B云图数据允许您将IP地址转换到公司，识别匿名Web访客，并将帐户数据集成到您的技术堆栈中 — 所有这些都基于公司的IP地址。

[!DNL KickFire] 是Adobe Experience Platform中的一个个性化扩展。有关扩展功能的更多信息，请参阅[Kickfire网站](https://www.kickfire.com/)。
