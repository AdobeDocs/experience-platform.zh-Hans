---
keywords: Marketo Web Personalization;marketo Web Personalization;Marketo Web Personalization扩展；marketo Web Personalization扩展；marketo Web Personalization扩展；marketo;Marketo
title: Marketo Web Personalization扩展
description: Marketo Web Personalization扩展是Adobe Experience Platform中的个性化目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
...
此扩展部署[!DNL Marketo’s] Web个性化和ContentAI应用程序的脚本。 [!DNL Marketo] Web Personalization可以唯一地识别内容并将其个性化到Web访客特征，如匿名访客的动态图形，以及针对已知访客的参与平 [!DNL Marketo] 台中的各种行为属性。[!DNL Marketo] ContentAI包含针对B2B客户特有的Web和电子邮件活动的基于AI的推荐和个性化功能。

[!DNL Marketo Web Personalization] 是Adobe Experience Platform的个性化扩展。有关扩展功能的详细信息，请参阅[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.101232.marketo-web-personalization.html)上的扩展页。
...
安装[!DNL Marketo Web Personalization]扩展：
...
有关扩展配置选项和安装支持的信息，请参阅Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101232.marketo-web-personalization.html)上的“Marketo Web Personalization”页。[
