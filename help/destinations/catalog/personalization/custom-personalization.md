...
此集成由[Adobe Experience Platform Web SDK](/help/web-sdk/home.md)或[Adobe Experience Platform Mobile SDK](https://developer.adobe.com/client-sdks/documentation/)提供支持。 您必须使用这些SDK之一才能使用此目标。
