...
title: Beemray扩展
description: Beemray扩展是Adobe Experience Platform中的个性化目标。 有关扩展功能的更多信息，请参阅Adobe Exchange上的扩展页面。
...
[!DNL Beemray]帮助您通过情景上下文加速您的产品。 使您能够获得见解、构建新体验、推动交互并参与真正重要的时刻。 Beemray使用机器学习实现了情境智能自动化。 Beemray连接到[!DNL Adobe Experience Cloud]和您的其他技术合作伙伴。 所有事情都是实时发生的。 此扩展在您的网站上安装[!DNL Beemray] SDK。

Beemray是[!DNL Adobe Experience Platform]中的个性化扩展。 有关扩展功能的更多信息，请参阅[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101063.beemray-human-context.html)上的扩展页面。
...
有关扩展配置选项和安装支持的信息，请参阅Adobe Exchange[上的](https://exchange.adobe.com/experiencecloud.details.101063.beemray-human-context.html)Beemray页。
