...
| 项目 | 类型 | 注释 |
---------|----------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 导出类型 | **[!UICONTROL 基于配置文件]** | 您正在导出区段（受众）的所有成员，这些成员具有标识符(user_id、anonymous_id)以及您导出到[!DNL Moengage]时定义的自定义属性。 |
...
* **[!UICONTROL 用户名]**： [!DNL Moengage]仪表板的设置页面的数据应用程序ID。
* **[!UICONTROL 密码]**： [!DNL Moengage]仪表板的设置页面中的数据应用密钥。

![Moengage目标身份验证](../../assets/catalog/mobile-engagement/moengage/destination_details.png)

* **[!UICONTROL 名称]**：将来用于识别此目标的名称。
* **[!UICONTROL 描述]**：可帮助您将来识别此目标的描述。
* **[!UICONTROL 地区]**：您的应用程序&#x200B;*数据中心*。
...
在[!UICONTROL 目标字段]部分中，选择字段右侧的映射图标。
