---
keywords: Google全局网站标记；Gatg;Google Gtag;Google扩展；Google Gtag扩展；GTAG
title: Google全局网站标签扩展
description: Google全局网站标签扩展是Adobe Experience Platform中的一个分析目标。 有关扩展功能的更多信息，请参阅Exchange上的扩展页面Adobe。
...
通过[!DNL Google's Global Site Tag]或gtag.js将数据发送到[!DNL Google Analytics]、[!DNL Google Ads]和[!DNL Google Marketing Platform]。 可以为每个产品配置多个帐户。

[!DNL Google Global Site Tag] 是Adobe Experience Platform中的一项analytics扩展。有关扩展功能的更多信息，请参阅[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.101437.google-global-site-tag-gtag.html)上的扩展页面。

此目标是一个标记扩展。 有关标记扩展如何在Platform中工作的更多信息，请参阅[标记扩展概述](../launch-extensions/overview.md)。

![Google全局网站标签扩展](../../assets/catalog/analytics/gtag-analytics/catalog.png)
...
有关扩展配置选项的信息，请参阅扩展的[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.101437.google-global-site-tag-gtag.html)页面。
