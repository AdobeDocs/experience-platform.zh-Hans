---
keywords: Google全局网站标签；gtag;google gtag;google extension;google gtag extension;GTAG
title: Google Global Site Tag Extension
description: Google全球站点标记扩展是Adobe Experience Platform中的一个分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
...
通过[!DNL Google's Global Site Tag]或gtag.js将数据发送到[!DNL Google Analytics]、[!DNL Google Ads]和[!DNL Google Marketing Platform]。 可以配置每个产品的多个帐户。

[!DNL Google Global Site Tag] 是Adobe Experience Platform的分析扩展。有关扩展功能的详细信息，请参阅[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.101437.google-global-site-tag-gtag.html)上的扩展页。
...
有关扩展配置选项的信息，请参阅扩展的[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.101437.google-global-site-tag-gtag.html)页。
