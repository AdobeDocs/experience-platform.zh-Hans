...
description: Google Universal Analytics扩展是Adobe Experience Platform中的一个分析目标。 有关扩展功能的更多信息，请参阅Exchange上的扩展页面Adobe。
...
[!DNL Google Universal Analytics] 可让您衡量广告投资回报率，并跟踪您的Flash、视频、社交网站和应用程序。

[!DNL Google Universal Analytics] 是Adobe Experience Platform中的一项analytics扩展。有关扩展功能的更多信息，请参阅[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.102829.google-universal-analytics.html)上的扩展页面。
...
有关扩展配置选项的信息，请参阅Exchange上的[Google Universal Analytics扩展页面](https://exchange.adobe.com/experiencecloud.details.102829.google-universal-analytics.html)Adobe。
