...
[!DNL Google Universal Analytics] 是Adobe Experience Platform的分析扩展。有关扩展功能的详细信息，请参见[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.102829.google-universal-analytics.html)上的扩展页。
...
有关扩展配置选项的信息，请参阅AdobeExchange上的[Google Universal Analytics扩展页面](https://exchange.adobe.com/experiencecloud.details.102829.google-universal-analytics.html)。
