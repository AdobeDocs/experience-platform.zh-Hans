...
[!DNL Google Universal Analytics]是Adobe Experience Platform中的Analytics扩展。 有关扩展功能的详细信息，请参阅[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.102829.google-universal-analytics.html)上的扩展页面。
...
有关扩展配置选项的信息，请参阅Adobe Exchange上的[Google Universal Analytics扩展页](https://exchange.adobe.com/experiencecloud.details.102829.google-universal-analytics.html)。
