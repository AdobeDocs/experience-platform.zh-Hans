...
description: Google Universal Analytics扩展是Adobe Experience Platform中的一个分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
...
[!DNL Google Universal Analytics] 使您能够衡量广告投资回报，并跟踪Flash、视频、社交网站和应用。

[!DNL Google Universal Analytics] 是Adobe Experience Platform的分析扩展。有关扩展功能的详细信息，请参阅[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.102829.google-universal-analytics.html)上的扩展页。
...
安装[!DNL Google Universal Analytics]扩展：
