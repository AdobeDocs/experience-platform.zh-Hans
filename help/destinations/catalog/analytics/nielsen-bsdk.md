...
[!DNL Nielsen BSDK]是Adobe Experience Platform中的Analytics扩展。 有关扩展功能的详细信息，请参阅[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101361.html)上的扩展页面。
