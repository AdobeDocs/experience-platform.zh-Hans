...
[!DNL Nielsen BSDK]是[!DNL Adobe Experience Platform]中的Analytics扩展。 有关扩展功能的更多信息，请参阅[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101361.html)上的扩展页面。
...
有关扩展配置选项和安装支持的信息，请参阅Adobe Exchange[上的](https://exchange.adobe.com/experiencecloud.details.101361.html)Nielsen BSDK页面。
