---
keywords: clicktale;clicktale扩展；clicktale目标
title: Clicktale扩展
description: Clicktale扩展是Adobe Experience Platform中的一个分析目标。 有关扩展功能的更多信息，请参阅Exchange上的扩展页面Adobe。
...
[!DNL Clicktale's] 与Experience Platform Launch集成后，可以使 [!DNL Clicktale] 用可视化编辑器部署代码，并在Launch中映射 [!DNL Clicktale's] 数据元素。

[!DNL Clicktale] 是Adobe Experience Platform中的一项analytics扩展。有关扩展功能的更多信息，请参阅[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100082.html)上的扩展页面。
...
![Clicktale扩展](../../assets/catalog/analytics/clicktale/catalog.png)
...
有关扩展配置选项的信息，请参阅Exchange中的[Clicktale扩展页面](https://exchange.adobe.com/experiencecloud.details.100082.html)Adobe。
