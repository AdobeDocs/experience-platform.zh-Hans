...
[!DNL Clicktale] 是Adobe Experience Platform的分析扩展。有关扩展功能的详细信息，请参见[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100082.html)上的扩展页。
...
有关扩展配置选项的信息，请参阅AdobeExchange中的[Clicktale扩展页面](https://exchange.adobe.com/experiencecloud.details.100082.html)。
