...
[!DNL Clicktale]是Adobe Experience Platform中的Analytics扩展。 有关扩展功能的更多信息，请参阅[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100082.html)上的扩展页面。
...
有关扩展配置选项的信息，请参阅Adobe Exchange中的[Clicktale扩展页](https://exchange.adobe.com/experiencecloud.details.100082.html)。
