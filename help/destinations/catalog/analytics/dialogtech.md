...
title: DialogTech扩展
description: DialogTech扩展是Adobe Experience Platform中的分析目标。 有关扩展功能的更多信息，请参阅Adobe Exchange上的扩展页面。
...
[!DNL DialogTech]是[!DNL Adobe Experience Platform]中的Analytics扩展。 有关扩展功能的详细信息，请参阅[Dialogtech网站](https://www.dialogtech.com/)。
