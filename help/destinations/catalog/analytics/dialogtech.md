---
keywords: dialogtech extension;dialogtech;dialogtech destination;dialogtech;dialogtech;DialogTech;DialogTech SourceTrak
title: DialogTech扩展
description: DialogTech扩展是Adobe Experience Platform中的分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
...
在Adobe启动中包含[!DNL DialogTech SourceTrak] javascript片段
