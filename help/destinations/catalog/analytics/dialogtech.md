---
keywords: dialogtech扩展；dialogtech;dialogtech目标；DialogTech;DialogTech SourceTrak
title: DialogTech扩展
description: DialogTech扩展是Adobe Experience Platform中的一个分析目标。 有关扩展功能的更多信息，请参阅Exchange上的扩展页面Adobe。
...
在Launch中包含[!DNL DialogTech SourceTrak] javascript代码片段Adobe

[!DNL DialogTech] 是Adobe Experience Platform中的一项analytics扩展。有关扩展功能的更多信息，请参阅[Dialogtech网站](https://www.dialogtech.com/)。
