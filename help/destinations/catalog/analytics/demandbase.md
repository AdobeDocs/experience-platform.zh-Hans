...
[!DNL Demandbase] 是Adobe Experience Platform的分析扩展。有关扩展功能的详细信息，请参见[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.101605.html)上的扩展页。
...
有关扩展配置选项的信息，请参见AdobeExchange上的[Demandbase扩展页面](https://exchange.adobe.com/experiencecloud.details.101605.html)。
