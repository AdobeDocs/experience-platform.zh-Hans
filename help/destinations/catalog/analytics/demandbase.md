...
在[!DNL Demandbase]中直接获取[!DNL Adobe Analytics]个B2B帐户洞察，您可以在此按行业、收入和目标帐户细分流量和行为。 此基于帐户的视图为您最有价值的访客提供了关于参与、转化和来源的独特见解。

[!DNL Demandbase]是[!DNL Adobe Experience Platform]中的Analytics扩展。 有关扩展功能的更多信息，请参阅[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101605.html)上的扩展页面。
...
有关扩展配置选项的信息，请参阅Adobe Exchange上的[Demandbase扩展页](https://exchange.adobe.com/experiencecloud.details.101605.html)。
