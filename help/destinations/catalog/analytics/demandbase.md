---
keywords: demandbase extension;demanbase;demandbase destination
title: Demandbase扩展
description: Demandbase扩展是Adobe Experience Platform中的一个分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
...
直接在Adobe Analytics中获取[!DNL Demandbase] B2B帐户洞察，在此您可以按行业、收入和目标帐户细分流量和行为。 此基于帐户的视图可为最有价值的访客提供关于参与度、转化率和来源的独特洞察。

[!DNL Demandbase] 是Adobe Experience Platform的分析扩展。有关扩展功能的详细信息，请参阅[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.101605.html)上的扩展页。
...
有关扩展配置选项的信息，请参阅Adobe Exchange上的[Demandbase扩展页面](https://exchange.adobe.com/experiencecloud.details.101605.html)。
