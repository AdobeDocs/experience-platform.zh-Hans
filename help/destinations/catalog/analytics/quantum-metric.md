---
keywords: 量子量度扩展量子量度量度量度量度
title: 量子度量扩展
description: 量子量度扩展是Adobe Experience Platform中的分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
...
[!DNL Quantum Metric's] 与Adobe Launch集成有助于数据收集标 [!DNL Quantum Metric's] 签的无代码部署。此外，此扩展还优惠了从[!DNL Quantum Metric] API捕获包含有用信息的启动数据元素的功能。

[!DNL Quantum Metric] 是Adobe Experience Platform的分析扩展。有关扩展功能的详细信息，请参阅[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.101535.quantum-metric-extension-for-adobe-launch.html)上的扩展页。
...
有关扩展配置选项和安装支持的信息，请参阅Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101535.quantum-metric-extension-for-adobe-launch.html)上的“量子度量”页。[
