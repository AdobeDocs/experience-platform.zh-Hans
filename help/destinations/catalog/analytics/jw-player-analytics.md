...
description: JW Player Analytics（测试版）扩展是Adobe Experience Platform中的分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
...
此扩展将安装[!DNL JW Player]适配器，以将[!DNL JW Player]事件连接到Adobe Video Analytics。 利用Adobe视频分析的强大功能，获得详细的洞察，以了解客户的视频观看习惯。

[!DNL JW Player Analytics] （测试版）是Adobe Experience Platform中的分析扩展。有关扩展功能的详细信息，请参阅[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.101523.jw-player-analytics-launch-extension.html)上的扩展页。
...
![JW分析扩展](../../assets/catalog/analytics/jw-analytics/catalog.png)
...
安装[!DNL JW Player Analytics]（测试版）扩展：
...
有关扩展配置选项的信息，请参阅Adobe Exchange中的[JW Player Analytics(Beta)扩展页面](https://exchange.adobe.com/experiencecloud.details.101523.jw-player-analytics-launch-extension.html)。
