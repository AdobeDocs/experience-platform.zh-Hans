...
[!DNL TMMData's] Foundation Platform for Adobe Marketing Cloud为营销团队提供了工具，使其能够访问和混合所有关键数据源（包括内部/外部和在线/离线数据），以实现有信心、全面的跨渠道分析，同时还可以自动设置营销活动并直接导入到Adobe和其他分析和BI工具。

[!DNL TMMData]是[!DNL Adobe Experience Platform]中的Analytics扩展。 有关扩展功能的更多信息，请参阅[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100148.tmmdata-foundation-platform.html)上的扩展页面。
...
有关扩展配置选项和安装支持的信息，请参阅Adobe Exchange[上的](https://exchange.adobe.com/experiencecloud.details.100148.tmmdata-foundation-platform.html)TMMData页。
