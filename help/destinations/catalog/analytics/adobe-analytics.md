...
# [!DNL Adobe Analytics] 扩展

## 概述 {#overview}

[!DNL Adobe Analytics]是一款行业领先的解决方案，可帮助您了解客户的种种需求，并根据客户情报掌控业务发展方向。

[!DNL Adobe Analytics]是[!DNL Adobe Experience Platform]中的Analytics扩展。 有关扩展功能的更多信息，请参阅标记文档中的[Adobe Analytics扩展概述](/help/tags/extensions/client/analytics/overview.md)。
...
要使用此扩展，您需要具有对Experience Platform中标记的访问权限。 标记以内置增值功能的方式提供给[!DNL Adobe Experience Cloud]客户。 请联系您的组织管理员以获取数据收集UI的访问权限，并让他们向您授予&#x200B;**[!UICONTROL manage_properties]**&#x200B;权限，以便您能够安装扩展。

## 安装扩展 {#install-extension}

要安装[!DNL Adobe Analytics]扩展，请执行以下操作：
...
有关扩展配置选项的信息，请参阅[Adobe Analytics扩展页面](https://experienceleague.adobe.com/docs/platform-learn/implement-in-websites/implement-solutions/analytics.html?lang=zh-Hans)标记文档。
