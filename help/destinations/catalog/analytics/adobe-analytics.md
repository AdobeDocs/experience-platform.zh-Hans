...
有关扩展配置选项的信息，请参阅标记文档中的[Adobe Analytics扩展页面](https://experienceleague.adobe.com/docs/platform-learn/implement-in-websites/implement-solutions/analytics.html)。
