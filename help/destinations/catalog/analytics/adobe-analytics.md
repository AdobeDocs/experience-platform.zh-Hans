...
有关扩展配置选项的信息，请参阅标记文档中的[Adobe Analytics扩展页面](https://experienceleague.adobe.com/docs/launch-learn/implementing-in-websites-with-launch/implement-solutions/analytics.html)。
