---
keywords: Nielsen IMA Handler;nielsen ima处理函数；ima;Nielsen ima;Nielsen IMA
title: Nielsen IMA Handler扩展
description: Nielsen IMA Handler扩展是Adobe Experience Platform中的一个分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
