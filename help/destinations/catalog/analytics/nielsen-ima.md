---
keywords: Nielsen IMA处理程序；nielsen ima处理程序；nielsen ima;Nielsen ima;Nielsen IMA
title: Nielsen IMA处理程序扩展
description: Nielsen IMA处理程序扩展是Adobe Experience Platform中的一个分析目标。 有关扩展功能的更多信息，请参阅Exchange上的扩展页面Adobe。
...
[!DNL Nielsen IMA Handler] 是Adobe Experience Platform中的一项analytics扩展。
