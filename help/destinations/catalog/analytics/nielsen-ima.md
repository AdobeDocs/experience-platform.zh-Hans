---
keywords: Nielsen IMA Handler；Nielsen IMA Handler；Nielsen IMA；Nielsen IMA
title: Nielsen IMA处理程序扩展
description: Nielsen IMA Handler扩展是Adobe Experience Platform中的分析目标。 有关扩展功能的更多信息，请参阅Adobe Exchange上的扩展页面。
...
[!DNL Nielsen IMA Handler]是[!DNL Adobe Experience Platform]中的Analytics扩展。
...
要安装[!DNL Nielsen IMA Handler]扩展，请执行以下操作：
