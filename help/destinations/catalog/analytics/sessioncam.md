---
keywords: 会话摄像头；会话摄像头；会话摄像头
title: SessionCam扩展
description: SessionCam扩展是Adobe Experience Platform中的分析目标。 有关扩展功能的更多信息，请参阅Adobe Exchange上的扩展页面。
...
[!DNL SessionCam]提供了一整套基本工具，这些工具可揭示用户行为并向您显示要修复的最重要问题。

[!DNL SessionCam]是[!DNL Adobe Experience Platform]中的Analytics扩展。 有关扩展功能的更多信息，请参阅[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100517.html)上的扩展页面。

此目标是标记扩展。 有关标记扩展如何在Experience Platform中工作的更多信息，请参阅[标记扩展概述](../launch-extensions/overview.md)。

![SessionCam扩展](../../assets/catalog/analytics/sessioncam/catalog.png)
...
有关扩展配置选项和安装支持的信息，请参阅Adobe Exchange[上的](https://exchange.adobe.com/experiencecloud.details.100517.html)SessionCam页。
