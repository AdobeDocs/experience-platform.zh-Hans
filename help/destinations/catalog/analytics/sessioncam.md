...
title: SessionCam扩展
description: SessionCam扩展是Adobe Experience Platform中的分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
...
[!DNL SessionCam] 提供了一套基本工具，可揭示用户行为并向您显示要修复的最重要问题。

[!DNL SessionCam] 是Adobe Experience Platform的分析扩展。有关扩展功能的详细信息，请参阅[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100517.html)上的扩展页。
