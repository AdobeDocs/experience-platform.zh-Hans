...
seo-description: Parse.ly Analytics扩展是Adobe Experience Platform的一个分析目标。 有关扩展功能的详细信息，请参阅AdobeExchange上的扩展页。
...
Parse.ly是Adobe Experience Platform的分析扩展。 有关扩展功能的详细信息，请参阅[Parse.ly Analytics](https://www.parse.ly/)。
