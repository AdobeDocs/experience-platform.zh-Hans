---
keywords: 解析。 Ly；解析；解析；parse.ly；Parse.ly
title: Parse.ly Analytics扩展
description: Parse.ly Analytics扩展是Adobe Experience Platform中的分析目标。 有关扩展功能的更多信息，请参阅Adobe Exchange上的扩展页面。
...
Parse.ly是Adobe Experience Platform中的一个Analytics扩展。 有关扩展功能的详细信息，请参阅[Parse.ly Analytics](https://www.parse.ly/)。
