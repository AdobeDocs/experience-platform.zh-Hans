---
keywords: 解析。 ly;parsely;parsely;parsely;parsey.ly;parsey.ly
title: Parse.ly Analytics扩展
description: Parse.ly Analytics扩展是Adobe Experience Platform中的分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
...
[!DNL Parse.ly Analytics] 帮助2,500多名公司使用数据了解其在线受众。此扩展安装一个JavaScript代码片段，该代码段跟踪访客与您站点内容的交互方式。

Parse.ly是Adobe Experience Platform中的分析扩展。 有关扩展功能的详细信息，请参阅[Parse.ly Analytics](https://www.parse.ly/)。
