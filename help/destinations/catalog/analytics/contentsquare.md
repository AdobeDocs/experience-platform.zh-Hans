...
description: Contentsquare扩展是Adobe Experience Platform中的一个分析目标。 有关扩展功能的更多信息，请参阅Exchange上的扩展页面Adobe。
...
可视化页面内行为，请参阅客户放弃的原因和改进方式。 将收入归因于每个Analytics区段和Target测试的UX和内容元素。 安装[!DNL Contentsquare]标记，设置自定义变量和事件。 只需单击几下，即可开始收集数据以供UX分析使用。

[!DNL Contentsquare] 是Adobe Experience Platform中的一项analytics扩展。有关扩展功能的更多信息，请参阅[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100364.html)上的扩展页面。
...
要安装[!DNL Contentsquare]扩展，请执行以下操作：
...
有关扩展配置选项的信息，请参阅Exchange上的[Contentsquare扩展页面](https://exchange.adobe.com/experiencecloud.details.100364.html)Adobe。
