...
description: Contentsquare扩展是Adobe Experience Platform中的分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
...
直观地显示页面内行为，了解客户放弃的原因以及您如何改进。 将收入归因于每个Analytics细分和目标测试的UX和内容元素。 安装[!DNL Contentsquare]标记，设置自定义变量和事件。 开始只需单击几下即可收集UX分析的数据。

[!DNL Contentsquare] 是Adobe Experience Platform的分析扩展。有关扩展功能的详细信息，请参阅[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100364.html)上的扩展页。
...
有关扩展配置选项的信息，请参阅Adobe Exchange上的[Contentsquare扩展页](https://exchange.adobe.com/experiencecloud.details.100364.html)。
