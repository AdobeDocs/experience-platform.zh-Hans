...
title: Adform网站跟踪扩展
description: Adform扩展是Adobe Experience Platform中的分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
...
Adform网站跟踪扩展使广告商能够使用[!DNL Experience Platform Launch]平台在其网站上轻松实现Adform跟踪点。

[!DNL Adform] 是Adobe Experience Platform的分析扩展。有关扩展功能的详细信息，请参阅[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.103195.adform-website-tracking.html)上的扩展页
...
有关扩展配置选项和安装支持的信息，请参阅Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103195.adform-website-tracking.html)上的[Adform页。
