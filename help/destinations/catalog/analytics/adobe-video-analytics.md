...
Adobe媒体音频和视频分析是Adobe Experience Platform的分析扩展。 有关扩展功能的详细信息，请参见[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100157.html)上的扩展页。
...
有关扩展配置选项的信息，请参阅[!DNL Experience Launch]文档中的[“Adobe音频和视频媒体分析”扩展页面](https://experienceleague.adobe.com/docs/launch/using/extensions-ref/adobe-extension/media-analytics-extension/overview.html)。
