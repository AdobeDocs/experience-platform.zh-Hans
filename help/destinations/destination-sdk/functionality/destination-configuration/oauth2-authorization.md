...
通过阅读本文，您现在了解[!DNL Adobe Experience Platform]支持的OAuth 2授权模式，并知道如何使用OAuth 2授权支持配置您的目标。 接下来，您可以使用Destination SDK设置支持OAuth 2的目标。 阅读[使用Destination SDK配置目标](../../guides/configure-destination-instructions.md)以了解后续步骤。
