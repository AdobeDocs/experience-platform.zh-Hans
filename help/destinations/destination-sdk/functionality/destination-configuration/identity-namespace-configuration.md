...
* 允许用户将[自定义身份命名空间](../../../../identity-service/features/namespaces.md#create-namespaces)映射到您自己的身份命名空间。
...
## 配置可选源字段散列 {#configure-optional-hashing}
...
在使用未经过哈希处理的源字段时选中此选项，以便在激活时让[!DNL Adobe Experience Platform]自动对其进行哈希处理。
...
## 配置强制源字段散列 {#configure-mandatory-hashing}
