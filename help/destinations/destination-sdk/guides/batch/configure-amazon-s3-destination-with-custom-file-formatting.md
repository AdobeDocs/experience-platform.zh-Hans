...
本页介绍如何使用Destination SDK通过自定义配置Amazon S3目标 [文件格式选项](configure-file-formatting-options.md) 和定制 [文件名配置](../../functionality/destination-configuration/batch-configuration.md#file-name-configuration).
...
以下负载包括通用的Amazon S3配置（具有自定义） [CSV文件格式](../../functionality/destination-server/file-formatting.md) 配置参数，用户可以在Experience PlatformUI中定义这些参数。
...
![显示包含选定目标卡的目标目录页面的屏幕记录。](../../assets/guides/batch/destination-card.gif)
