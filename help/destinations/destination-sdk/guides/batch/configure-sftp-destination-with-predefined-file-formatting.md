...
本页介绍如何使用Destination SDK，通过预定义的默认SFTP目标配置 [文件格式选项](configure-file-formatting-options.md) 和定制 [文件名配置](../../functionality/destination-configuration/batch-configuration.md#file-name-configuration).
...
以下负载包括通用的SFTP配置，其中包含预定义的默认值 [CSV文件格式](../../functionality/destination-server/file-formatting.md) 配置参数，用户可以在Experience PlatformUI中定义这些参数。
