...
本页介绍如何使用Destination SDK配置具有预定义的默认值的SFTP目标 [文件格式选项](configure-file-formatting-options.md) 和自定义 [文件名配置](../../functionality/destination-configuration/batch-configuration.md#file-name-configuration).
...
以下有效负载包含常规SFTP配置，带有预定义的默认配置 [CSV文件格式](../../functionality/destination-server/file-formatting.md) 用户可以在Experience PlatformUI中定义的配置参数。
