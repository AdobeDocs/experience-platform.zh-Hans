...
此页面显示所有可用的配置选项 [!DNL Amazon S3] 目标。 您可以根据需要编辑以下步骤中显示的配置或删除配置的某些部分。
...
以下有效负载包含通用 [!DNL Amazon S3] 配置，预定义，默认 [CSV文件格式](../../functionality/destination-server/file-formatting.md) 用户可以在Experience PlatformUI中定义的配置参数。
