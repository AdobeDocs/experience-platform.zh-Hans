...
本页介绍如何使用Destination SDK配置 [!DNL Data Landing Zone] 自定义目标 [文件格式选项](../../server-and-file-configuration.md#file-configuration) 和定制 [文件名配置](../../file-based-destination-configuration.md#file-name-configuration).
...
以下负载包括一个通用 [!DNL Data Landing Zone] 配置，自定义 [CSV文件格式](../../server-and-file-configuration.md#file-configuration) 配置参数，用户可以在Experience PlatformUI中定义这些参数。
...
![显示包含选定目标卡的目标目录页面的屏幕记录。](../../assets/dlz-destination-card.gif)
