...
3. 使用您自己的模板调用[渲染模板API终结点](../../testing-api/streaming-destinations/create-template.md#render-template-api)。 Adobe根据您的架构生成示例配置文件，并返回结果或任何遇到的错误。
...
## 将字符转义模板添加到目标服务器配置 {#add-template-to-server-config}
