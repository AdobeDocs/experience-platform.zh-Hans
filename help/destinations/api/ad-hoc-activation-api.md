...
>[!IMPORTANT]
>
>请注意以下一次性限制：在运行临时激活作业之前，请确保根据您在[步骤3 — 在Platform UI](#activation-flow)中创建激活流中设置的计划首次激活受众时起已过去至少20分钟。
...
* [(Beta)使用Experience PlatformUI按需将文件导出到批处理目标](/help/destinations/ui/export-file-now.md)