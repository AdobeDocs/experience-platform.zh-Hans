...
使用帐户受众名称左侧的复选框选择要导出到目标的受众，然后选择&#x200B;**[!UICONTROL Next]**。

>[!NOTE]
>
>此视图中只显示&#x200B;*帐户受众*，不显示其他受众类型。
...
>[!NOTE]
>
>在将帐户受众导出到云存储目标时的计划步骤中，激活帐户受众的工作流仅允许您按每日计划导出[完整文件](/help/destinations/ui/activate-batch-profile-destinations.md#export-full-files)和[增量文件](/help/destinations/ui/activate-batch-profile-destinations.md#export-incremental-files) _。_&#x200B;不支持每小时导出。 **[!UICONTROL After audience evaluation]**&#x200B;是唯一支持的评估类型。
