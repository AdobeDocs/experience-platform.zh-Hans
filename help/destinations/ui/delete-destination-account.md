...
>[!TIP]
>
>在删除目标帐户之前，必须首先删除与目标帐户关联的任何现有数据流。 要删除现有的目标数据流，请参阅上的教程 [在UI中删除目标数据流](./delete-destinations.md).
...
3. 选择省略号(`...`)。 此时会出现一个弹出面板，其中提供以下选项 **[!UICONTROL 激活受众]**， **[!UICONTROL 编辑详细信息]**、和 **[!UICONTROL 删除]** 帐户。 选择 ![“删除”按钮](../assets/ui/workspace/pencil-icon.png) **[!UICONTROL 删除]** 按钮以删除所需的帐户。
...
有关如何使用以编程方式执行这些操作的步骤 [!DNL Flow Service] API，请参考上的教程 [使用流服务API删除连接](../api/delete-destination-account.md)
