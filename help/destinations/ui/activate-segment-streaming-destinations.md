...
![审阅步骤中的选择摘要。](/help/destinations/assets/ui/activate-segment-streaming-destinations/review.png)
...
![屏幕记录，其中显示了审阅步骤中可用的区段过滤器。](/help/destinations/assets/ui/activate-segment-streaming-destinations/filter-segments-review-step.gif)
