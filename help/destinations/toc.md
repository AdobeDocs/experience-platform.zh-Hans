...
* 目标目录{#catalog}
   ...
   * Adobe目标{#adobe}
      ...
      * [Experience Platform细分共享](https://experienceleague.adobe.com/docs/audience-manager/user-guide/implementation-integration-guides/integration-experience-platform/aam-aep-audience-sharing.html)
   * 广告目标{#advertising}
   ...
   * 电子邮件营销目标{#email-marketing}
      ...
      * [Oracle Elvoca连接](./catalog/email-marketing/oracle-eloqua.md)
   ...
   * 个性化目标{#personalization}
      ...
      * [贝姆雷延伸](./catalog/personalization/beemray.md)
