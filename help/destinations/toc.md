...
* UI指南 {#ui}
   ...
   * 将受众数据激活到目标{#activate}
      ...
      * [将受众数据激活到配置文件请求目标](./ui/activate-profile-request-destinations.md)
...
* 目标目录 {#catalog}
   ...
   * 广告目标{#advertising}
      ...
      * [(Beta) Snapchat Ads连接](./catalog/advertising/snap-inc.md)
   ...
   * 云存储目标 {#cloud-storage}
      ...
      * [允许列表云存储目标的IP地址](./catalog/cloud-storage/ip-address-allow-list.md)
   * 客户关系管理(CRM)目标 {#crm}
   ...
   * 电子邮件营销目标 {#email-marketing}
      ...
      * [Eloqua连接Oracle](./catalog/email-marketing/oracle-eloqua.md)
   ...
   * 个性化目标 {#personalization}
      ...
      * [(Beta) Adobe Commerce连接](./catalog/personalization/adobe-commerce.md)
...
* 目标 SDK {#destination-sdk}
   ...
   * Destination SDK功能 {#functionality}
      ...
      * [流式目标服务器和模板规范](./destination-sdk/server-and-template-configuration.md)
   ...
   * API操作 {#api}
      ...
      * 开发人员工具参考 {#developer-tools-reference}
         * 流式目标测试API {#streaming-destination-testing-api}
         ...
         * 基于文件的目标测试API {#file-based-destination-testing-api}
            ...
            * [根据源架构生成示例配置文件](./destination-sdk/file-based-sample-profile-generation-api.md)
            * [使用示例配置文件测试基于文件的目标](./destination-sdk/file-based-destination-testing-api.md)
            * [查看详细的激活结果](./destination-sdk/file-based-destination-results-api.md)
            * [验证模板化的客户字段](./destination-sdk/file-based-render-template-api.md)
   * 指南 {#guides}
      ...
      * [提交供审核在Destination SDK中创作的目标](./destination-sdk/submit-destination.md)
