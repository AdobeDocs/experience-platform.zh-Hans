...
* 目标的工作方式 {#how-destinations-work}
   ...
   * [流目标中的受众生命周期](./how-destinations-work/audience-lifecycle-streaming-destinations.md)
* API教程 {#api}
...
* UI 指南  {#ui}
   ...
   * 将数据激活到目标{#activate}
      ...
      * [延长在2024年11月之前创建的数据流的数据集导出计划](./ui/dataset-expiration-update.md)
...
* 目标目录 {#catalog}
   ...
   * Adobe目标{#adobe}
      ...
      * [Marketo Engage连接](./catalog/adobe/marketo-engage-connection.md)
   ...
   * Advertising目标{#advertising}
      ...
      * [(Beta) Acxiom RealID受众连接](./catalog/advertising/acxiom-real-id-audience-connection.md)
      * [Advertising目标概述](./catalog/advertising/overview.md)
      * [Adobe Advertising DSP连接](./catalog/advertising/adobe-advertising-dsp-connection.md)
      * [旧版Adobe Advertising Cloud DSP连接](./catalog/advertising/adobe-advertising-cloud-dsp-connection-legacy.md)
      * [Adobe Advertising Cloud扩展](./catalog/advertising/adobe-advertising-cloud.md)
      * [Adform连接](./catalog/advertising/adform.md)
      * [（旧版）Amazon Ads连接](./catalog/advertising/amazon-ads.md)
      * [Amazon Ads v2连接](./catalog/advertising/amazon-ads-v2.md)
      ...
      * {hide-from-toc}[(Beta) FreeWheel连接](./catalog/advertising/freewheel.md)
      ...
      * [（限量发布） Google Customer Match + DV360连接](./catalog/advertising/google-customer-match-dv360.md)
      ...
      * [Microsoft Ads客户匹配连接](./catalog/advertising/microsoft-ads-customer-match.md)
      ...
      * [Reddit自定义受众连接](./catalog/advertising/reddit-custom-audience.md)
   ...
   * 云存储目标 {#cloud-storage}
      ...
      * [基于文件的云存储目标的IP地址](./catalog/cloud-storage/ip-address-allow-list.md)
   * 客户关系管理(CRM)目标 {#crm}
   ...
   * 流目标 {#streaming}
      ...
      * [流目的地的IP地址](./catalog/streaming/ip-address-allow-list.md)
   * 调查目标 {#survey}
...
* Destination SDK {#destination-sdk}
   ...
   * 指南 {#guides}
      ...
      * 配置基于文件的目标 {#configure-file-based-destinations}
         ...
         * [使用自定义文件格式选项和自定义文件名配置来配置Azure Data Lake Storage目标](../destinations/destination-sdk/guides/batch/configure-adls-destination-with-custom-file-formatting.md)
