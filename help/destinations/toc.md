...
* 目标目录 {#catalog}
   ...
   * Advertising目标{#advertising}
      ...
      * [Acxiom Real ID™受众连接](./catalog/advertising/acxiom-real-id-audience-connection.md)
      ...
      * [旧版Adobe Advertising DSP连接](./catalog/advertising/adobe-advertising-cloud-dsp-connection-legacy.md)
      * [Adobe Advertising扩展](./catalog/advertising/adobe-advertising-cloud.md)
