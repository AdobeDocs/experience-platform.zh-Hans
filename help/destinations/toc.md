...
* API教程{#api}
   ...
   * [连接到电子邮件营销目标并使用API调用激活数据](./api/email-marketing.md)
* UI指南{#ui}
...
* 目标目录{#catalog}
   ...
   * 广告目标{#advertising}
      ...
      * [Adobe Advertising Cloud延伸](./catalog/advertising/adobe-advertising-cloud.md)
      * [Awin广告商转换标签扩展](./catalog/advertising/awin-conversiontag.md)
      * [Awin Advertiser Mastertag扩展](./catalog/advertising/awin-mastertag.md)
      * [Bing Ads Universal事件跟踪(UET)扩展](./catalog/advertising/bing-ads.md)
   ...
   * 个性化目标{#personalization}
      ...
      * [D&amp;B访客智能扩展](./catalog/personalization/dnb.md)
   ...
   * 调查目标{#survey}
      ...
      * [QuestionPro Intercept调查扩展](./catalog/survey/web-intercept-surveys.md)
   * 客户目标语音{#voice}
