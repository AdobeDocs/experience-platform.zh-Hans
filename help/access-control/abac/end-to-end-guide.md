...
>[!NOTE]
>
> 使用[!UICONTROL Permissions]对象级访问控制[，将在](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/access-control/object-based-access)工作区中创建的标签（如上面的区段标签）分配给Adobe Journey Optimizer中的各种对象。
