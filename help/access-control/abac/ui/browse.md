...
一旦您拥有管理员权限，请转到[Adobe Experience Platform](https://experience.adobe.com/)并使用您的[!DNL Adobe]凭据登录。 登录后，会为您拥有管理员权限的组织显示&#x200B;**[!UICONTROL 概述]**&#x200B;页面。 此页面显示贵组织订阅的产品，以及用于将用户和管理员添加到整个组织的其他控件。 选择&#x200B;**[!UICONTROL 权限]**&#x200B;以打开Experience Platform集成的基于属性的访问控制工作区。

![flac-select-product](../../images/flac-ui/flac-select-product.png)

Experience Platform的基于属性的访问控制工作区随即出现，并在&#x200B;**[!UICONTROL Roles]**&#x200B;页面上打开。 此页允许您查看所有角色并管理本文档中概述的各种设置。
