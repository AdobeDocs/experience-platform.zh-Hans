...
如果要查看用户详细信息和他们被分配到的角色，请选择&#x200B;**[!UICONTROL Users]**&#x200B;选项卡。

显示![突出显示了[!UICONTROL Users]选项卡的用户页面。](../../images/flac-ui/flac-users-tab.png)

此时将显示一个用户列表。 从列表中选择要查看的用户。 或者，使用搜索栏通过输入用户的姓名或电子邮件地址来搜索用户。

详细信息选项卡提供用户的概述。 该概述显示了用户名、帐户类型、电子邮件、身份验证ID、联系人信息和位置详细信息。

![包含[!UICONTROL Details]选项卡的用户详细信息页面，且用户配置文件突出显示。](../../images/flac-ui/flac-users-details.png)

选择&#x200B;**[!UICONTROL Roles]**&#x200B;选项卡以查看用户被分配到的角色。

显示![角色页面，其中突出显示[!UICONTROL Roles]选项卡和角色。](../../images/flac-ui/flac-users-roles.png)
