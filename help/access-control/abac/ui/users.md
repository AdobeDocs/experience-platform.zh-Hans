...
![显示的用户页面具有 [!UICONTROL 用户] 选项卡已突出显示。](../../images/flac-ui/flac-users-tab.png)

此时将显示一个用户列表。 从列表中选择要查看的用户。 或者，使用搜索栏通过输入用户的姓名或电子邮件地址来搜索用户。

详细信息选项卡提供用户的概述。 该概述显示了用户名、帐户类型、电子邮件、身份验证ID、联系人信息和位置详细信息。

![用户详细信息页面 [!UICONTROL 详细信息] 选项卡，并突出显示用户配置文件。](../../images/flac-ui/flac-users-details.png)

选择 **[!UICONTROL 角色]** 选项卡以查看用户分配到的角色。

![显示的角色页面具有 [!UICONTROL 角色] 选项卡和角色突出显示。](../../images/flac-ui/flac-users-roles.png)
