...
在不使用[使用标记扩展](/help/tags/extensions/client/web-sdk/overview.md)的情况下安装Web SDK的替代方法是引用托管在CDN上的Web SDK JavaScript库。 您可以直接引用库，也可以下载该库并将其托管在您自己的基础架构中。 它提供缩小的和完整的格式。
