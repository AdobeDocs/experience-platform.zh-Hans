...
否。任何Adobe Digital Experience客户都可以免费使用Adobe Experience Platform Web SDK。
...
是，Adobe Experience Platform Web SDK提供了身份迁移功能。 有关更多详细信息，请按照[`idMigrationEnabled`](/help/collection/js/commands/configure/idmigrationenabled.md)中的说明操作。
