...
`edgeDomain`属性允许您更改Web SDK发送数据的域。 使用自定义域有助于减少广告阻止程序的影响。
...
**如果您的组织未参与证书计划**，请将该值设置为`data.adobedc.net`的子域。 Adobe建议使用贵组织由Adobe分配的IMS公司ID来保持一致性。 例如：`example.data.adobedc.net`。使用以下步骤可确定您的IMS公司ID：

1. 使用您的Adobe ID凭据登录[experience.adobe.com](https://experience.adobe.com)。
1. 在Experience Cloud界面中的任意位置，按`[Cmd]` + `[I]` (macOS)或`[Ctrl]` + `[I]` (Windows)。
