...
| 访问 | 描述 |
| --- | --- |
| 首次访问 | 假设您尚未开始设置[!DNL FPID] Cookie。 [!DNL ECID]AMCV Cookie[中包含的](https://experienceleague.adobe.com/docs/id-service/using/intro/cookies.html#section-c55af54828dc4cce89f6118655d694c8)将是用于识别访客的标识符。 |
...
><br> 当您使用第一方ID时，由于Audience Manager合作伙伴ID同步主要基于[或](https://experienceleague.adobe.com/en/docs/audience-manager)，因此不支持在合作伙伴平台中激活的`UUIDs`Audience Manager`DIDs`功能。 从第一方ID派生的[!DNL ECID]未链接到`UUID`，使其不可寻址。
