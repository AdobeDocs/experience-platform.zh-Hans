...
此外，Web SDK还通过Adobe Experience Platform个性化目标(如[Adobe Target](/help/destinations/catalog/personalization/adobe-target-connection.md)和[自定义个性化连接](/help/destinations/catalog/personalization/custom-personalization.md))支持同页和下一页个性化功能。 要了解如何为同页和下一页个性化配置Experience Platform，请参阅[专用指南](/help/destinations/ui/activate-edge-personalization-destinations.md)。
