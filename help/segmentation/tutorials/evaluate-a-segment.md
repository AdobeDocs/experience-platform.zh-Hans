...
本文档提供了一个教程，用于使用实时客户用户档案API评估细 [分和访问细分结果](https://www.adobe.io/apis/experienceplatform/home/api-reference.html#!acpdr/swagger-specs/real-time-customer-profile.yaml)。
