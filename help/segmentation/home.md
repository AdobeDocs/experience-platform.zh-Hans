...
要了解如何在中创建和使用区段，请执行以下操作 [!DNL Segment Builder] (的UI实现 [!DNL Segmentation Service])，请参见 [区段生成器指南](./ui/segment-builder.md).
...
Edge分段功能能够在Platform中即时评估区段 [在Edge Network上](../web-sdk/home.md)，启用同一页面和下一页面个性化用例。
