...
要打开Audience Portal，请在“分段”部分中选择&#x200B;**[!UICONTROL Browse]**&#x200B;选项卡。
...
>title="评估方法"
>abstract="受众的评估方法包括批次评估、流式处理评估和边缘评估。"
...
![将显示源为[!UICONTROL Audience composition]的受众的快速操作列表。](../images/ui/audience-portal/browse-audience-composition-details.png)

| 操作 | 来源 | 描述 |
| ------ | ------- | ----------- |
| [!UICONTROL Edit] | Segmentation Service | 打开区段生成器以编辑受众。 请注意，如果您的受众是通过API创建的，则&#x200B;**无法**&#x200B;使用区段生成器编辑它。 有关使用区段生成器的更多信息，请参阅[区段生成器UI指南](./segment-builder.md)。 |
| [!UICONTROL Open composition] | 受众构成 | 打开受众组合以查看受众。 有关受众组合的详细信息，请参阅[受众组合UI指南](./audience-composition.md)。 |
| [!UICONTROL Activate to destination] | Segmentation Service | 激活目标受众。 有关将受众激活到目标的更多详细信息，请阅读[激活概述](../../destinations/ui/activation-overview.md)。 |
| [!UICONTROL Share with partners] | 受众构成、自定义上传、分段服务 | 与其他Experience Platform用户共享您的受众。 有关此功能的更多信息，请阅读[区段匹配概述](./segment-match/overview.md)。 |
| [!UICONTROL Manage tags] | 受众构成、自定义上传、分段服务 | 管理属于受众的用户定义标记。 有关此功能的详细信息，请阅读[筛选和标记](#manage-audiences)部分。 |
| [!UICONTROL Move to folder] | 受众构成、自定义上传、分段服务 | 管理受众属于哪个文件夹。 有关此功能的详细信息，请阅读[筛选和标记](#manage-audiences)部分。 |
...
切换&#x200B;**[!UICONTROL Schedule all audiences]**&#x200B;将启用计划分段。 有关计划分段的更多信息，请参阅本用户指南[的](#scheduled-segmentation)计划分段部分。

选择&#x200B;**[!UICONTROL Import audience]**&#x200B;将允许您导入外部生成的受众。 要了解有关导入受众的更多信息，请阅读用户指南[中有关](#import-audience)导入受众的部分。

选择&#x200B;**[!UICONTROL Create audience]**&#x200B;将允许您创建受众。 要了解有关创建受众的更多信息，请阅读用户指南[中有关](#create-audience)创建受众的部分。

![受众浏览页面上的顶部导航栏突出显示。 此栏包含用于创建受众的按钮和用于导入受众的按钮。](../images/ui/audience-portal/browse-audiences-top.png)

您可以选择&#x200B;**[!UICONTROL Evaluation summary]**&#x200B;以显示饼图，其中显示受众评估的摘要。
...
| [!UICONTROL Created] | 创建受众的日期和时间（UTC时区）。 |
| [!UICONTROL Last updated] | 上次更新受众的日期和时间(UTC)。 |
| [!UICONTROL Tags] | 属于受众的用户定义标记。 有关这些标记的详细信息，可在标记[的](#tags)部分找到。 |
| [!UICONTROL Description] | 受众的描述。 |
| [!UICONTROL Created by] | 创建受众的人员姓名。 |
| [!UICONTROL Access labels] | 受众的访问标签。 访问标签允许您根据应用于该数据的使用策略对数据集和字段进行分类。 这些标签可随时应用，从而为您选择如何管理数据提供了灵活性。 有关访问标签的详细信息，请阅读有关[管理标签](../../access-control/abac/ui/labels.md)的文档。 |
| [!UICONTROL Breakdown] | 受众的个人资料状态细分。 此用户档案状态划分的更详细描述可以在下面找到。 |

如果选择划分，则显示条形图，其中概述了属于以下每个已计算用户档案状态的用户档案的百分比： [!UICONTROL Realized]、[!UICONTROL Existing]和[!UICONTROL Exiting]。 此外，[!UICONTROL Browse]选项卡上显示的划分是对区段定义状态最准确的划分。 如果此数字与[!UICONTROL Overview]选项卡上所列的数字不同，您应使用[!UICONTROL Browse]选项卡上的数字作为正确的信息源，因为[!UICONTROL Overview]选项卡上的数字每天只更新一次。

| 状态 | 描述 |
| ------ | ----------- |
| [!UICONTROL Realized] | 自上次批处理区段作业运行以来的最后24小时内&#x200B;**符合受众资格的**&#x200B;的用户档案计数。 |
| [!UICONTROL Existing] | 自上次批处理区段作业运行以来的最后24小时内受众中仍有&#x200B;**保留**&#x200B;的用户档案数。 此字段为&#x200B;**已计算**，并且未显示在[`segmentMembership`对象](../../xdm/field-groups/profile/segmentation.md)中。 |
| [!UICONTROL Exiting] | 自上次批处理区段作业运行以来的最后24小时内&#x200B;**退出**&#x200B;受众的个人资料计数。 |

选择要显示的字段后，您还可以重新调整所显示列的宽度。 可以通过拖动列之间的区域或选择要重新调整大小的列的![箭头图标](/help/images/icons/chevron-down.png)以及后面的&#x200B;**[!UICONTROL Resize column]**&#x200B;来执行此操作。
...
要添加标记，请在要标记的受众中选择&#x200B;**[!UICONTROL Manage tags]**。

![已为指定的受众选择[!UICONTROL Manage tags]按钮。](../images/ui/audience-portal/browse-manage-tags.png)

出现&#x200B;**[!UICONTROL Manage tags]**&#x200B;弹出框。 在此弹出窗口中，您可以选择已分类的标记或未分类的标记。

| 标记类型 | 描述 |
| -------- | ----------- |
| 已分类 | 由贵组织的管理员创建并管理的标记。 |
| 未分类 | 在[!UICONTROL Manage tags]弹出框内创建的标记。 任何人都可以创建或管理这些类型的标记。 |

![将显示[!UICONTROL Manage tags]弹出框。 用于选择已分类或未分类的选项会突出显示。](../images/ui/audience-portal/create-tag.png)

添加所有要附加到受众的标记后，选择&#x200B;**[!UICONTROL Save]**。

![在[!UICONTROL Manage tags]弹出窗口上，添加的标记突出显示。](../images/ui/audience-portal/created-tags.png)
...
要创建用于保存受众的文件夹，请选择&#x200B;**[!UICONTROL Create folder]**。

![“创建文件夹”按钮高亮显示。](../images/ui/audience-portal/create-folder.png)

>[!NOTE]
>
>仅当位于其他文件夹中时，才能创建文件夹。 这意味着，如果您在左侧导航栏中选择了&#x200B;**，则**&#x200B;无法&#x200B;**[!UICONTROL All Audiences]**&#x200B;创建文件夹。

此时会出现一个弹出窗口，允许您命名新创建的文件夹。 在命名文件夹后选择&#x200B;**[!UICONTROL Save]**&#x200B;以完成创建文件夹。 请注意，名称&#x200B;**必须**&#x200B;对于父文件夹是唯一的。

![创建文件夹对话框上的“保存”按钮高亮显示。](../images/ui/audience-portal/create-folder-dialog.png)

要将受众移动到文件夹中，请在要移动的受众上选择&#x200B;**[!UICONTROL Move to folder]**。

![已为特定受众选择[!UICONTROL Move to folder]按钮。](../images/ui/audience-portal/browse-move-to-folder.png)

出现“**将受众移动到文件夹**”弹出框。 选择要将受众移动到的文件夹，然后选择&#x200B;**[!UICONTROL Save]**。
...
| [!UICONTROL Created by] | 允许您根据创建受众的人员进行筛选。 |
| [!UICONTROL Creation date] | 可让您根据受众的创建日期进行筛选。 您可以选择创建受众时要过滤的日期范围。 |
| [!UICONTROL Modified date] | 可让您根据受众的上次修改日期进行筛选。 您可以选择上次修改受众时要过滤的日期范围。 |
...
要查看有关特定受众的更多详细信息，请在&#x200B;**[!UICONTROL Browse]**&#x200B;选项卡中选择受众的名称。
...
**[!UICONTROL Audience summary]**&#x200B;部分提供属性的ID、名称、描述、来源和详细信息等信息。

此外，您还可以选择将受众激活到目标、应用访问标签或编辑/更新受众。

通过选择&#x200B;**[!UICONTROL Activate to destination]**，您可以将受众激活到目标。 有关将受众激活到目标的更多详细信息，请阅读[激活概述](../../destinations/ui/activation-overview.md)。

![已突出显示“激活到目标”按钮。](../images/ui/audience-portal/audience-details-activate.png)

选择&#x200B;**[!UICONTROL Apply access labels]**&#x200B;允许您管理属于受众的访问标签。 有关访问标签的详细信息，请阅读有关[管理标签](../../access-control/abac/ui/labels.md)的文档。
...
![将显示受众详细信息页面，其中突出显示[!UICONTROL Open composition]按钮。](../images/ui/audience-portal/audience-details-open-composition.png)

选择&#x200B;**[!UICONTROL Open composition]**&#x200B;允许您在受众构成中查看受众。 有关受众组合的详细信息，请参阅[受众组合UI指南](./audience-composition.md)。

>[!TAB 自定义上传]

![将显示受众详细信息页面，其中突出显示[!UICONTROL Update audience]按钮。](../images/ui/audience-portal/audience-details-update-audience.png)

选择&#x200B;**[!UICONTROL Update audience]**&#x200B;允许您重新上传外部生成的受众。 有关导入外部生成的受众的详细信息，请阅读有关[导入受众](#import-audience)的部分。

如果您的受众在过期后七天内，则可以选择&#x200B;**[!UICONTROL Refresh data expiration]**&#x200B;以重新摄取该受众的最后一个成功批次。
...
![将显示受众详细信息页面，其中突出显示[!UICONTROL Edit audience]按钮。](../images/ui/audience-portal/audience-details-edit-audience.png)

选择&#x200B;**[!UICONTROL Edit audience]**&#x200B;允许您在区段生成器中编辑受众。 有关使用[!DNL Segment Builder]工作区的更多详细信息，请阅读[[!DNL Segment Builder] 用户指南](./segment-builder.md)。

>[!ENDTABS]

选择&#x200B;**[!UICONTROL Edit properties]**&#x200B;将允许您编辑受众的基本详细信息，如名称、描述和标记。

![受众详细信息页面中会突出显示“编辑属性”按钮。](../images/ui/audience-portal/audience-details-edit-properties.png)

### 受众总数 {#audience-total}

对于Experience Platform生成的受众和合成，**[!UICONTROL Audience total]**&#x200B;部分显示符合受众条件的配置文件总数。
...
对于源自&#x200B;**[!UICONTROL Custom upload]**&#x200B;的受众，**[!UICONTROL Ingestion details]**&#x200B;部分既显示配置文件总数，也显示外部生成的受众被摄取到的数据集的详细信息。
...
| 架构 | 受众所属的架构的名称。 您可以选择架构的名称以查看有关架构的结构信息并应用数据使用标签。 有关详细信息，请阅读架构指南[的](../../xdm/tutorials/labels.md)管理数据使用标签。 |
| 已提取的记录 | 摄取到数据集的记录数。 |
| 失败的记录 | 无法引入数据集的记录数。 |
| 新轮廓片段 | 已创建的新配置文件的数量。 |
...
**[!UICONTROL Activated destinations]**&#x200B;部分显示激活此受众的目标。
...
对于批量摄取，每十五分钟自动扫描一次配置文件存储区，以查看自上次采样作业运行以来是否成功摄取了新批次。 如果是这种情况，随后将扫描配置文件存储区，以查看记录数量是否至少有3%的变化。 如果满足这些条件，则会触发新的取样作业。

对于流式摄取，每小时自动扫描一次配置文件存储区，以查看记录数量是否至少有3%的更改。 如果满足此条件，则会触发新的取样作业。
...
可以使用UI或API启用受众进行计划评估。 在UI中，返回到&#x200B;**[!UICONTROL Browse]**&#x200B;中的&#x200B;**[!UICONTROL Audiences]**&#x200B;选项卡并打开&#x200B;**[!UICONTROL Schedule all audiences]**。 这将导致根据贵组织设置的计划评估所有受众。
...
您可以选择&#x200B;**[!UICONTROL Create audience]**&#x200B;创建受众。
...
选择&#x200B;**[!UICONTROL Compose audiences]**&#x200B;将转到受众合成。 此工作区为构建和编辑受众提供了直观的控件，例如用于表示不同操作的拖放图块。 要了解有关创建受众的更多信息，请阅读[受众组合指南](./audience-composition.md)。

![显示受众组合工作区。](../images/ui/audience-portal/audience-composition.png)

### 区段生成器 {#segment-builder}

选择&#x200B;**[!UICONTROL Build rule]**&#x200B;将转到区段生成器。 此工作区为构建和编辑区段定义提供了直观的控件，例如用于表示数据属性的拖放图块。 要了解有关创建区段定义的更多信息，请参阅[区段生成器指南](./segment-builder.md)
...
>title="数据过期"
>abstract="受众成员资格将在指定天数后过期。该值可以设置为 1 天至 90 天。一旦受众会员资格到期，系统将停止评估，所有轮廓都会退出该受众。当受众会员资格剩余时间少于 7 天时，您可以刷新到期时间窗口。但是，一旦剩余天数为 0 天，您将无法刷新到期时间窗口。"

>[!IMPORTANT]
>
>为了导入外部生成的受众，您&#x200B;**必须**&#x200B;具有以下权限： [!UICONTROL View segments]、[!UICONTROL Manage segments]和[!UICONTROL Import audience]。 有关这些权限的详细信息，请阅读[访问控制概述](../../access-control/home.md#permissions)。

您可以选择&#x200B;**[!UICONTROL Import audience]**&#x200B;以导入外部生成的受众。

![在“受众”浏览页面上，“导入受众”按钮高亮显示。](../images/ui/audience-portal/browse-import-audience.png)

出现&#x200B;**[!UICONTROL Import audience CSV]**&#x200B;工作流。 您可以选择要导入为外部生成受众的CSV文件。

![在[!UICONTROL Import audience CSV]工作流中，[!UICONTROL Drag and drop files]框高亮显示，显示您可以在何处上传外部生成的受众。](../images/ui/audience-portal/import-audience-csv.png)
...
选择要导入的CSV文件后，将显示此外部生成受众的示例数据列表。 确认样本数据正确后，选择&#x200B;**[!UICONTROL Next]**。

![显示外部生成的受众的示例数据。](../images/ui/audience-portal/import-audience-sample-data.png)

此时会显示&#x200B;**[!UICONTROL Audience details]**&#x200B;页面。 您可以添加有关受众的信息，包括其名称、描述、主要身份和身份命名空间值。

导入外部生成的受众时，必须选择其中一列作为主标识字段并指定命名空间值。 请注意，其余所有字段将被视为&#x200B;**有效负载属性**。 这些属性被视为&#x200B;**非持久属性**，因为它们将仅与此受众关联以进行个性化，并且&#x200B;**不**&#x200B;连接到配置文件。

![显示[!UICONTROL Audience details]页。](../images/ui/audience-portal/import-audience-audience-details.png)

您还可以选择向外部生成的受众添加一些其他详细信息，包括向其提供外部ID、定义其合并策略、编辑其列数据类型或应用自定义数据过期。
...
>[!NOTE]
>
>自定义数据到期设置配置文件在受众成员资格中&#x200B;**保留**&#x200B;的天数。 数据过期后，用户档案将退出受众成员资格。 此值可以设置为1到90天。

填写受众详细信息后，选择&#x200B;**[!UICONTROL Next]**。

![在[!UICONTROL Next]页面上突出显示[!UICONTROL Audience details]按钮。](../images/ui/audience-portal/import-audience-filled-details.png)

显示&#x200B;**[!UICONTROL Review]**&#x200B;页面。 您可以查看新导入的外部生成受众的详细信息。

![显示[!UICONTROL Review]页面，显示新导入的外部生成受众的详细信息。](../images/ui/audience-portal/import-audience-review-details.png)

确认详细信息正确后，选择&#x200B;**[!UICONTROL Finish]**&#x200B;以将外部生成的受众导入Adobe Experience Platform。
