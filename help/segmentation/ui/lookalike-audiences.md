...
![已突出显示“受众”按钮，以及用于相似人群拓展建模的基本受众。](../images/ui/lookalike-audiences/browse.png)
...
![相似性和可达图已突出显示。](../images/ui/lookalike-audiences/similarity-and-reach.png)
...
![相似受众部分已突出显示。](../images/ui/lookalike-audiences/select-laa.png)
...
>additional-url="https://experienceleague.adobe.com/docs/experience-platform/segmentation/ui/lookalike-audiences.html?lang=zh-Hans#exclude" text="排除数据"
...
![影响因素部分已突出显示。](../images/ui/lookalike-audiences/influential-factors.png)
...
![已高亮显示[!UICONTROL 创建相似受众]按钮。](../images/ui/lookalike-audiences/create-look-alike-audience.png)

出现&#x200B;**[!UICONTROL 创建相似受众]**&#x200B;弹出框。 在此页面上，您可以为相似受众设置相似性百分比。

![显示[!UICONTROL 创建相似受众]弹出框。](../images/ui/lookalike-audiences/create-audience.png)
...
![基本信息在[!UICONTROL 创建相似受众]弹出框内突出显示。](../images/ui/lookalike-audiences/basic-info.png)

选择&#x200B;**[!UICONTROL 创建]**&#x200B;以完成创建相似受众。

![创建按钮在[!UICONTROL 创建相似受众]弹出框内突出显示。](../images/ui/lookalike-audiences/create-audience.png)
...
此时会显示受众详细信息页面。 有关此页面的详细信息，请阅读受众门户概述](./audience-portal.md#audience-details)的[受众详细信息部分。

![显示相似受众的详细信息。](../images/ui/lookalike-audiences/laa-details.png)
