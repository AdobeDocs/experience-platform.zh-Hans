...
有关用于设置数据共享同意值的`share`属性的更多信息，请参阅以下关于[隐私和同意字段组](../../xdm/field-groups/profile/consents.md)的文档。 有关用于捕获消费者对收集和使用与隐私、个性化和营销首选项相关数据的同意的特定字段组的信息，请参阅以下[隐私、个性化和营销首选项的同意GitHub示例](https://github.com/adobe/xdm/blob/master/docs/reference/datatypes/consent-preferences.schema.md)。
