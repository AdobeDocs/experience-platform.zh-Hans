...
您可以使用查询服务连接在线到离线客户历程并了解品牌的全渠道归因。 以下视频演示了体验业务如何使用查询服务来解决关键用例，并说明了查询服务的工作方式。

>[!VIDEO](https://video.tv.adobe.com/v/33591?captions=chi_hans&quality=12&learn=on)
...
借助Adobe Experience Platform，您可以摄取、存储、构造和提取所有存储的数据集，包括行为、CRM和销售点数据。 使用查询服务，您可以查询这些数据集并回答特定的业务问题，从而产生有影响力的见解。 了解如何构建和管理自定义仪表板，以便在其中创建、添加和编辑定制的小组件通过[用户定义的仪表板](../dashboards/standard-dashboards.md)可视化关键量度。 您还可以将SQL查询与Real-Time CDP分析数据模型结合使用，为营销和KPI用例[自定义您自己的Real-Time Customer Data Platform报表](../dashboards/data-models/cdp-insights-data-model-b2c.md)。
...
>[!VIDEO](https://video.tv.adobe.com/v/33586?captions=chi_hans&quality=12&learn=on)
