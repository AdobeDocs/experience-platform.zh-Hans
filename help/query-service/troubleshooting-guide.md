...
+++回答是，您可以使用Postman（一个免费的第三方应用程序）可视化所有AdobeAPI服务并与之交互。 观看 [Postman设置指南](https://video.tv.adobe.com/v/28832) 有关如何在Adobe开发人员控制台中设置项目并获取所有必要凭据以与Postman一起使用的分步说明。 请参阅 [关于启动、运行和共享Postman集合的指导](https://learning.postman.com/docs/running-collections/intro-to-collection-runs/).
+++
...
+++答案本节包含有关使用第三方工具(如PSQL和Power BI)的信息。
+++
