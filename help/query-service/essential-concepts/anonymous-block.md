...
>[!IMPORTANT]
>
>目前，只有通过 [!DNL Query Service] API。 请参阅相关文档 [有关通过API计划查询的完整说明](../api/scheduled-queries.md).
...
通过阅读本文档，您现在可以清楚地了解匿名块及其结构。 [有关查询执行的详细信息](../best-practices/writing-queries.md)，请阅读有关查询服务中查询执行的指南。
