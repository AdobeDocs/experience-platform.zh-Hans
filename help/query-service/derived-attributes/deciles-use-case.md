...
![航空公司忠诚度数据架构的图表。](../images/derived-attributes/deciles-use-case/airline-loyalty-data.png)
...
![“航空公司忠诚度决策架构”的图表。](../images/derived-attributes/deciles-use-case/airline-loyalty-decile-schema.png)
