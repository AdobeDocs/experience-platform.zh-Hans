...
description: 了解扩展SQL功能的受支持Spark SQL函数。
...
| [`approx_percentile`](https://spark.apache.org/docs/latest/api/sql/index.html#approx_percentile) | 返回给定百分比的近似百分位值 |
...
| [`exp`](https://spark.apache.org/docs/latest/api/sql/index.html#exp) | 将e返回值的幂次方 |
| [`expm1`](https://spark.apache.org/docs/latest/api/sql/index.html#expm1) | 返回e为值减去1的幂次 |
...
| [`rand`](https://spark.apache.org/docs/latest/api/sql/index.html#rand) | 返回从0到1的随机数 |
...
| [`arrays_overlap`](https://spark.apache.org/docs/latest/api/sql/index.html#arrays_overlap) | 返回公共元素 |
| [`assert_true`](https://spark.apache.org/docs/latest/api/sql/index.html#assert_true) | 断言表达式是否为true |
...
| [`nanvl`](https://spark.apache.org/docs/latest/api/sql/index.html#nanvl) | 返回第一个表达式（如果不是数字），否则返回第二个表达式 |
...
| [`day`](https://spark.apache.org/docs/latest/api/sql/index.html#day)，[`dayofmonth`](https://spark.apache.org/docs/latest/api/sql/index.html#dayofmonth) | 返回月中日 |
| [`dayofweek`](https://spark.apache.org/docs/latest/api/sql/index.html#dayofweek) | 返回星期几(1-7) |
| [`dayofyear`](https://spark.apache.org/docs/latest/api/sql/index.html#dayofyear) | 返回年中哪天 |
| [`from_unixtime`](https://spark.apache.org/docs/latest/api/sql/index.html#from_unixtime) | 以UNIX®时间返回日期 |
...
| [`to_date`](https://spark.apache.org/docs/latest/api/sql/index.html#to_date) | 将字符串转换为日期。 **注意：**&#x200B;字符串&#x200B;**必须**&#x200B;的格式为`yyyy-mm-ddTHH24:MM:SS`。 |
| [`to_timestamp`](https://spark.apache.org/docs/latest/api/sql/index.html#to_timestamp) | 将字符串转换为时间戳。 **注意：**&#x200B;字符串&#x200B;**必须**&#x200B;的格式为`yyyy-mm-ddTHH24:MM:SS`。 |
| [`to_unix_timestamp`](https://spark.apache.org/docs/latest/api/sql/index.html#to_unix_timestamp) | 将字符串转换为UNIX®时间戳 |
...
| [`unix_timestamp`](https://spark.apache.org/docs/latest/api/sql/index.html#unix_timestamp) | 返回UNIX®时间戳 |
...
| 函数 | 描述 |
| -------- | ----------- |
| [`array`](https://spark.apache.org/docs/latest/api/sql/index.html#array) | 创建具有给定元素的数组 |
| [`array_contains`](https://spark.apache.org/docs/latest/api/sql/index.html#array_contains) | 检查数组是否包含值 |
| [`array_distinct`](https://spark.apache.org/docs/latest/api/sql/index.html#array_distinct) | 从数组中删除重复的值 |
...
| [`array_position`](https://spark.apache.org/docs/latest/api/sql/index.html#array_position) | 返回元素从1开始的位置 |
...
| [`arrays_zip`](https://spark.apache.org/docs/latest/api/sql/index.html#array_zip) | 将给定数组的值与给定索引处的原始集合的值组合在一起 |
| [`cardinality`](https://spark.apache.org/docs/latest/api/sql/index.html#cardinality) | 返回数组的大小 |
| [`element_at`](https://spark.apache.org/docs/latest/api/sql/index.html#element_at) | 返回位置的元素 |
| [`explode`](https://spark.apache.org/docs/latest/api/sql/index.html#explode) | 将数组的元素分隔为多行，不包括null |
| [`explode_outer`](https://spark.apache.org/docs/latest/api/sql/index.html#explode_outer) | 将数组的元素分隔为多个行，包括null |
| [`find_in_set`](https://spark.apache.org/docs/latest/api/sql/index.html#find_in_set) | 返回数组的从1开始的位置 |
| [`flatten`](https://spark.apache.org/docs/latest/api/sql/index.html#flatten) | 拼合阵列阵列 |
...
| [`posexplode`](https://spark.apache.org/docs/latest/api/sql/index.html#posexplode) | 将数组的元素分隔为多个具有位置的行，但不包括null |
| [`reverse`](https://spark.apache.org/docs/latest/api/sql/index.html#reverse) | 反转数组的元素 |
...
| [`initcap`](https://spark.apache.org/docs/latest/api/sql/index.html#initcap) | 将字符串更改为字首大写 |
...
| [`lpad`](https://spark.apache.org/docs/latest/api/sql/index.html#lpad) | 垫住线条的左侧 |
...
| [`rpad`](https://spark.apache.org/docs/latest/api/sql/index.html#rpad) | 垫住线条的右侧 |
...
| [`concat_ws`](https://spark.apache.org/docs/latest/api/sql/index.html#concat_ws) | 与分隔符连接 |
...
| [`elt`](https://spark.apache.org/docs/latest/api/sql/index.html#elt) | 返回第[`n`](https://spark.apache.org/docs/latest/api/sql/index.html#n)个输入 |
...
| [`left`](https://spark.apache.org/docs/latest/api/sql/index.html#left) | 返回前[`n`](https://spark.apache.org/docs/latest/api/sql/index.html#n)个字符 |
| [`length`](https://spark.apache.org/docs/latest/api/sql/index.html#length) | 返回字符串的长度 |
| [`levenshtein`](https://spark.apache.org/docs/latest/api/sql/index.html#levenshtein) | 返回字符串之间的列文氏距离 |
...
| [`nvl2`](https://spark.apache.org/docs/latest/api/sql/index.html#nvl2) | 如果不是null，则返回值 |
...
| [`shiftleft`](https://spark.apache.org/docs/latest/api/sql/index.html#shiftleft) | 带符号的左位移位 |
...
| [`space`](https://spark.apache.org/docs/latest/api/sql/index.html#space) | 返回包含[`n`](https://spark.apache.org/docs/latest/api/sql/index.html#n)个空格的字符串 |
...
| [`xpath_int`](https://spark.apache.org/docs/latest/api/sql/index.html#xpath_int) | 解析XML节点的整数 |
| [`xpath_long`](https://spark.apache.org/docs/latest/api/sql/index.html#xpath_long) | 长时间解析XML节点 |
| [`xpath_short`](https://spark.apache.org/docs/latest/api/sql/index.html#xpath_short) | 分析短整数的XML节点 |
