...
来自选定Adobe Analytics报告套件的数据将转换为XDM ExperienceEvents，并作为数据集引入Adobe Experience Platform。 本文档概述了Adobe Experience Platform查询服务利用这些数据的许多使用案例，其中包含的示例查询应与您的Adobe Analytics数据集结合使用。 有关映射 [到XDM ExperienceEvents的更多信息](../../source-connectors/ui/adobe-applications/analytics-mapping.md) ，请参阅Analytics字段映射文档。
