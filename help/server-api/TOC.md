...
user-guide-description: Adobe Experience Platform Edge Network Server API 为客户提供了与任何 Adobe Experience Cloud 或 Adobe Experience Platform Edge 服务交互的优化方式。了解如何将服务器 API 用于各种数据收集、个性化、广告和营销用例。
