...
1. 安装 [Adobe Experience Platform Web SDK](/help/web-sdk/install/overview.md) 并查看 [Web渠道先决条件](https://experienceleague.adobe.com/docs/journey-optimizer/using/web/configure-web-channel/web-prerequisites.html) 页面。
