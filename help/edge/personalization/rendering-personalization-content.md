...
Adobe Experience Platform支 [!DNL Web SDK] 持在包括Adobe Target在内的Adobe查询个性化解决方案。 有两种个性化模式：检索可自动渲染的内容和开发人员必须渲染的内容。 SDK还提供管理闪 [烁的工具](../personalization/manage-flicker.md)。
