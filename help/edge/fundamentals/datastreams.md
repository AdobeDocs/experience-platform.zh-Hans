...
| 字段 | 描述 |
| --- | --- |
| [!UICONTROL 沙盒] | **（必需）** 选择要将数据发送到的平台沙盒。 沙盒是Adobe Experience Platform中的虚拟分区，允许您将数据和实施与组织中的其他人员隔离开来。 有关这些组件工作方式的更多详细信息，请参阅 [沙盒文档](../../sandboxes/home.md). |
