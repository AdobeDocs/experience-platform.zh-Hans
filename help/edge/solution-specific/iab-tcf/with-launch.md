---
title: 将IAB TCF 2.0与Launch结合使用
seo-title: 通过Adobe启动和Adobe Experience PlatformWeb SDK设置IAB TCF 2.0同意
description: 了解如何通过AdobeLaunch和Adobe Experience PlatformWeb SDK设置IAB TCF 2.0同意
seo-description: 了解如何通过AdobeLaunch和Adobe Experience PlatformWeb SDK设置IAB TCF 2.0同意
...
Adobe Experience PlatformWeb软件开发工具包(Adobe Experience PlatformWeb SDK)支持交互式广告局透明度和同意框架，版本2.0(IAB TCF 2.0)。 本指南向您展示如何设置Adobe Experience Platform Launch属性，以便使用AEP Web SDK Launch扩展向Adobe发送IAB TCF 2.0同意信息。

如果您不想使用Experience Platform Launch，请参阅有关使用IAB TCF 2. [0而不使用Experience Platform Launch的指南](./without-launch.md)。

## 入门指南

要将IAB TCF 2.0与Experience Platform Launch及AEP Web SDK扩展一起使用，您需要提供XDM模式和数据集。 如果尚未设置其中任一设置，请在继续操作之前查 [看“Adobe Experience PlatformWeb SDK Launch”快](../../getting-started/quick-start-with-launch.md) 速开始指南进行开始。
