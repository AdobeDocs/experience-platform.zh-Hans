...
使用Adobe Experience Platform标记部分可查看标记请求。 您还可以选择 **[!UICONTROL 配置]** 配置 [嵌入代码](../tags/ui/publishing/environments.md#embed-code). 您可以在 Experience Platform Debugger 中编辑、替换或添加更多嵌入代码。如果您已登录，则可以使用下拉列表选择替代资产。
