...
Adobe Experience Platform Web SDK 屏幕可显示有关 Adobe Experience Platform Web SDK 的信息。選取 **[!UICONTROL 設定]** 以開啟或關閉主控台登入。

## [!UICONTROL Analytics] {#section-f71dfcc22bb44c86bec328491606a482}

此 [!UICONTROL 分析] 標籤會提供您對應 [Adobe Analytics實施](https://experienceleague.adobe.com/docs/analytics/implementation/home.html?lang=zh-Hans).
...
使用 [!UICONTROL Adobe Experience Platform標籤] 區段來檢視標籤請求。 您也可以選取 **[!UICONTROL 設定]** 進行設定 [內嵌程式碼](../../tags/ui/publishing/environments.md#embed-code). 您可以在 Experience Platform Debugger 中编辑、替换或添加更多嵌入代码。如果您已登录，则可以使用下拉列表选择替代资产。

## [!UICONTROL Experience Cloud ID] {#section-a96c32f8e63a4991abb296f6e8ea01cf}

使用 [!UICONTROL EXPERIENCE CLOUDID] 標籤以檢視 [Experience CloudID服務](https://experienceleague.adobe.com/docs/id-service/using/home.html?lang=zh-Hans) 要求。
