...
以下文档提供了有关如何连接的信息 [!DNL Veeva CRM] 至使用API或用户界面的Platform：

## Connect [!DNL Veeva CRM] 到 [!DNL Platform] 使用API

- [使用流服务API创建Veeva CRM基本连接](../../tutorials/api/create/crm/veeva.md)
- [使用流服务API浏览数据表](../../tutorials/api/explore/tabular.md)
- [使用流服务API为CRM源创建数据流](../../tutorials/api/collect/crm.md)

## Connect [!DNL Veeva CRM] 到 [!DNL Platform] 使用UI
