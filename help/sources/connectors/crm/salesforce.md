...
Experience Platform支持从第三方CRM系统中摄取数据。 对CRM提供商的支持包括 [!DNL Salesforce].
...
建立源连接： [!DNL Salesforce] 和平台， [!DNL Salesforce] 在将源数据字段引入Platform之前，必须将其映射到相应的目标XDM字段。
...
要使用 [!DNL Salesforce] 源作为的一部分 [!DNL B2B-CDP]，您必须首先设置 [!DNL Postman] 用于自动生成您的 [!DNL Salesforce] 命名空间和架构。 以下文档提供了有关设置的其他信息 [!DNL Postman] 实用工具：
