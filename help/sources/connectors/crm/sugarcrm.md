...
>[!NOTE]
>
>此 [!DNL SugarCRM] 源为测试版。 请参阅 [源概述](../../home.md#terms-and-conditions) 有关使用测试版标记源的更多信息。

Adobe Experience Platform允许从外部源摄取数据，同时让您能够使用Platform服务来构建、标记和增强传入数据。 您可以从各种来源(如Adobe应用程序、基于云的存储、数据库和许多其他来源)中摄取数据。

Experience Platform支持从第三方CRM应用程序引入数据。 CRM提供商的支持包括 [!DNL SugarCRM].
...
在创建 [!DNL SugarCRM] 源连接中，您必须首先确保具有以下内容：

* A [!DNL SugarMarket] 帐户。 您必须联系 [!DNL SugarCRM] 客户经理获取有效的 [!DNL SugarMarket] 帐户（如果没有）。

* 与营销或销售流程关联的任何用户帐户分开的唯一API用户名和帐户。 此唯一的用户名和帐户组合必须具有API访问权限。 欲知关于帐户设置过程的更多信息，请访问 [[!DNL SugarMarket RESTFUL API]](https://market.apidocs.sugarcrm.com/#intro) 文档。

## Connect [!DNL SugarCRM Accounts & Contacts] 目标平台
...
## Connect [!DNL SugarCRM Events] 目标平台

* [创建源连接以引入 [!DNL SugarCRM Events] 使用API将数据发送到平台](../../tutorials/api/create/crm/sugarcrm-events.md).
