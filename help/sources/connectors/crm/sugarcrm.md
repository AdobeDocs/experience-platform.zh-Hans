...
## 将[!DNL SugarCRM Accounts & Contacts]连接到平台

* [创建源连接以使用API将 [!DNL SugarCRM Accounts & Contacts] 数据引入Platform](../../tutorials/api/create/crm/sugarcrm-accounts-contacts.md)。
* [使用用户界面](../../tutorials/ui/create/crm/sugarcrm-accounts-contacts.md)创建源连接以将 [!DNL SugarCRM Accounts & Contacts] 数据引入Platform。
* [使用流服务API为CRM源创建数据流](../../tutorials/api/collect/crm.md)


## 将[!DNL SugarCRM Events]连接到平台

* [创建源连接以使用API将 [!DNL SugarCRM Events] 数据引入Platform](../../tutorials/ui/create/crm/sugarcrm-events.md)。
* [使用用户界面](../../tutorials/ui/create/crm/sugarcrm-events.md)创建源连接以将 [!DNL SugarCRM Events] 数据引入Platform。
