...
Experience Platform支持从第三方CRM系统中摄取数据。 对CRM提供商的支持包括Microsoft Dynamics。

以下文档提供了有关如何使用API或用户界面将Microsoft Dynamics连接到平台的信息：
...
- [在UI中创建Microsoft Dynamics源连接器](../../tutorials/ui/create/crm/dynamics-salesforce.md)
