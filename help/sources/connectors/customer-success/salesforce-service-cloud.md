...
以下文档提供了有关如何连接的信息 [!DNL Salesforce Service Cloud] to [!DNL Platform] 使用API或用户界面：

## 连接 [!DNL Salesforce Service Cloud ]to [!DNL Platform] 使用API
...
## 连接 [!DNL Salesforce Service Cloud] to [!DNL Platform] 使用UI
