...
| `TECHNICAL_ACCOUNT_ID` | 用于集成到[Adobe Developer Console](https://developer.adobe.com/)的凭据。 请按照以下步骤检索您的技术帐户ID：<ul><li>导航到[Adobe Developer Console](https://developer.adobe.com/)并打开您的项目。</li><li>打开使用&#x200B;**服务帐户(JWT)**&#x200B;的&#x200B;_凭据_。 **注意**：在旧版UI中，这可能称为“企业”。</li><li>凭据详细信息应显示您的客户端ID、技术帐户ID、组织ID和其他JWT元数据。</li></ul>。 | `D42AEVJZTTJC6LZADUBVPA15@techacct.adobe.com` |
...
| `PLATFORM_URL` | 您对其进行API调用的URL端点。 此值是固定的，并且始终设置为： `platform.adobe.io/`。 | `platform.adobe.io/` |
