...
在[!UICONTROL Adobe applications]类别下，选择&#x200B;**[!UICONTROL Adobe Data Collection]**，然后选择&#x200B;**[!UICONTROL Set up]**。

![数据收集](./images/data-collection/catalog.png)

数据收集UI显示在&#x200B;**[!UICONTROL Datastreams]**&#x200B;选项卡上。
...
有关如何在UI中配置数据收集的全面步骤，请参阅[Web SDK标记扩展快速入门](/help/tags/extensions/client/web-sdk/getting-started.md)。

## 后续步骤

通过阅读本文档，您已了解如何使用源工作区访问数据收集UI。 有关数据收集的详细信息，请参阅[数据收集概述](/help/collection/home.md)。
