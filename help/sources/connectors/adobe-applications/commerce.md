...
* [安装Adobe Commerce的 [!DNL Data Connection] 扩展](https://experienceleague.adobe.com/docs/commerce-merchant-services/data-connection/fundamentals/install.html?lang=zh-Hans)。 您可以从[Adobe市场](https://commercemarketplace.adobe.com/magento-experience-platform-connector.html)下载连接器扩展。
...
* 完成上述所有配置后，您现在可以通过使用[!DNL Commerce Admin]配置Commerce Services Connector和[!DNL Data Connection]扩展来连接到Experience Platform。 有关此最终步骤的更多信息，请阅读有关[将Commerce数据连接到Experience Platform](https://experienceleague.adobe.com/docs/commerce-merchant-services/data-connection/fundamentals/connect-data.html?lang=zh-Hans)的指南。
