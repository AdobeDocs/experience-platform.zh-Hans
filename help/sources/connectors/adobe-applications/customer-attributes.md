...
您可以通过在数据收集`CORE`、[Mobile SDK](/help/collection/identity/overview.md)或[Experience Cloud ID服务API](https://developer.adobe.com/client-sdks/documentation/mobile-core/identity/)中使用[标识为访客设置Experience Cloud ID来建立](https://experienceleague.adobe.com/docs/id-service/using/intro/overview.html?lang=zh-Hans)命名空间。
