...
Adobe Experience Platform为云提供商(如AWS)提供本机连接， [!DNL Google Cloud Platform]、和 [!DNL Azure]，允许您从这些系统获取数据。 引入的数据可以格式化为JSON、Parquet或分隔。 对云存储提供商的支持包括 [!DNL Apache] HDFS。
...
## 连接 [!DNL Apache] HDFS至 [!DNL Platform]

以下文档提供了有关如何连接的信息 [!DNL Apache] HDFS至 [!DNL Platform] 使用API或用户界面：
