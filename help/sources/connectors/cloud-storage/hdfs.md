...
Adobe Experience Platform为AWS、[!DNL Google Cloud Platform]和[!DNL Azure]等云提供商提供本机连接，允许您从这些系统中获取数据。 摄取的数据可以采用JSON、Parquet或分隔格式。 对云存储提供程序的支持包括[!DNL Apache] HDFS。
