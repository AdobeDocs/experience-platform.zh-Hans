...
>[!IMPORTANT]
>
>[!DNL PayPal]源将于2025年5月底弃用。 您可以使用[[!DNL Data Landing Zone]](../cloud-storage/data-landing-zone.md)代替[!DNL PayPal]源。
...
以下文档提供了有关如何使用API或用户界面将[!DNL PayPal]连接到Platform的信息：

## 使用API将[!DNL PayPal]连接到平台
