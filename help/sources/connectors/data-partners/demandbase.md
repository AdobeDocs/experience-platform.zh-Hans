...
现在您已完成[!DNL Demandbase]的必备项设置，接下来可以使用UI [将您的[!DNL Demandbase]帐户连接到Experience Platform]完成必备项设置后，请阅读有关[将您的 [!DNL Demandbase] 帐户连接到Experience Platform](../../tutorials/ui/create/data-partners/demandbase.md)的教程以开始集成。
