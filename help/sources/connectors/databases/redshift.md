...
[!DNL Experience Platform] 支持从第三方数据库中摄取数据。[!DNL Platform] 可以连接到不同类型的数据库，如关系、NoSQL或data warehouse。对数据库提供程序的支持包括[!DNL Amazon Redshift]。
...
- [使用Flow Service API创建Amazon Redshift源连接](../../tutorials/api/create/databases/redshift.md)
