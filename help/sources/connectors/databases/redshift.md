...
title: Amazon红移连接器
topic: overview
description: 以下文档提供了如何使用API或用户界面将AmazonRedshift连接到平台的信息。
...
[!DNL Experience Platform] 支持从第三方数据库中摄取数据。 [!DNL Platform] 可以连接到不同类型的数据库，如关系型、NoSQL或data warehouse。 对数据库提供者的支持包 [!DNL Amazon Redshift]括。
...
以下文档提供了如何使用API [!DNL Amazon Redshift] 或 [!DNL Platform] 用户界面连接的信息：

## 连接 [!DNL Amazon Redshift] 到 [!DNL Platform] 使用API

- [使用Flow Service API创建AmazonRedshift连接器](../../tutorials/api/create/databases/redshift.md)
...
## 连接 [!DNL Amazon Redshift] 到 [!DNL Platform] 使用UI

- [在UI中创建AmazonRedshift源连接器](../../tutorials/ui/create/databases/redshift.md)
