...
以下文档提供了有关如何连接的信息 [!DNL Azure Synapse Analytics] to [!DNL Platform] 使用API或用户界面：

## 连接 [!DNL Azure Synapse Analytics] to [!DNL Platform] 使用API
...
## 连接 [!DNL Azure Synapse Analytics] to [!DNL Platform] 使用UI
