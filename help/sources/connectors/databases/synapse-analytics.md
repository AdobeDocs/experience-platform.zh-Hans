...
topic: overview
description: 了解如何使用API或用户界面将Azure synapse分析与Adobe Experience Platform连接。
...
[!DNL Experience Platform] 支持从第三方数据库中摄取数据。[!DNL Platform] 可以连接到不同类型的数据库，如关系型、NoSQL或data warehouse。对数据库提供者的支持包括[!DNL Azure Synapse Analytics]。
