...
# （测试版）连 [!DNL HubSpot] 接器

>[!NOTE]
>连接 [!DNL HubSpot] 器为测试版。 有关使用 [测试版标记](../../home.md#terms-and-conditions) 的连接器的更多信息，请参阅源概述。

Adobe Experience Platform允许从外部源摄取数据，同时使您能够使用服务来构建、标记和增强传入数 [!DNL Platform] 据。 您可以从各种来源(如Adobe应用程序、基于云的存储、数据库和许多其他来源)收集数据。

[!DNL Experience Platform ]支持从第三方营销自动化系统中获取数据。 对营销自动化提供商的支持 [!DNL HubSpot]包括
...
以下文档提供了如何使用API [!DNL HubSpot] 或 [!DNL Platform] 用户界面连接的信息：

## 连接 [!DNL HubSpot] 到 [!DNL Platform] 使用API
...
## 连接 [!DNL HubSpot] 到 [!DNL Platform] 使用UI
