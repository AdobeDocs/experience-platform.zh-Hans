...
>[!NOTE]
>
>将自动禁用连续30天失败的Source摄取数据流。 使用[监视仪表板](/help/dataflows/ui/monitor-sources.md)查看您的数据流，确定它失败的原因（例如，凭据、权限或架构或映射更改），应用必要的更新，并在解析后重新启用数据流。
...
| [[!DNL Google BigQuery]](connectors/databases/bigquery.md) | 数据库 | 批次 | Azure、AWS |
...
| 来源 | 摄取类型 | 云 |
| --- | --- | --- |
| [[!DNL Didomi]](../sources/connectors/consent-and-preferences/didomi.md) | 流传输 | Azure |
...
| [[!DNL Relay Connector]](tutorials/ui/create/marketing-automation/relay-connector.md) | 流传输 | Azure |
