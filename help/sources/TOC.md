...
- 可用源连接器 {#connectors}
   ...
   - 营销自动化 {#marketing-automation}
      - [查蒂奥](connectors/marketing-automation/chatlio-webhook.md)
      ...
      - [OracleResponsys连接器](connectors/marketing-automation/oracle-responsys.md)
...
- UI教程 {#ui-tutorials}
   - 创建源连接 {#create}
      ...
      - 营销自动化 {#marketing-automation}
         - [查蒂奥](tutorials/ui/create/marketing-automation/chatlio-webhook.md)
