...
本教程介绍了从第三方CRM系统检索数据并通过源连接器和API [!DNL Platform] 将其导入的步骤。
...
要调用平台API，您必须先完成身份验证 [教程](../../../../tutorials/authentication.md)。 完成身份验证教程可为所有API调用中的每个所需 [!DNL Experience Platform] 标头提供值，如下所示：
