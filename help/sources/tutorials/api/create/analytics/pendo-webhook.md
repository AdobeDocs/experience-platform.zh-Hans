...
## Connect [!DNL Pendo] 到平台，使用 [!DNL Flow Service] API {#connect-platform-to-flow-api}
...
成功响应将返回有关您的数据流的信息，包括您的端点URL，这些信息标记为 `inletUrl`. 请参阅 [设置Webhook](../../../ui/create/analytics/pendo-webhook.md#get-streaming-endpoint-url) 页面以获取所需的值。
