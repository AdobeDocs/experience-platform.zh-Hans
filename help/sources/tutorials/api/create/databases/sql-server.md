...
# 使用[!DNL Flow Service] API创建[!DNL Microsoft] SQL Server连接器

>[!NOTE]
>
>[!DNL Microsoft] SQL Server连接器处于测试状态。 有关使用测试版标签的连接器的详细信息，请参见[源概述](../../../../home.md#terms-and-conditions)。
...
以下各节提供了使用[!DNL Flow Service] API成功连接到SQL Server时需要了解的其他信息。
...
通过本教程，您已使用[!DNL Flow Service] API创建了SQL Server连接，并获得了该连接的唯一ID值。 在下一个教程中，您可以使用此连接ID，因为您正在学习如何[使用流服务API](../../explore/database-nosql.md)浏览数据库或NoSQL系统。
