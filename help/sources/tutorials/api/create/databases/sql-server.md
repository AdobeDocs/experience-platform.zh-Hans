...
# 使用 [!DNL Microsoft] API创建SQL Server连 [!DNL Flow Service] 接器
...
本教程使 [!DNL Flow Service] 用API指导您完成连接到 [!DNL Experience Platform] SQL [!DNL Microsoft] Server（以下称“SQL Server”）的步骤。
...
以下各节提供了使用API成功连接到SQL Server所需了解的其他信 [!DNL Flow Service] 息。
...
通过本教程，您已使用API创建了SQL Server [!DNL Flow Service] 连接，并获得了该连接的唯一ID值。 在下一个教程中，您可以使用此连接ID，因为您将学习 [如何使用流服务API浏览数据库或NoSQL系统](../../explore/database-nosql.md)。
