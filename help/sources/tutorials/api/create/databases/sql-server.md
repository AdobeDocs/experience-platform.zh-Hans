...
# 使用[!DNL Microsoft] API创建[!DNL Flow Service] SQL Server基本连接

基本连接表示源和Adobe Experience Platform之间的已验证连接。

阅读本教程以了解如何使用[!DNL Microsoft SQL Server]API[[!DNL Flow Service] 为](https://www.adobe.io/experience-platform-apis/references/flow-service/)创建基本连接。
...
以下部分提供使用[!DNL Microsoft SQL Server] API成功连接到[!DNL Flow Service]所需了解的其他信息。
...
要创建基本连接ID，请在提供您的`/connections`身份验证凭据作为请求参数的一部分时，向[!DNL Microsoft SQL Server]端点发出POST请求。
...
通过完成本教程，您已使用[!DNL Microsoft SQL Server] API创建了[!DNL Flow Service]基本连接。 您可以在下列教程中使用此基本连接ID：
