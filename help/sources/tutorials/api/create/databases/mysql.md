...
# 使用[!DNL Flow Service] API创建MySQL源连接
...
以下各节提供了使用[!DNL Flow Service] API成功连接到MySQL所需了解的其他信息。
...
要创建MySQL连接，必须在POST请求中提供其唯一连接规范ID。 MySQL的连接规范ID为`26d738e0-8963-47ea-aadf-c60de735468a`。
...
通过本教程，您已使用[!DNL Flow Service] API创建了MySQL连接，并已获得该连接的唯一ID值。 在下一个教程中，您可以使用此连接ID，因为您将学习如何使用流服务API](../../explore/database-nosql.md)浏览数据库或NoSQL系统。[