...
topic: overview
type: Tutorial
description: 本教程使用Flow Service API指导您完成将IBM DB2（以下简称“DB2”）连接到Experience Platform的步骤。
...
# 使用[!DNL Flow Service] API创建IBM DB2连接器
...
本教程使用[!DNL Flow Service] API指导您完成将IBM DB2（以下称“DB2”）连接到[!DNL Experience Platform]的步骤。
...
按照本教程，您已使用[!DNL Flow Service] API创建了IBM DB2连接，并已获得该连接的唯一ID值。 在下一个教程中，您可以使用此ID，因为您正在学习如何[使用流服务API](../../explore/database-nosql.md)浏览数据库。
