...
本教程使用Flow Service API指导您完成将IBM DB2（以下简称“DB2”）连接到Experience Platform的步骤。
...
通过本教程，您已使用Flow Service API创建了IBM DB2连接，并获得了该连接的唯一ID值。 在下一个教程中，您可以使用此ID，因为您将学习如 [何使用流服务API浏览数据库](../../explore/database-nosql.md)。
