...
以下各节提供了使用[!DNL Flow Service] API成功连接到[!DNL Oracle]所需的其他信息。
...
要创建[!DNL Oracle]连接，必须在POST请求中提供其唯一连接规范ID。 [!DNL Oracle]的连接规范ID为`d6b52d86-f0f8-475f-89d4-ce54c8527328`。
...
通过本教程，您已使用[!DNL Flow Service] API创建了[!DNL Oracle]连接，并已获得该连接的唯一ID值。 在下一个教程中，您可以使用此ID，因为您将学习如何[使用流服务API](../../explore/database-nosql.md)浏览数据库。
