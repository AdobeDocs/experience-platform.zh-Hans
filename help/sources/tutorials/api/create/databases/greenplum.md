...
# 使用[!DNL Flow Service] API创建[!DNL GreenPlum]连接器
...
要创建[!DNL GreenPlum]连接，其唯一连接规范ID必须作为POST请求的一部分提供。 [!DNL GreenPlum]的连接规范ID为`37b6bf40-d318-4655-90be-5cd6f65d334b`。
...
按照本教程，您已使用[!DNL Flow Service] API创建了[!DNL GreenPlum]连接，并已获得该连接的唯一ID值。 在下一个教程中，您可以使用此ID，因为您正在学习如何[使用流服务API](../../explore/database-nosql.md)浏览数据库。
