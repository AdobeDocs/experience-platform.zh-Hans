...
# 使用[!DNL Flow Service] API创建[!DNL Azure Synapse Analytics]连接器
...
本教程使用Flow Service API指导您完成将[!DNL Azure Synapse Analytics]（以下称为“[!DNL Synapse]”）连接到[!DNL Experience Platform]的步骤。
