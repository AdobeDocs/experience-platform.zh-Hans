...
以下教學課程將逐步引導您完成建立 [!DNL OneTrust Integration] 來源連線並建立資料流以帶來 [!DNL OneTrust Integration] 使用將資料傳送至Platform [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).
