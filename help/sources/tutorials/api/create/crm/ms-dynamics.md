...
本教程将指导您完成使用[[!DNL Flow Service]  API](https://www.adobe.io/experience-platform-apis/references/flow-service/)为[!DNL Microsoft Dynamics]（以下称“[!DNL Dynamics]”）创建基本连接的步骤。
