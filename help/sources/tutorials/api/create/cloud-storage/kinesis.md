...
>[!NOTE]
>
>[!DNL Amazon Kineses]接头为测试版。 有关使用测试版标签的连接器的详细信息，请参见[源概述](../../../../home.md#terms-and-conditions)。
...
以下各节提供您需要了解的其他信息，以便使用[!DNL Flow Service] API成功连接到[!DNL Amazon Kinesis]帐户。
...
| `secretKey` | [!DNL Kinesis]帐户的机密访问密钥。 |
...
| `auth.params.secretKey` | [!DNL Kinesis]帐户的机密访问密钥。 |
...
通过本教程，您已使用API创建了[!DNL Amazon Kinesis]连接，并且作为响应主体的一部分获得了唯一ID。 您可以使用此连接ID来使用流服务API[收集流数据。](../../collect/streaming.md)