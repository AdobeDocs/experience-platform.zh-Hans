...
# 使用[!DNL Flow Service] API连接[!DNL Amazon S3]以Experience Platform
...
### 在Azure上Experience Platform为[!DNL Amazon S3]创建基础连接
...
## 连接[!DNL Amazon S3]以在Amazon Web Services (AWS)上Experience Platform {#aws}
...
### 在AWS中Experience Platform时为[!DNL Amazon S3]创建基本连接
