...
type: Tutorial
description: 数据流是一种从源中检索数据并将其摄取到 [!DNL Platform] 数据集。 本教程提供了使用电子商务帐户配置新数据流的步骤。
...
数据流是一种从源中检索数据并将其摄取到 [!DNL Platform] 数据集。 本教程提供了使用 **[!UICONTROL 电子商务]** 帐户。
...
此外，本教程还要求您已经创建了 **[!UICONTROL 电子商务]** 帐户。 用于创建不同 **[!UICONTROL 电子商务]** 可以在 [源连接器概述](../../../home.md).

## 选择数据

创建 **[!UICONTROL 电子商务]** 帐户， **[!UICONTROL 选择数据]** 中，提供了一个交互式界面来浏览文件层次结构。
...
通过阅读本教程，您已成功创建了要引入的数据流 **[!UICONTROL 电子商务]** 并深入了解监控数据集。 现在，下游可以使用传入数据 [!DNL Platform] 诸如 [!DNL Real-time Customer Profile] 和 [!DNL Data Science Workspace]. 有关更多详细信息，请参阅以下文档：
