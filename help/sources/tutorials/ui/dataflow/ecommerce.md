...
>[!NOTE]
>
>* 要创建数据流，您必须已拥有具有电子商务源的经过身份验证的帐户。 有关在UI中创建不同的电子商务源帐户的教程列表，请参阅 [源概述](../../../home.md#ecommerce).
...
创建电子商务源帐户后， **[!UICONTROL 添加数据]** 此时会显示步骤，提供一个界面以供您浏览电子商务源帐户的表层次结构。
