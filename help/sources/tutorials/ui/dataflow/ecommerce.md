...
topic: overview
type: Tutorial
description: 数据流是从源中检索数据并将其引入 [!DNL Platform] 数据集的计划任务。 本教程提供使用电子商务帐户配置新数据流的步骤。
...
数据流是从源中检索数据并将其引入[!DNL Platform]数据集的计划任务。 本教程提供使用&#x200B;**[!UICONTROL eCommerce]**&#x200B;帐户配置新数据流的步骤。
...
此外，本教程要求您已创建&#x200B;**[!UICONTROL eCommerce]**&#x200B;帐户。 在[源连接器概述](../../../home.md)中，可以找到在UI中创建不同&#x200B;**[!UICONTROL 电子商务]**&#x200B;连接器的列表教程。

## 选择数据

创建&#x200B;**[!UICONTROL eCommerce]**&#x200B;帐户后，将显示&#x200B;**[!UICONTROL 选择数据]**&#x200B;步骤，为您提供一个交互界面来浏览文件层次结构。
...
找到源数据后，选择目录，然后选择&#x200B;**[!UICONTROL 下一步]**。
...
通过本教程，您已成功创建了一个数据流以导入&#x200B;**[!UICONTROL eCommerce]**&#x200B;数据并获得了有关监视数据集的洞察。 现在，下游[!DNL Platform]服务（如[!DNL Real-time Customer Profile]和[!DNL Data Science Workspace]）可以使用传入数据。 有关更多详细信息，请参阅以下文档:
