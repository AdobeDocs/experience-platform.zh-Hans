...
title: 在UI中为电子商务源连接配置数据流
topic-legacy: overview
type: Tutorial
description: 数据流是从源中检索数据并将其引入 [!DNL Platform] 数据集的计划任务。 本教程提供了使用您的电子商务帐户配置新数据流的步骤。
...
数据流是从源中检索数据并将其引入[!DNL Platform]数据集的计划任务。 本教程提供了使用&#x200B;**[!UICONTROL eCommerce]**&#x200B;帐户配置新数据流的步骤。
...
此外，本教程要求您已经创建了&#x200B;**[!UICONTROL eCommerce]**&#x200B;帐户。 在[源连接器概述](../../../home.md)中，可以找到有关在UI中创建不同&#x200B;**[!UICONTROL eCommerce]**&#x200B;连接器的列表教程。

## 选择数据

创建&#x200B;**[!UICONTROL eCommerce]**&#x200B;帐户后，将显示&#x200B;**[!UICONTROL Select data]**&#x200B;步骤，为您提供一个交互式界面来浏览文件层次结构。
...
通过本教程，您成功创建了一个数据流，以导入&#x200B;**[!UICONTROL eCommerce]**&#x200B;数据并获得了对监视数据集的洞察。 现在，下游[!DNL Platform]服务（如[!DNL Real-time Customer Profile]和[!DNL Data Science Workspace]）可以使用传入数据。 有关更多详细信息，请参阅以下文档:
