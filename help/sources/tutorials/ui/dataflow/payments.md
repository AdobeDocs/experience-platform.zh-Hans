...
创建付款帐户后，将显 *[!UICONTROL 示“选择]* ”数据步骤，为您提供一个交互界面来浏览文件层次结构。
...
![添加数据](../../../images/tutorials/dataflow/payments/add-data.png)
...
“映 *[!UICONTROL 射]* ”屏幕还允许您设 *[!UICONTROL 置“增量”列]*。 创建数据流时，您可以将任何时间戳字段设置为基准，以决定在计划的增量摄取中摄取哪些记录。
...
出现 *[!UICONTROL 数据流详细]* 信息步骤，您必须在该步骤中为数据流提供名称和可选说明。 完成后 **[!UICONTROL 选择]** “下一步”。
