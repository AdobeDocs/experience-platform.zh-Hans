...
在“源 *[!UICONTROL ”工作]* 区中，单击“ **[!UICONTROL 浏览]** ”选项卡。 然后，单击与要禁用的活动数据流关联的基本连接的名称。

![](../../../../images/tutorials/dataflow/cloud-storage/streaming/browse.png)

将显 *[!UICONTROL 示“源活动]* ”页面。 从列表中选择活动数据流以在屏 *幕* 右侧打开其“属性”列，该列包含“已启用 **** ”切换按钮。 单击切换以禁用数据流。 在禁用数据流后，可以使用相同的切换重新启用数据流。
