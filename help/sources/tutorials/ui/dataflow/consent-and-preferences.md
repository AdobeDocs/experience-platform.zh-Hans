...
>[!NOTE]
>
>* 要创建数据流，您必须已具有经过身份验证的帐户， [!DNL OneTrust Integration] 源。 请参阅上的教程 [创建 [!DNL OneTrust Integration] UI中的源连接](../../ui/create/consent-and-preferences/onetrust.md) 以了解更多信息。
...
创建您的同意和偏好设置源帐户后， **[!UICONTROL 添加数据]** 步骤，为您提供一个界面，用于浏览您的同意和偏好设置帐户的表层次结构。
...
通过学习本教程，您已成功创建了一个数据流，将数据从您的同意和偏好设置源引入Platform。 传入数据现在可供下游使用 [!DNL Platform] 服务，例如 [!DNL Real-Time Customer Profile] 和 [!DNL Data Science Workspace]. 有关更多详细信息，请参阅以下文档：
