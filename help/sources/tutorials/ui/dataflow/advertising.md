...
此外，本教程要求您已创建广告帐户。 在[源连接器概述](../../../home.md)中可找到有关在UI中创建不同付款连接器的列表教程。

## 选择数据

创建广告帐户后，将显示&#x200B;**[!UICONTROL 选择数据]**&#x200B;步骤，为您提供一个交互界面来浏览文件层次结构。
...
出现&#x200B;**[!UICONTROL 选择模式]**&#x200B;对话框。 选择要应用于新数据集的模式，然后单击&#x200B;**[!DNL Done]**。
