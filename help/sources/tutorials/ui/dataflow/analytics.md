...
>[!NOTE]
>
>要创建数据流，您必须已具有源为[!DNL Mixpanel]的经过身份验证的帐户。 有关详细信息，请参阅有关[在UI [!DNL Mixpanel] 中创建](../../ui/create/analytics/mixpanel.md)源连接的教程。
...
>
>[!VIDEO](https://video.tv.adobe.com/v/32139?captions=chi_hans&quality=12&learn=on)
