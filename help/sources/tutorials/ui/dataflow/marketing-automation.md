...
title: 在UI中为营销自动化源连接配置数据流
topic-legacy: overview
type: Tutorial
description: 数据流是一种从源中检索数据并将其摄取到 [!DNL Platform] 数据集。 本教程提供了使用营销自动化帐户配置新数据流的步骤。
...
数据流是一种从源中检索数据并将其摄取到 [!DNL Platform] 数据集。 本教程提供了使用营销自动化帐户配置新数据流的步骤。
...
此外，本教程要求您已创建营销自动化帐户。 可在 [源连接器概述](../../../home.md).

## 选择数据

创建营销自动化帐户后， *选择数据* 中，提供了一个交互式界面来浏览文件层次结构。
...
![选择模式](../../../images/tutorials/dataflow/marketing-automation/select-schema.png)
...
在 **[!UICONTROL 身份验证]** 屏幕中，选择与要禁用的数据流关联的连接名称。
