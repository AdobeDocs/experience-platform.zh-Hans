...
type: Tutorial
description: 数据流是从源中检索数据并将其引入 [!DNL Platform] 数据集的计划任务。 本教程提供了使用营销自动化帐户配置新数据流的步骤。
...
数据流是从源中检索数据并将其引入[!DNL Platform]数据集的计划任务。 本教程提供了使用营销自动化帐户配置新数据流的步骤。
...
此外，本教程要求您已经创建了营销自动化帐户。 [源连接器概述](../../../home.md)中提供了有关在UI中创建不同营销自动化连接器的列表教程。
