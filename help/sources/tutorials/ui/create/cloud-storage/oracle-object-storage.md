...
收集所需的凭据后，您可以按照以下步骤创建新的Oracle对象存储帐户以连接到Platform。
...
通过学习本教程，您已建立与[!DNL Oracle Object Storage]帐户的连接。 您现在可以继续有关[配置数据流以将数据从云存储引入Platform](../../dataflow/batch/cloud-storage.md)的下一个教程。
