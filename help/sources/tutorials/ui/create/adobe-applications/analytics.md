...
# 在UI中创建AdobeAnalytics源连接器

本教程提供在UI中创建AdobeAnalytics源连接器以将消费者数据引入Adobe Experience Platform的步骤。
...
## 与AdobeAnalytics建立源连接

登录到 <a href="https://platform.adobe.com" target="_blank">Adobe Experience Platform</a> ，然后从左 **[!UICONTROL 侧导航栏]** 中选择“源”以访问源工作区。 “目 *录* ”屏幕显示用于创建入站连接的可用源，每个源显示与它们关联的现有帐户和数据集流的数量。

您可以从屏幕左侧的目录中选择适当的类别。 或者，您也可以使用搜索选项找到要使用的特定源。

在Adobe *应用程序* 类别下， **[!UICONTROL 选择Adobe]** Analytics，在屏幕的右侧显示一个信息栏。 信息栏提供所选源的简短描述以及与源或视图其文档的选项。 要视图现有帐户，请选择 **[!UICONTROL 帐户]**。

![](../../../../images/tutorials/create/analytics/catalog.png)

### 选择数据

出现 *AdobeAnalytics* (Adobe G)步骤。 此屏幕上列出了以前为Analytics建立的数据集流。 您可以通过单击选择数据来创建新 **[!UICONTROL 数据集流]**。
...
此时 *会出现* “审阅”步骤，允许您在创建新的Analytics绑定数据集流之前对其进行查看。 连接的详细信息按类别分组，包括：
...
有关回填、实时数据及其各自延迟的详细信息，请参阅 [Analytics数据连接器概述](../../../../connectors/adobe-applications/analytics.md)。
...
有关如何标记来自Analytics的数据的更多信息，请访 [问数据使用标签指南](../../../../../data-governance/labels/user-guide.md)。
