...
Adobe Experience Platform中的源连接器提供按计划收集外部源CRM数据的能力。 本教程提供了使用用 [!DNL Microsoft Dynamics] 户界面创建(下[!DNL Dynamics]称“”)源连接器 [!DNL Platform] 的步骤。
...
在“数 *[!UICONTROL 据库]* ”类别 **[!UICONTROL 下]** ，选择Dynamics **单** 击+图标(+)以创建新连 [!DNL Dynamics] 接器。
