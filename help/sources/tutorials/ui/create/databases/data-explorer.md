...
topic: overview
type: Tutorial
description: 本教程提供了使用平台用户界面创建AzureData Explorer(以下称“Data Explorer”)源连接器的步骤。
...
Adobe Experience Platform的源连接器提供按计划接收外部源数据的能力。 本教程提供了使用用 [!DNL Azure Data Explorer] 户界面创建(下[!DNL Data Explorer]称“”)源连接器 [!DNL Platform] 的步骤。
