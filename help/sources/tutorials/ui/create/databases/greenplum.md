...
Adobe Experience Platform中的源连接器提供按计划接收外部源数据的能力。 本教程提供了使用用户界 [!DNL GreenPlum] 面创建源连接器 [!DNL Platform] 的步骤。
...
在“数 *[!UICONTROL 据库]* ”类别 **[!UICONTROL 下]** ，选择“GreenPlum **”,** 单击+图标(+)以创建新连 [!DNL GreenPlum] 接器。
