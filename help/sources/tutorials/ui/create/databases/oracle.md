...
Adobe Experience Platform中的Source连接器提供了按计划摄取外部来源数据的功能。 本教程提供了使用[!DNL Platform]用户界面创建[!DNL Oracle DB]源连接器的步骤。
...
要在[!DNL Platform]上访问您的[!DNL Oracle DB]帐户，必须提供以下值：
...
收集所需的凭据后，您可以按照以下步骤链接您的[!DNL Oracle DB]帐户以连接到[!DNL Platform]。
...
在&#x200B;**[!UICONTROL 数据库]**&#x200B;类别下，选择&#x200B;**[!UICONTROL Oracle数据库]**。 如果这是您第一次使用此连接器，请选择&#x200B;**[!UICONTROL 配置]**。 否则，请选择&#x200B;**[!UICONTROL 添加数据]**&#x200B;以创建新的[!DNL Oracle DB]连接器。

![目录](../../../../images/tutorials/create/oracle/catalog.png)

将显示&#x200B;**[!UICONTROL 连接到Oracle数据库]**&#x200B;页。 在此页上，您可以使用新凭据或现有凭据。
...
通过学习本教程，您已建立与[!DNL Oracle DB]帐户的连接。 您现在可以继续下一教程，并[配置数据流以将数据导入 [!DNL Platform]](../../dataflow/databases.md)。
