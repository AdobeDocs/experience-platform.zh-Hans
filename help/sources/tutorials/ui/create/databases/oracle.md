...
Adobe Experience Platform的源连接器提供按计划接收外部源数据的能力。 本教程提供了使用用户界 [!DNL Oracle] 面创建源连接器 [!DNL Platform] 的步骤。
...
在“数 *[!UICONTROL 据库]* ”类别 **[!UICONTROL 下]** ，选择Oracle **[!UICONTROL DB]** ，然后 [!DNL Oracle] 选择添加数据，以创建新连接器。
