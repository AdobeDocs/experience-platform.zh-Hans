...
topic: overview
type: Tutorial
description: 了解如何使用Adobe Experience PlatformUI创建Couchbase源连接。
...
如果您已经有有效的[!DNL Couchbase]连接，您可以跳过此文档的其余部分，继续学习有关配置数据流](../../dataflow/databases.md)的教程。[
...
收集所需凭据后，您可以按照以下步骤将[!DNL Couchbase]帐户链接到[!DNL Platform]。
...
在&#x200B;**[!UICONTROL Databases]**&#x200B;类别下，选择&#x200B;**[!UICONTROL Couchbase]**。 如果这是您首次使用此连接器，请选择&#x200B;**[!UICONTROL 配置]**。 否则，选择&#x200B;**[!UICONTROL 添加数据]**&#x200B;以创建新的[!DNL Couchbase]连接器。

![目录](../../../../images/tutorials/create/couchbase/catalog.png)

将显示&#x200B;**[!UICONTROL 连接到Couchbase]**&#x200B;页。 在此页上，您可以使用新凭据或现有凭据。

### 新帐户

如果您使用新凭据，请选择&#x200B;**[!UICONTROL 新建帐户]**。 在显示的输入表单上，提供名称、可选说明和[!DNL Couchbase]凭据。 完成后，选择&#x200B;**[!UICONTROL 连接到源]**，然后为新连接建立留出一些时间。
...
按照本教程，您已建立了与[!DNL Couchbase]帐户的连接。 现在，您可以继续阅读下一个教程，并配置数据流以将数据导入 [!DNL Platform]](../../dataflow/databases.md)。[