...
Adobe Experience Platform中的源连接器提供按计划接收外部源数据的能力。 本教程提供了使用用 [!DNL Azure Table Storage] 户界面创建（下称“ATS”）源连接器 [!DNL Platform] 的步骤。
...
在“ *[!UICONTROL 类别]* ”下， **[!UICONTROL 选择“Azure表存储]** ”，在屏幕的右侧显示一个信息栏。 信息栏提供所选源的简短描述以及与源或视图其文档的选项。 要创建新的入站连接，请选择“ **[!UICONTROL 连接源”]**。
