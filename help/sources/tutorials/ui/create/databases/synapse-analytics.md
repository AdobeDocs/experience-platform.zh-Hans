---
title: 在UI中创建Azure synapseAnalytics Source连接
...
本教程提供了使用[!DNL Platform]用户界面创建[!DNL Azure Synapse Analytics] （以下称为“[!DNL Synapse]”）源连接器的步骤。
...
收集所需的凭据后，您可以按照以下步骤将您的[!DNL Synapse]帐户关联到[!DNL Platform]。
...
在&#x200B;**[!UICONTROL 数据库]**&#x200B;类别下，选择&#x200B;**[!UICONTROL Azure synapse分析]**。 如果这是您第一次使用此连接器，请选择&#x200B;**[!UICONTROL 配置]**。 否则，请选择&#x200B;**[!UICONTROL 添加数据]**&#x200B;以创建新的[!DNL Synapse]连接器。

![](../../../../images/tutorials/create/azure-synapse-analytics/catalog.png)

此时会显示&#x200B;**[!UICONTROL 连接到Azure synapseAnalytics]**&#x200B;页。 在此页上，您可以使用新凭据或现有凭据。
...
通过学习本教程，您已建立与[!DNL Synapse]帐户的连接。 您现在可以继续下一教程，并[配置数据流以将数据导入 [!DNL Platform]](../../dataflow/databases.md)。
