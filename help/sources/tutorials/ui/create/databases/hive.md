...
Adobe Experience Platform中的源连接器提供按计划接收外部源数据的能力。 本教程提供了在Azure HDInsights源连接器上使用Platform用户界面创建Apache Hive的步骤。
...
收集所需凭据后，您可以按照以下步骤创建新的Hive帐户以连接到Platform。
...
按照本教程，您已建立了与您的Hive帐户的连接。 您现在可以继续学习下一个教程并 [配置数据流以将数据引入Platform](../../dataflow/databases.md)。