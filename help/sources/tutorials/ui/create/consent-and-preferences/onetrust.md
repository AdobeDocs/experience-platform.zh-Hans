...
本教程提供了一些步骤，介绍如何使用Platform用户界面创建[[!DNL OneTrust Integration]](https://my.onetrust.com/s/contactsupport?language=en_US)源连接以将历史同意数据和计划同意数据吸收到Adobe Experience Platform中。
...
为了将[!DNL OneTrust Integration]连接到Platform，您必须提供以下身份验证凭据的值：
...
在Platform UI中，从左侧导航中选择&#x200B;**[!UICONTROL 源]**&#x200B;以访问Experience Platform中可用源目录的[!UICONTROL 源]工作区。
...
通过学习本教程，您已建立与[!DNL OneTrust Integration]帐户的连接。 您现在可以继续下一教程，并[配置数据流以将同意数据导入Platform](../../dataflow/consent-and-preferences.md)。
