...
>[!NOTE]
>Salesforce Service Cloud连接器处于测试状态。 有关使用 [测试版标记](../../../../home.md#terms-and-conditions) 的连接器的更多信息，请参阅源概述。

Adobe Experience Platform中的源连接器提供按计划接收外部源数据的能力。 本教程提供了使用Platform用户界面创建Salesforce Service Cloud（以下称“SSC”）源连接器的步骤。
...
收集所需凭据后，您可以按照以下步骤创建新的SSC帐户以连接到Platform。
...
通过本教程，您已建立了与SSC帐户的连接。 您现在可以继续阅读下一个教程并 [配置数据流，将客户成功数据引入Platform](../../dataflow/customer-success.md)。