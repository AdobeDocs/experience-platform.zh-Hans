...
登录到 <a href="https://platform.adobe.com" target="_blank">Adobe Experience Platform</a> ，然后从左 **侧导航栏** 中选 *择源* ，以访问源工作区。 “ *目录* ”屏幕显示可为其创建入站帐户的各种源。 每个源显示与其关联的现有帐户和数据集流的数量。
...
通过遵循本教程，您已建立了与OData帐户的连接。 您现在可以继续阅读下一个教程并 [配置数据集流，将协议数据引入Platform](../../dataflow/protocols.md)。