...
# 使用用户界面连接您的[!DNL RainFocus]帐户以Experience Platform
...
在将[!DNL RainFocus]帐户连接到Experience Platform之前，必须先完成以下先决任务：
...
在Platform UI中，从左侧导航栏中选择&#x200B;**[!UICONTROL 源]**&#x200B;以访问源工作区。 *[!UICONTROL Catalog]*&#x200B;屏幕显示您可以用来创建帐户的各种源。
...
* 粘贴从Experience Platform中的数据流复制的&#x200B;**数据流ID**&#x200B;和&#x200B;**流式端点**，并选择&#x200B;**保存**

## 后续步骤

通过学习本教程，您已为[!DNL RainFocus]源建立连接，从而允许您流式传输事件管理和分析数据以Experience Platform。
