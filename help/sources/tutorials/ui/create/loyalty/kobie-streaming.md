...
![选择了Kobie流事件信息卡的UI中的源目录。](../../../../images/tutorials/create/kobie/catalog.png)

## 选择数据

接下来，使用&#x200B;*[!UICONTROL Select data]*&#x200B;接口上传示例JSON文件以定义源架构。 在此步骤中，您可以使用预览界面查看有效载荷的文件结构。 完成后，选择&#x200B;**[!UICONTROL Next]**。

![源工作流的选择数据步骤](../../../../images/tutorials/create/kobie/select-data.png)
...
![数据流详细信息接口](../../../../images/tutorials/create/kobie/dataflow-details.png)
...
![源工作流中的审核步骤。](../../../../images/tutorials/create/kobie/review.png)

## 检索流端点URL

创建连接后，将显示源详细信息页面。 此页面显示新创建连接的详细信息，包括以前运行的数据流、ID和流端点URL。

![流终结点URL。](../../../../images/tutorials/create/kobie/streaming-endpoint.png)
