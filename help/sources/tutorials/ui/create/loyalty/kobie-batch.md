---
title: 使用UI将批量数据从Kobie引入到Experience Platform中
description: 了解如何使用UI将批量数据从Kobie摄取到Adobe Experience Platform。
badge: Beta 版
hide: true
hidefromtoc: true
...
# 使用UI将批次数据从[!DNL Kobie]摄取到Experience Platform

阅读本教程，了解如何使用UI中的源工作区将批次数据从[!DNL Kobie]帐户摄取到Adobe Experience Platform中。
...
要从[!DNL Kobie]中摄取数据，请选择&#x200B;**[!UICONTROL Kobie Batch Source Connector]**&#x200B;下的&#x200B;*[!UICONTROL Loyalty]*&#x200B;源卡，然后选择&#x200B;**[!UICONTROL Add data]**。
...
要为您的[!DNL Kobie]源创建新帐户，请选择&#x200B;**[!UICONTROL New account]**&#x200B;并为您的帐户提供名称和可选描述。 接下来，提供您的[!DNL Kobie]域和[!UICONTROL Kobie Management API Key]。 完成后，选择&#x200B;**[!UICONTROL Connect to source]**，留出一段时间让您的连接建立。



### 使用现有帐户

要使用现有帐户，请选择&#x200B;**[!UICONTROL Existing account]**&#x200B;并从帐户界面中选择要使用的[!DNL Kobie]帐户。
...
>[!IMPORTANT]
>
>有关映射[!DNL Kobie]源数据的其他指导，请阅读[[!DNL Kobie]概述]



## 计划数据流摄取

此时会显示[!UICONTROL Scheduling]步骤。 使用界面配置摄取计划，以使用配置的映射自动摄取选定的源数据。 默认情况下，计划设置为`Once`。 要调整摄取频率，请选择&#x200B;**[!UICONTROL Frequency]**，然后从下拉菜单中选择一个选项。
