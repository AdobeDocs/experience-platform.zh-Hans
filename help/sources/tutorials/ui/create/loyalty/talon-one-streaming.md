...
若要从[!DNL Talon.One]流式传输数据，请选择&#x200B;**[!UICONTROL 忠诚度]**&#x200B;下的&#x200B;*[!UICONTROL Talon.One流式传输事件]*&#x200B;源卡，然后选择&#x200B;**[!UICONTROL 添加数据]**。
...
创建数据流后，您可以监视通过它摄取的数据，以查看有关摄取率、成功和错误的信息。 有关如何监视数据流的详细信息，请参阅有关UI中[监视帐户和数据流的教程](../../monitor-streaming.md)