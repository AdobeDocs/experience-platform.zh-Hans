...
# 使用UI将[!DNL Demandbase Intent]连接到Experience Platform

阅读本指南，了解如何使用用户界面将您的[!DNL Demandbase Intent]帐户连接到Adobe Experience Platform。
...
有关如何检索身份验证凭据的信息，请阅读[[!DNL Demandbase Intent] 概述](../../../../connectors/data-partners/demandbase.md)。
...
* **存储段名称**：将从其中提取数据的[!DNL Demandbase]存储段。

![源工作流的新帐户接口。](../../../../images/tutorials/create/demandbase/new.png)
...
* **描述**： （可选）数据流的简短说明或其他信息。
* **域源**：域或网站字段将您的源帐户记录与Experience Platform帐户相匹配。 此值取决于您的配置。 如果未提供，则域默认为`accountOrganization.website`。

![源工作流的数据流详细信息步骤。](../../../../images/tutorials/create/demandbase/dataflow-detail.png)
...
![源工作流的审阅界面。](../../../../images/tutorials/create/demandbase/review.png)

## 后续步骤

通过学习本教程，您已成功创建了一个数据流，以将意图数据从[!DNL Demandbase]源引入Experience Platform。 有关其他资源，请访问下面列出的文档。
