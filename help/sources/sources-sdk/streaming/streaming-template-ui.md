...
>[!TIP]
>
>下面使用的屏幕截图是示例。 在创建文档时，请将图像替换为实际源的屏幕快照。 您可以使用相同的标记模式和颜色，也可以使用相同的文件名。 请确保屏幕快照捕获了整个Platform UI屏幕。 有关如何上传屏幕截图的信息，请参阅上的指南 [提交文档以供审阅](../documentation/github.md).
...
通过学习本教程，您已建立与的连接 *YOURSOURCE* 帐户。 您现在可以继续下一教程和 [配置数据流以将数据引入平台](https://experienceleague.adobe.com/docs/experience-platform/sources/ui-tutorials/dataflow/crm.html).
