...
以下文档提供了有关如何使用检索和更新流规格的步骤 [!DNL Flow Service] 适用于自助源的API (Streaming SDK)。
...
使用创建的源 `generic-streaming` 模板都使用 `GenericStreamingAEP` 流程规范。 可以通过向以下对象发出GET请求来检索此流量规范 `/flowSpecs/` 端点，并提供 `flowSpec.id` 之 `e77fde5a-22a8-11ed-861d-0242ac120002`.
...
以下请求更新了的流规范 `e77fde5a-22a8-11ed-861d-0242ac120002` 以包含连接规范ID `bdb5b792-451b-42de-acf8-15f3195821de`.
