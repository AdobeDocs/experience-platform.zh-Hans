---
title: 使用流服务API更新流式SDK的连接规范
description: 以下文档提供了有关如何使用自助源（流SDK）的流服务API进行连接规范的步骤。
hide: true
hidefromtoc: true
...
完成连接规范的更新后，您现在可以继续 [测试并提交源以进行集成](./submit.md).