...
| `1102-500` | 內部錯誤 | 發生內部錯誤。 请重试。如果問題仍然存在，請聯絡客戶支援。 |
| `1103-503` | 服務無法使用 | 服務暫時無法使用。 请重试。如果問題仍然存在，請聯絡客戶支援。 |
| `1104-504` | 閘道逾時 | 發生閘道逾時。 请重试。如果問題仍然存在，請聯絡客戶支援。 |
| `1400-500` | 內部錯誤 | 發生內部錯誤。 请重试。如果問題仍然存在，請聯絡客戶支援。 |
