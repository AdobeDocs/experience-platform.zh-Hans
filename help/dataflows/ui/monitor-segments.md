...
>title="区段"
>abstract="区段视图包含有关您的所有IMS组织区段的信息，以及有关其激活和评估作业的更多信息。"
...
| **[!UICONTROL 用户档案计数]** | 区段作业正在评估的用户档案数。 每个用户应具有唯一的用户档案。 |
...
| 量度 | 描述 |
| ------ | ----------- |
| **[!UICONTROL 收到的用户档案]** | 激活流程中收到的用户档案总数。 |
| **[!UICONTROL 已激活身份]** | 成功激活到目标的身份总数，基于收到的用户档案。 |
| **[!UICONTROL 排除的身份]** | 根据收到的用户档案，被排除到目标的身份总数。 由于缺少属性或违反同意，可能会排除这些身份。 |
