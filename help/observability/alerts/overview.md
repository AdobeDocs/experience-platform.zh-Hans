...
您可以使用[Adobe App Builder](https://developer.adobe.com/app-builder/docs/get_started/app_builder_get_started/first-app)上的webhook代理将[Adobe I/O Events](https://developer.adobe.com/events/docs/guides/)从Experience Platform接收到[!DNL Slack]。 代理处理Adobe的验证握手并将事件负载转换为[!DNL Slack]消息，以便您可以直接接收面向客户的警报到工作区。

>[!VIDEO](https://video.tv.adobe.com/v/3480183?learn=on)

有关如何通过与Experience Platform App Builder webhook代理集成在[!DNL Slack]中接收Adobe通知的更多信息，请参阅[在 [!DNL Slack]](https://experienceleague.adobe.com/zh-hans/docs/platform-learn/tutorials/monitoring/monitor-events-in-slack)中监视Experience Platform事件。
