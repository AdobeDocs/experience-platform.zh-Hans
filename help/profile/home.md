...
实时客户资料由称为 **主要实体**，以及各种支持实体。 在Experience Platform上下文中，主实体通常是 **配置文件实体**，由个人的特征、行为和区段成员关系组成。 其他实体允许分段引擎利用用户档案主实体外的数据，并包括以下内容：
...
维和B2B实体通过 **模式关系**. 有关更多信息，请参阅以下文档：

- [为查找实体创建一对一架构关系](../xdm/tutorials/relationship-ui.md)
- [为B2B实体创建多对一模式关系](../xdm/tutorials/relationship-b2b.md)
