...
## 基于[!DNL XDM Individual Profile]类编写架构

要创建数据集，您首先需要创建一个实施[!DNL XDM Individual Profile]类的新架构。 有关如何创建模式的更多信息，请阅读[模式注册API开发人员指南](../../xdm/api/getting-started.md)。
...
在数据集和流连接就绪后，您可以摄取XDM格式的JSON记录，以将记录数据摄取到[!DNL Platform]中。
