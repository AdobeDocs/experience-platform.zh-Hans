...
机器人检测允许您识别由生成的事件 [Web SDK](../web-sdk/home.md)， [移动SDK](https://developer.adobe.com/client-sdks/home/) 和 [[!DNL Server API]](../server-api/overview.md) 由已知的蜘蛛和机器人生成。
