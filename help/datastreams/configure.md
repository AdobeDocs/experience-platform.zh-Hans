...
如果启用以上任何字段进行数据收集，请确保正确设置 [`context`](/help/web-sdk/commands/configure/context.md) 配置Web SDK时的数组属性。
...
| [!UICONTROL Media Analytics] | 支持通过Experience PlatformSDK处理流跟踪数据以实现Edge Network集成，或者 [Media Edge API](https://developer.adobe.com/cja-apis/docs/endpoints/media-edge/getting-started/). 从了解Media Analytics [文档](https://experienceleague.adobe.com/docs/media-analytics/using/media-overview.html?lang=zh-Hans). |
