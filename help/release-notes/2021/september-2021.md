...
| 功能 | 描述 |
| --- | --- |
| [!DNL Data Landing Zone] | 您现在可以使用[!DNL Data Landing Zone]API[[!DNL Flow Service] 或](../../sources/tutorials/api/create/cloud-storage/data-landing-zone.md)用户界面[创建](../../sources/tutorials/ui/create/cloud-storage/data-landing-zone.md)源连接。 [!DNL Data Landing Zone]是由Experience Platform设置的[!DNL Azure Blob]存储接口，允许您访问安全的基于云的文件存储设施，以将文件导入Experience Platform。 有关详细信息，请参阅[[!DNL Data Landing Zone] 概述](../../sources/connectors/cloud-storage/data-landing-zone.md)。 |
| [!DNL Snowflake] | 您现在可以使用[!DNL Snowflake]API[[!DNL Flow Service] 或](../../sources/tutorials/api/create/databases/snowflake.md)用户界面[创建](../../sources/tutorials/ui/create/databases/snowflake.md)源连接，将数据从[!DNL Snowflake]数据库引入Experience Platform。 有关详细信息，请参阅[[!DNL Snowflake] 概述](../../sources/connectors/databases/snowflake.md)。 |
