---
title: Adobe Experience Platform 2021年6月版发行说明
...
| 功能 | 描述 |
| ------- | ----------- |
| [!DNL Veeva CRM] (Beta) | 您现在可以使用[!DNL Flow Service] API或用户界面连接[!DNL Veeva CRM]以Experience Platform。 有关详细信息，请参阅[[!DNL Veeva CRM] 连接器概述](../../sources/connectors/crm/veeva.md)。 |
