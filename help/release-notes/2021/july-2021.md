...
| [支援重複資料刪除索引鍵](../../destinations/ui/activate-batch-profile-destinations.md#deduplication-keys) | 通过选择删除重复项键，消除导出文件中同一配置文件的多条记录。您可以選取單一名稱空間或最多兩個XDM結構描述屬性作為重複資料刪除索引鍵。 |
