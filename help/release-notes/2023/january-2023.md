...
| 功能 | 描述 |
| ----------- | ----------- |
| 用于与流媒体目标集成的付费媒体同意策略增强功能 | 针对付费媒体激活用例，对[流媒体目标](/help/destinations/destination-types.md#streaming-destinations)的同意策略执行](/help/data-governance/enforcement/auto-enforcement.md#consent-policy-enhancement)进行了[增强。当轮廓不再符合同意策略时，Experience Platform 现在会主动将其策略退出通知给流媒体目标。<br> <b>注意</b>：此功能仅适用于&#x200B;**[!UICONTROL Privacy and Security Shield]**&#x200B;的客户和&#x200B;**[!UICONTROL Healthcare Shield]**&#x200B;的客户。 |
