...
| [!BADGE 测试版]{type=Informational}支持 [!DNL RainFocus] | 您现在可以使用 [!DNL RainFocus] 源集成将 [!DNL RainFocus] 帐户中的事件管理和分析数据添加到 Experience Platform。有关更多信息，请阅读[[!DNL RainFocus] 源概述](../../sources/connectors/analytics/rainfocus.md)。 |
