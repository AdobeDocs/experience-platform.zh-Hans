...
| 在导出到 Beta 云存储目的地时包含清单文件 | 现在，您可以包含一个清单JSON文件，该文件包含有关导出位置、导出大小等的信息，以便将数据导出到六个云存储测试版目标 —  [(Beta) Amazon S3](/help/destinations/catalog/cloud-storage/amazon-s3.md)， [(Beta) Azure Blob](/help/destinations/catalog/cloud-storage/azure-blob.md)， [(Beta) Azure Data Lake Storage Gen2](/help/destinations/catalog/cloud-storage/adls-gen2.md)， [(Beta)数据登陆区](/help/destinations/catalog/cloud-storage/data-landing-zone.md)， [(Beta) Google Cloud Storage](/help/destinations/catalog/cloud-storage/google-cloud-storage.md)， [(Beta) SFTP](/help/destinations/catalog/cloud-storage/sftp.md). <br><br>在上面链接的页面的&#x200B;**[!UICONTROL 目标详细信息]**&#x200B;部分获取更多信息。 |
