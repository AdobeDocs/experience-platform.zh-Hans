...
| 功能 | 描述 |
|--- | ---|
| [!DNL JupyterLab Launcher Real-time ML]入门者 | [!DNL JupyterLab Launcher]现在包含[!DNL Real-time Machine Learning]的[!DNL Python]笔记本启动程序(Alpha)。 |
...
| 对数据库的其他API和用户界面支持 | [!DNL Couchbase]的新源连接器。 |
