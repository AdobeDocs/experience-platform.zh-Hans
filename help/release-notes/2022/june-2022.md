...
| 组件类型 | 名称 | 描述 |
| --- | --- | --- |
| 类 | [[!UICONTROL 藥物]](https://github.com/adobe/xdm/blob/master/components/classes/medication.schema.json) | 一種醫療保健產業類別，可擷取用於醫療處理（尤其是藥物或藥物）的物質詳細資訊。 |
| 类 | [[!UICONTROL 规划]](https://github.com/adobe/xdm/blob/master/components/classes/plan.schema.json) | 擷取醫療計畫詳細資訊（例如健康計畫或保險計畫）的醫療保健產業類別。 |
| 类 | [[!UICONTROL 提供者]](https://github.com/adobe/xdm/blob/master/components/classes/provider.schema.json) | 擷取醫療保健提供者相關詳細資料的醫療保健產業類別。 |
| 类 | [[!UICONTROL 付款人]](https://github.com/adobe/xdm/blob/master/components/classes/payer.schema.json) | 擷取保險公司詳細資訊的醫療保健產業類別。 |
| 类 | [[!UICONTROL 即時活動排程]](https://github.com/adobe/xdm/blob/master/components/classes/live-event-schedule.schema.json) | 一種體育及娛樂產業類別，可擷取直播活動排程的詳細資訊，例如旅遊演唱會排程或運動隊排程。 |
| 类 | [[!UICONTROL 位置]](https://github.com/adobe/xdm/blob/master/components/classes/location.schema.json) | 擷取現場活動位置（例如音樂廳或體育場）的運動和娛樂產業類別。 |
| 字段组 | [[!UICONTROL 醫療保健]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/medication/healthcare-medication.schema.json) | 的欄位群組 [!UICONTROL 藥物] 擷取藥物詳細資訊的類別，例如品牌名稱、批號和數量。 |
| 字段组 | [[!UICONTROL 醫療保健計畫詳細資料]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/plan/healthcare-plan-details.schema.json) | 的欄位群組 [!UICONTROL 計畫] 擷取網路、型別和作用中狀態等詳細資料的類別。 |
| 字段组 | [[!UICONTROL 醫療保健提供者]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/provider/healthcare-provider-details.schema.json) | 的欄位群組 [!UICONTROL 提供者] 類別，可擷取獲授權提供醫療保健診斷與治療服務的個人健康專業人員或健康設施組織的詳細資訊。 |
