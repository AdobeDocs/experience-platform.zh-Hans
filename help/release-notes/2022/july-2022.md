...
| 组件类型 | 名称 | 描述 |
| --- | --- | --- |
| 类 | [[!UICONTROL 天氣]](https://github.com/adobe/xdm/blob/master/components/classes/weather.schema.json) | 用於擷取天氣資料的記錄型類別。 |
| 字段组 | [[!UICONTROL 目前天氣]](https://github.com/adobe/xdm/blob/master/components/classes/weather.schema.json) | 的欄位群組 [!UICONTROL XDM ExperienceEvent] 和 [!UICONTROL 天氣] 類別，用於擷取郵遞區號的目前天氣狀況。 |
| 字段组 | [[!UICONTROL 天氣預報]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/shared/forecasted-weather.schema.json) | 的欄位群組 [!UICONTROL XDM ExperienceEvent] 和 [!UICONTROL 天氣] 類別，用於擷取郵遞區號的預測天氣狀況。 |
| 字段组 | [[!UICONTROL 產品觸發程式]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/shared/product-triggers.schema.json) | 的欄位群組 [!UICONTROL XDM ExperienceEvent] 和 [!UICONTROL 天氣] 類別，用於擷取產品特定觸發器，這些觸發器會利用已知會驅動消費者行為的天氣條件。 |
| 字段组 | [[!UICONTROL 相對觸發程式]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/shared/relative-triggers.schema.json) | 的欄位群組 [!UICONTROL XDM ExperienceEvent] 和 [!UICONTROL 天氣] 類別，用來擷取利用已知會驅動消費者行為的天氣狀況的相關觸發器。 |
| 字段组 | [[!UICONTROL 嚴重觸發程式]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/shared/severe-triggers.schema.json) | 的欄位群組 [!UICONTROL XDM ExperienceEvent] 和 [!UICONTROL 天氣] 類別，用來擷取觸發程式，這些觸發程式會利用已知的惡劣天氣條件來驅動消費者行為。 |
| 字段组 | [[!UICONTROL 天氣觸發程式]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/shared/weather-triggers.schema.json) | 的欄位群組 [!UICONTROL XDM ExperienceEvent] 和 [!UICONTROL 天氣] 類別，用來擷取一般觸發程式，這些觸發程式會利用已知的天氣狀況來驅動消費者行為。 |
| 字段组 | [[!UICONTROL 媒體互動細節]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/experience-event/experienceevent-media.schema.json) | 的欄位群組 [!UICONTROL XDM ExperienceEvent] 擷取媒體互動相關細節的類別。 |
| 字段组 | [[!UICONTROL MediaAnalytics互動細節]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/experience-event/experienceevent-media-analytics.schema.json) | 的欄位群組 [!UICONTROL XDM ExperienceEvent] 類別，擷取與媒體報表互動的詳細資訊。 |
