...
- [Adobe Experience Platform 发行说明](#adobe-experience-platform-release-notes)
   - [仪表板 {#dashboards}](#dashboards-dashboards)
      - [帐户配置文件功能板](#account-profiles-dashboards)
      - [用户档案功能板](#profile-dashboards)
      - [目标功能板](#destinations-dashboards)
   ...
   - [Real-time Customer Data Platform B2B 版本 {#b2b}](#real-time-customer-data-platform-b2b-edition-b2b)
   - [实时客户个人资料 {#profile}](#real-time-customer-profile-profile)
...
| 功能 | 描述 |
| --- | --- |
| 导致帐户匹配 | 通过帐户到帐户匹配，您可以将已知人员用户档案加入帐户用户档案。 然后，您可以在B2B上下文中对数据进行分段和定位，如帐户或商机。 每日运行的作业使用确定性因素和可能性因素将尚未与任何帐户关联的人员配置文件匹配到最佳匹配帐户。 然后，您可以决定是否在区段定义中包含此类匹配项 |
...
有关如何在区段定义中使用相关帐户的说明，请参阅 [Real-time Customer Data Platform B2B版的分段用例](../../rtcdp/segmentation/b2b.md#related-accounts).
