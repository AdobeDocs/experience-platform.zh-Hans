...
| [!BADGE Beta]{type=Informative} 从激活流程中移除多个受众和数据集 | 您现在可以从目标激活流中选择和删除多个受众和数据集。查看[目标详情](../../destinations/ui/destination-details-page.md#bulk-remove)和[数据集导出](../../destinations/ui/export-datasets.md)文档以了解更多详细信息。 |
