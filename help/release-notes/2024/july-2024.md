...
- [!BADGE 有限可用性]{type=Informative} [联合受众组合](#federated-audience-composition)
...
| 类型 | 功能 | 描述 |
| --- | --- | --- |
| Web SDK | 自动跟踪命题互动 | 您现在可以使用 `autoCollectPropositionInteractions` Web SDK 中的属性来确定 Web SDK 是否应该自动收集命题交互。有关更多信息，请参阅[`autoCollectPropositionInteractions`](/help/collection/js/commands/configure/autocollectpropositioninteractions.md)文档。 |
