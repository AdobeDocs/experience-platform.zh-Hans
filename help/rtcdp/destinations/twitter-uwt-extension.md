...
seo-title: Twitter通用网站标记扩展
description: Twitter通用网站标签扩展是Adobe实时客户数据平台中的一个广告目的地。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
seo-description: Twitter通用网站标签扩展是Adobe实时客户数据平台中的一个广告目的地。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
...
# Twitter通用网站标记扩展 {#twitter-uwt-extension}

## 概述 {#overview}

Twitter通用网站标记提供将信标发送到Twitter UWT标记的操作。

Twitter通用网站标签是Adobe实时客户数据平台中的一个广告扩展。 有关扩展功能的详细信息，请参阅高 [级转换跟踪](https://business.twitter.com/en/solutions/twitter-ads/website-clicks/advanced-conversion-tracking.html)。
...
![Twitter通用网站标记扩展](assets/twitter-uwt-extension.png)
