...
description: Awin Advertiser Mastertag扩展是Adobe Real-time Customer Data Platform中的一个广告目的地。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
...
# Awin Advertiser Mastertag扩展 {#awin-mastertag-extension}

## 概述 {#overview}

MasterTag是一个JavaScript库，其中包含Awin跟踪解决方案所需的所有功能，应无条件地附加到站点上的每个页面（包括确认页面），但不包括显示或处理付款信息的任何页面。

Awin Advertiser Mastertag是Adobe实时客户数据平台中的一个广告扩展。 有关扩展功能的详细信息，请参阅 [Adobe Exchange上的扩展页](https://exchange.adobe.com/experiencecloud.details.103176.awin-advertiser-mastertag.html)。
...
![UI中的Awin Advertiser Mastertag扩展](/help/rtcdp/destinations/assets/awin-mastertag-extension.png)
...
有关扩展配置选项和安装支持的信息，请参阅Adobe Exchange [上的Awin广告商主页](https://exchange.adobe.com/experiencecloud.details.103176.awin-advertiser-mastertag.html)。
