...
description: Google Global Site Tag扩展是Adobe Real-time Customer Data Platform中的一个分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
seo-description: Google Global Site Tag扩展是Adobe Real-time Customer Data Platform中的一个分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
...
通过Google的Global Site Tag（或gtag.js）将数据发送到Google Analytics、Google Ads和Google Marketing Platform。 可以配置每个产品的多个帐户。

Google Global Site Tag是Adobe Real-time Customer Data Platform中的分析扩展。 有关扩展功能的详细信息，请参阅 [Adobe Exchange上的扩展页](https://exchange.adobe.com/experiencecloud.details.101437.google-global-site-tag-gtag.html)。
