...
description: Google Global Site Tag扩展是Adobe Real-time Customer Data Platform中的一个分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
seo-description: Google Global Site Tag扩展是Adobe Real-time Customer Data Platform中的一个分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
...
# [!DNL Google Global Site Tag] 扩展 {#gtag-analytics-extension}

## 概述 {#overview}

将数据发 [!DNL Google Analytics]送到 [!DNL Google Ads]、通过或 [!DNL Google Marketing Platform] gtag.js发送 [!DNL Google's Global Site Tag]到和通过。 可以为每个产品配置多个帐户。

[!DNL Google Global Site Tag] 是Adobe实时客户数据平台中的分析扩展。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩 [展页](https://exchange.adobe.com/experiencecloud.details.101437.google-global-site-tag-gtag.html)。
...
安装扩 [!DNL Google Global Site Tag] 展：
...
有关扩展配置选项的信息，请参阅扩展的 [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101437.google-global-site-tag-gtag.html) 页。
