...
description: Demandbase扩展是Adobe实时客户数据平台中的一个分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
seo-description: Demandbase扩展是Adobe实时客户数据平台中的一个分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
...
# Demandbase扩展 {#demandbase-extension}

## 概述 {#overview}

直接将Demandbase B2B帐户洞察引入Adobe Analytics中，您可以在其中按行业、收入和目标帐户细分流量和行为。 此基于帐户的视图可为您最有价值的访客提供关于参与度、转化率和来源的独特洞察。

Demandbase是Adobe实时客户数据平台中的分析扩展。 有关扩展功能的详细信息，请参阅 [Adobe Exchange上的扩展页](https://exchange.adobe.com/experiencecloud.details.101605.html)。
...
![Demandbase扩展](assets/demandbase-extension.png)
...
有关扩展配置选项的信息，请参阅 [Adobe Exchange上的](https://exchange.adobe.com/experiencecloud.details.101605.html) Demandbase扩展页。
