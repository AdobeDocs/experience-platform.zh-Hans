...
Adobe Analytics是Adobe实时客户数据平台的分析扩展。 有关扩展功能的详细信息，请参阅Adobe交换上的扩 [展页](https://exchange.adobe.com/experiencecloud.details.100156.html)。
...
有关扩展配置选项的信息，请参阅文 [档中的Adobe Analytics扩](https://docs.adobe.com/content/help/en/core-services-learn/implementing-in-websites-with-launch/implement-solutions/analytics.html) 展 [!DNL Experience Launch] 页面。
