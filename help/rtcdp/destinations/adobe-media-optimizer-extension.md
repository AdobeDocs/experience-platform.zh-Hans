...
有关扩展配置选项的信息，请参 [阅文档中的AdobeAnalytics](https://docs.adobe.com/content/help/en/core-services-learn/implementing-in-websites-with-launch/implement-solutions/analytics.html) 扩展 [!DNL Experience Launch] 页。
