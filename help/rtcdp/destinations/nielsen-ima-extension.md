...
description: The Nielsen IMA Handler扩展是Adobe实时客户数据平台中的一个分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
seo-description: Nielsen IMA Handler扩展是Adobe实时客户数据平台中的一个分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
...
[!DNL Nielsen IMA Handler] 是Adobe实时客户数据平台中的分析扩展。
...
![Nielsen IMA处理程序扩展](assets/nielsen-ima-extension.png)
