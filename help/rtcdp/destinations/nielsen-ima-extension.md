...
description: The Nielsen IMA Handler扩展是Adobe实时客户数据平台中的一个分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
seo-description: Nielsen IMA Handler扩展是Adobe实时客户数据平台中的一个分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
...
# Nielsen IMA处理程序扩展 {#nielsen-ima-extension}

## 概述 {#overview}

Nielsen IMA Handler是Adobe实时客户数据平台中的分析扩展。
