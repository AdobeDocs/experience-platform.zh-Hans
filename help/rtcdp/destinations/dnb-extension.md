...
title: D&B访客智能扩展
seo-title: D&B访客智能扩展
description: D&B访客智能扩展是Adobe实时客户数据平台中的个性化目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
seo-description: D&B访客智能扩展是Adobe实时客户数据平台中的个性化目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
...
[!DNL D&B Visitor Intelligence] 是Adobe实时客户数据平台中的个性化扩展。 有关扩展功能的详细信息，请参 [阅D&amp;B网站](https://www.dnb.com/)。
