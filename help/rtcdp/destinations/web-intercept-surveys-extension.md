...
description: QuestionPro Intercept调查扩展是Adobe实时客户数据平台中的调查目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
seo-description: QuestionPro Intercept调查扩展是Adobe实时客户数据平台中的调查目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
...
# QuestionPro截取调查扩展 {#questionpro-extension}

## 概述 {#overview}

QuestionPro Intercept调查是一个平台，用于在交易点或用户进入／退出您的网站时部署调查和收集态度数据。

QuestionPro Intercept调查是Adobe实时客户数据平台中的调查扩展。 有关扩展功能的详细信息，请参阅 [Adobe Exchange上的扩展页](https://exchange.adobe.com/experiencecloud.details.90096.questionpro-surveys.html)。
...
![QuestionPro截取调查扩展](assets/web-intercept-surveys-extension.png)
...
有关扩展配置选项和安装支持的信息，请参阅Adobe Exchange上 [的“QuestionPro截取调查”页](https://exchange.adobe.com/experiencecloud.details.90096.questionpro-surveys.html)。
