...
# Contentsquare扩展 {#contentsquare-extension}

## 概述 {#overview}

可视化页面内行为，了解客户放弃的原因以及您如何改进。 将收入归因于每个Analytics细分和目标测试的UX和内容元素。 安装Contentsquare标签，设置自定义变量和事件。 开始只需单击几下即可收集UX分析的数据。
...
有关扩展配置选项的信息，请参阅Adobe Exchange [上的Contentsquare扩展](https://exchange.adobe.com/experiencecloud.details.100364.html) 页面。
