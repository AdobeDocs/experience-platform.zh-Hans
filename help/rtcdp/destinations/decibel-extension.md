...
title: 分贝扩展
seo-title: 分贝扩展
description: Decibel扩展是Adobe实时客户数据平台中的一个分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
seo-description: Decibel扩展是Adobe实时客户数据平台中的一个分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
...
[!DNL Decibel] 是Adobe实时客户数据平台中的分析扩展。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩 [展页](https://exchange.adobe.com/experiencecloud.details.100913.html)。
...
有关扩展配置选项的信息，请参 [阅Adobe Exchange上的](https://exchange.adobe.com/experiencecloud.details.100913.html) Decibel扩展页。
