---
title: 受众管理器DIL扩展
seo-title: 受众管理器DIL扩展
description: 受众管理器DIL扩展是Adobe实时客户数据平台中的数据管理平台(DMP)目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
seo-description: 受众管理器DIL扩展是Adobe实时客户数据平台中的数据管理平台(DMP)目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
...
# 受众管理器DIL扩展 {#aam-dil-extension}

## 概述 {#overview}

这是Adobe受众管理器数据集成库扩展（客户端实施）。 注意：此扩展不用于Adobe Analytics数据的服务器端转发(SSF)。 对于SSF，请使用Adobe Analytics扩展。 重要说明：从版本8.0开始，DIL对Experience Cloud ID服务版本3.3或更高版本有很强的依赖性。 请实施Experience Cloud ID服务和DIL以获得完整的受众管理器数据集成功能。

受众管理器DIL是Adobe实时客户数据平台中的数据管理平台(DMP)扩展。 有关扩展功能的详细信息，请参阅Experience Platform Launch文档中 [的受众管理器扩展页](https://docs.adobe.com/content/help/en/launch/using/extensions-ref/adobe-extension/adobe-audience-manager-extension.html) 。
...
![受众管理器DIL扩展](/help/rtcdp/destinations/assets/aam-dil-extension.png)
...
有关扩展配置选项的信息，请参阅Experience Launch文档 [中的受众管理器扩展页](https://docs.adobe.com/content/help/en/launch/using/extensions-ref/adobe-extension/adobe-audience-manager-extension.html) 。
