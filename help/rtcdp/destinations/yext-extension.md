...
description: The Yext Conversion Tracking扩展是Adobe实时客户数据平台中的一个分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
seo-description: Yext Conversion Tracking扩展是Adobe Real-time Customer Data Platform中的一个分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
...
扩展 [!DNL Yext Conversion Tracking] 允许您衡量可归因于您使用Yext产品的转化率。

[!DNL Yext Conversion Tracking] 是Adobe实时客户数据平台中的分析扩展。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩 [展页](https://exchange.adobe.com/experiencecloud.details.103174.yext-conversion-tracking.html)。
...
![Yext转换跟踪扩展](assets/yext-extension.png)
...
安装扩 [!DNL Yext Conversion Tracking] 展：
...
有关扩展配置选项和安装支持的信息，请参 [阅Adobe Exchange的“Yext Conversion Tracking”（转换跟踪）页](https://exchange.adobe.com/experiencecloud.details.103174.yext-conversion-tracking.html)。
