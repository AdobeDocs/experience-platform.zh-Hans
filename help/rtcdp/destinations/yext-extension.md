---
title: Yext Conversion Tracking扩展
seo-title: Yext Conversion Tracking扩展
description: The Yext Conversion Tracking扩展是Adobe实时客户数据平台中的一个分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
seo-description: Yext Conversion Tracking扩展是Adobe实时客户数据平台中的一个分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
...
Yext Conversion Tracking Extension允许您测量可归因于您使用Yext产品的转化。

Yext Conversion Tracking是Adobe实时客户数据平台中的分析扩展。 有关扩展功能的详细信息，请参阅 [Adobe Exchange上的扩展页](https://exchange.adobe.com/experiencecloud.details.103174.yext-conversion-tracking.html)。
...
要安装Yext Conversion Tracking扩展，请执行以下操作：
...
有关扩展配置选项和安装支持的信息，请参阅Adobe Exchange上的“ [Yext转换跟踪”页](https://exchange.adobe.com/experiencecloud.details.103174.yext-conversion-tracking.html)。
