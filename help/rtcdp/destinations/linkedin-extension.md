...
description: LinkedIn Insight Tag扩展是Adobe实时客户数据平台中的一个广告目的地。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
seo-description: LinkedIn Insight Tag扩展是Adobe实时客户数据平台中的一个广告目的地。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
...
# LinkedIn Insight标记扩展 {#linkedin-insights-extension}

## 概述 {#overview}

安装LinkedIn Insight标记以使用转化跟踪、重定向和网站人口统计功能。

LinkedIn Insight Tag是Adobe实时客户数据平台中的一个广告扩展。 有关扩展功能的详细信息，请参 [阅LinkedIn Insight标记](https://business.linkedin.com/marketing-solutions/insight-tag)。
...
要安装LinkedIn Insight Tag扩展，请执行以下操作：
...
有关扩展配置选项和安装支持的信息，请参 [阅LinkedIn Insight Tag](https://business.linkedin.com/marketing-solutions/insight-tag)。
