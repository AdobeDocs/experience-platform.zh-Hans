...
description: The Qualtrics网站反馈扩展是Adobe实时客户数据平台中的调查目的地。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
seo-description: Qualtrics网站反馈扩展是Adobe实时客户数据平台中的调查目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
...
# Qualtrics网站反馈扩展 {#qualtrics-extension}

## 概述 {#overview}

Qualtrics网站反馈使您能够在正确的时间通过正确的消息吸引网站访客。 无论您是希望通过网站反馈调查改善访客体验还是提高转化率，Qualtrics网站反馈都能满足您的需求。

使用直观的指向并单击界面，在几分钟内创建和部署目标明确、有品牌的Web消息。 您从网站收集的数据和洞察会与所有渠道的客户反馈数据一起呈现，提供完整的客户体验视图-所有这一切均在一个平台上实现。

Qualtrics网站反馈是Adobe实时客户数据平台中的调查扩展。 有关扩展功能的详细信息，请参阅 [Adobe Exchange上的扩展页](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html)。
...
有关扩展配置选项和安装支持的信息，请参阅Adobe Exchange上 [的Qualtrics网站反馈页](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html)。
