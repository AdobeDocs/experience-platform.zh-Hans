...
确认数字反馈解决方案可帮助您将网站流量转化为实时洞察。 通过确认，可以根据您的要求显示不显眼且目标明确的调查，鼓励访客提供反馈，例如：
...
有关扩展配置选项和安装支持的信息，请参阅Adobe Exchange上 [的“确认数字反馈”页](https://exchange.adobe.com/experiencecloud.details.103247.confirmit-digital-feedback-for-adobe-launch.html)。
