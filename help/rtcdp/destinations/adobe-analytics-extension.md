...
有关扩展配置选项的信息，请参阅体验 [文档中的Adobe Analytics](https://docs.adobe.com/content/help/en/core-services-learn/implementing-in-websites-with-launch/implement-solutions/analytics.html) 扩展 [!DNL Launch] 页面。
