...
description: The PebblePost扩展是Adobe实时客户数据平台中的电子邮件目的地。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
seo-description: PebblePost扩展是Adobe实时客户数据平台中的一个电子邮件目的地。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
...
PebblePost的程序化直邮®解决方案帮助数字营销人员将在线兴趣和意图与可转换的线下有形媒体联系起来。 营销人员可以利用他们在Adobe中创建的自定义数据细分，现在为消费者提供相关、更持久的家庭媒体印象。 根据响应路径活动和现场转换实时分析性能。

PebblePost是Adobe实时客户数据平台中的电子邮件扩展。 有关扩展功能的详细信息，请参阅 [Adobe Exchange上的扩展页](https://exchange.adobe.com/experiencecloud.details.100315.programmatic-direct-mail.html)。
