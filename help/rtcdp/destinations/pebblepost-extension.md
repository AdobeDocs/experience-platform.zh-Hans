...
description: PebblePost扩展是Adobe实时客户数据平台中的电子邮件目的地。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
seo-description: PebblePost扩展是Adobe实时客户数据平台中的电子邮件目的地。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
...
[!DNL PebblePost's Programmatic Direct Mail®] 该解决方案可帮助数字营销人员将在线兴趣和意图与可转换的线下、有形媒体关联起来。 营销人员可以利用他们在Adobe创建的自定义数据细分，现在为消费者提供相关、更持久的家庭媒体目标。 根据响应路径活动和现场转换实时分析性能。

[!DNL PebblePost] 是Adobe实时客户数据平台中的电子邮件扩展。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩 [展页](https://exchange.adobe.com/experiencecloud.details.100315.programmatic-direct-mail.html)。
...
![PebblePost扩展](assets/pebblepost-extension.png)
...
有关扩展配置选项和安装支持的信息，请参 [阅Adobe Exchange上的PebblePost页](https://exchange.adobe.com/experiencecloud.details.100315.programmatic-direct-mail.html)。
