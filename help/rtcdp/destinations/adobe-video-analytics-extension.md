...
description: Adobe Media Analytics for Audio和Video扩展是Adobe实时客户数据平台中的一个分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
seo-description: Adobe Media Analytics for Video扩展是Adobe实时客户数据平台中的一个分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
...
Adobe Media Analytics for Audio和Video是基础Analytics产品的附加组件，可为客户提供对视频、音频和广告的可靠衡量。

Adobe Media Analytics for Audio和Video是Adobe实时客户数据平台中的一个分析扩展。 有关扩展功能的详细信息，请参阅 [Adobe Exchange上的扩展页](https://exchange.adobe.com/experiencecloud.details.100157.html)。
...
有关扩展配置选项的信息，请参阅 [Experience Launch文档中的“用于音频和视频的Adobe Media Analytics](https://docs.adobe.com/content/help/zh-Hans/launch/using/extensions-ref/adobe-extension/media-analytics-extension/overview.translate.html) ”扩展页面。
