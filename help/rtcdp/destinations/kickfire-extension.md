...
description: KickFire扩展是实时客户数据平台中的个性化目标。 有关扩展功能的详细信息，请参阅AdobeExchange上的扩展页。
seo-description: KickFire扩展是实时客户数据平台中的个性化目标。 有关扩展功能的详细信息，请参阅AdobeExchange上的扩展页。
...
[!DNL KickFire] 是实时客户数据平台中的个性化扩展。 有关扩展功能的更多信息，请参 [阅Kickfire网站](https://www.kickfire.com/)。
