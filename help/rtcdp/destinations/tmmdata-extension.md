...
title: TMMData扩展
seo-title: TMMData扩展
description: TMMData扩展是Adobe实时客户数据平台中的一个分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
seo-description: TMMData扩展是Adobe实时客户数据平台中的一个分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
...
# TMMData扩展 {#tmmdata-extension}

## 概述 {#overview}

TMMData的Foundation platform for Adobe Marketing Cloud为营销团队提供了各种工具，可访问和混合其所有关键数据源（包括内部／外部和在线／离线数据），以实现自信、全面的跨渠道分析，并自动设置活动并直接导入Adobe和其他分析和BI工具。

TMMData是Adobe实时客户数据平台中的分析扩展。 有关扩展功能的详细信息，请参阅 [Adobe Exchange上的扩展页](hhttps://exchange.adobe.com/experiencecloud.details.100148.tmmdata-foundation-platform.html)。
...
![TMMData扩展](assets/tmmdata-extension.png)
...
有关扩展配置选项和安装支持的信息，请参 [阅Adobe Exchange上的TMMData页](https://exchange.adobe.com/experiencecloud.details.100148.tmmdata-foundation-platform.html)。
