...
description: Clicktale扩展是Adobe实时客户数据平台中的一个分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
seo-description: Clicktale扩展是Adobe实时客户数据平台中的一个分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
...
[!DNL Clicktale] 是Adobe实时客户数据平台中的分析扩展。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩 [展页](https://exchange.adobe.com/experiencecloud.details.100082.html)。
...
有关扩展配置选项的信息，请参 [阅Adobe Exchange中的](https://exchange.adobe.com/experiencecloud.details.100082.html) Clicktale扩展页。
