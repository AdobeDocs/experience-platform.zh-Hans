...
description: Foresee扩展是Adobe实时客户数据平台中的调查目的地。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页。
...
[!DNL Foresee] 是Adobe实时客户数据平台中的调查扩展。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩 [展页](https://exchange.adobe.com/experiencecloud.details.100164.html)。
...
有关扩展配置选项的信息，请参 [阅Adobe Exchange上的](https://exchange.adobe.com/experiencecloud.details.100164.html) Foresee扩展页。
