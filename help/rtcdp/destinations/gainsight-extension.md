...
description: Gainsight扩展是Adobe实时客户数据平台中的一个个性化目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
seo-description: Gainsight扩展是Adobe实时客户数据平台中的一个个性化目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
...
# Gainsight扩展 {#gainsight-extension}

## 概述 {#overview}

Gainsight使产品所有者能够借助这些工具深入理解用户行为、推动产品采用和收集用户反馈。

Gainsight是Adobe实时客户数据平台中的一个个性化扩展。 有关扩展功能的详细信息，请参阅 [Adobe Exchange上的扩展页](https://www.adobeexchange.com/experiencecloud.details.103343.html)。
...
![Gainsight扩展](assets/gainsight-extension.png)
...
有关扩展配置选项和安装支持的信息，请参阅Adobe [Exchange上的Gainsight页面](https://www.adobeexchange.com/experiencecloud.details.103343.html)。
