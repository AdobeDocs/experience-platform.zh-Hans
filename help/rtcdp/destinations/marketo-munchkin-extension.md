...
description: Marketo Munchkin扩展是Adobe实时客户数据平台中的一个个性化目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
seo-description: Marketo Munchkin扩展是Adobe实时客户数据平台中的一个个性化目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
...
# Marketo Munchkin 扩展 {#marketo-munchkin-extension}

## 概述 {#overview}

从销售线索管理到基于帐户的营销，Marketo Engagement Platform可简化您在客户和潜在客户体验的每个阶段规划、编排和衡量客户与客户的互动的方式。

Marketo的Munchkin JavaScript允许跟踪最终用户页面访问和对营销人员登陆页和外部网页的点击。

Marketo Munchkin是Adobe实时客户数据平台中的电子邮件扩展。 有关扩展功能的详细信息，请参阅 [Adobe Exchange上的扩展页](https://exchange.adobe.com/experiencecloud.details.101054.marketo-munchkin.html)。
...
![Marketo Munchkin 扩展](assets/marketo-munchkin-extension.png)
...
有关扩展配置选项和安装支持的信息，请参 [阅Adobe Exchange上的Marketo Munchkin页](https://exchange.adobe.com/experiencecloud.details.101054.marketo-munchkin.html)。
