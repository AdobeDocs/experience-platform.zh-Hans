...
description: Marketo Web Personalization扩展是Adobe实时客户数据平台中的一个个性化目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
seo-description: Marketo Web Personalization扩展是Adobe实时客户数据平台中的一个个性化目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
...
此扩展部署了Marketo的Web个性化和ContentAI应用程序的脚本。 Marketo Web Personalization可以根据Web访客特征唯一地识别和个性化内容，如匿名访客的Firmographics和已知访客的Marketo Engagement Platform中的各种行为属性。 Marketo ContentAI包含针对B2B客户特有的Web和电子邮件活动的基于AI的推荐和个性化功能。

Marketo Web Personalization是Adobe实时客户数据平台中的一个个性化扩展。 有关扩展功能的详细信息，请参阅 [Adobe Exchange上的扩展页](https://exchange.adobe.com/experiencecloud.details.101232.marketo-web-personalization.html)。
...
要安装Marketo Web Personalization扩展，请执行以下操作：
...
有关扩展配置选项和安装支持的信息，请参阅Adobe Exchange [上的“营销人员网络个性化”页](https://exchange.adobe.com/experiencecloud.details.101232.marketo-web-personalization.html)。
