...
description: Invoca标记扩展是Adobe实时客户数据平台中客户目标的声音。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
...
# Invoca标记扩展 {#invoca-extension}

## 概述 {#overview}

Invoca为数字客户旅程提供呼叫数据和语音洞察。 借助Invoca的呼叫智能平台，营销人员终于可以通过分析来衡量呼叫结果并将线下转化率与数字支出挂钩。

Invoca标记是Adobe实时客户数据平台中客户扩展的声音。 有关扩展功能的详细信息，请参阅 [Adobe Exchange上的扩展页](https://exchange.adobe.com/experiencecloud.details.100067.invoca.html)。
...
有关扩展配置选项和安装支持的信息，请参阅Adobe Exchange [上的“Invoca标记”页](https://exchange.adobe.com/experiencecloud.details.100067.invoca.html)。
