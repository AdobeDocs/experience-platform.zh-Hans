...
seo-title: Nielsen BSDK扩展
description: The Nielsen BSDK扩展是Adobe实时客户数据平台中的一个分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
seo-description: Nielsen BSDK扩展是Adobe实时客户数据平台中的一个分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
...
# Nielsen BSDK扩展 {#nielsen-bsdk-extension}
...
Nielsen BSDK是Adobe实时客户数据平台中的分析扩展。 有关扩展功能的详细信息，请参阅 [Adobe Exchange上的扩展页](https://exchange.adobe.com/experiencecloud.details.101361.html)。
...
![Nielsen BSDK扩展](assets/nielsen-bsdk-extension.png)
...
有关扩展配置选项和安装支持的信息，请参阅Adobe Exchange上的 [Nielsen BSDK页面](https://exchange.adobe.com/experiencecloud.details.101361.html)。
