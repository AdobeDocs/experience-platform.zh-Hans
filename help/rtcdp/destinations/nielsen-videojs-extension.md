...
description: Nielsen VideoJS播放器处理程序扩展是Adobe实时客户数据平台中的一个分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
seo-description: Nielsen VideoJS播放器处理程序扩展是Adobe实时客户数据平台中的一个分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
...
# Nielsen VideoJS播放器处理程序扩展 {#nielsen-vjs-extension}

## 概述 {#overview}

Nielsen Digital SDK通过以下数字测量产品发布扩展优惠受众测量：

DCR:提供对非线性数字内容（包括带有广告的内容）进行日常测量的测量解决方案可以全面视图桌面、移动设备、平板电脑和连接设备上的数字内容受众消费。

DTVR:这说明参加节目源在桌面和移动设备上发生的线性电视观看。 这是MRC为在计算机和移动设备上观看的节目而对电视受众测量做出贡献的第一个获得认证的解决方案。

Nielsen VideoJS播放器处理程序是Adobe实时客户数据平台中的分析扩展。 有关扩展功能的详细信息，请参阅 [Adobe Exchange上的扩展页](https://exchange.adobe.com/experiencecloud.details.101361.nielsen-digital-sdk-extension.html)。
...
![Nielsen VideoJS播放器处理程序扩展](assets/nielsen-videojs-extension.png)
...
有关扩展配置选项和安装支持的信息，请参阅Adobe Exchange上的 [Nielsen Digital SDK页面](https://exchange.adobe.com/experiencecloud.details.101361.nielsen-digital-sdk-extension.html)。
