...
title: 量子度量扩展
seo-title: 量子度量扩展
description: The Quantum Metric扩展是Adobe实时客户数据平台中的一个分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
seo-description: Quantum Metric扩展是Adobe实时客户数据平台中的一个分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
...
# 量子度量扩展 {#quantum-metric-extension}

## 概述 {#overview}

Quantum Metric与Adobe Launch的集成简化了Quantum Metric数据收集标签的无代码部署。 此外，此扩展还优惠了从量子度量API捕获包含有用信息的启动数据元素的能力。

Quantum Metric是Adobe实时客户数据平台中的分析扩展。 有关扩展功能的详细信息，请参阅 [Adobe Exchange上的扩展页](https://exchange.adobe.com/experiencecloud.details.101535.quantum-metric-extension-for-adobe-launch.html)。
...
![量子度量扩展](assets/quantum-metric-extension.png)
...
有关扩展配置选项和安装支持的信息，请参 [阅Adobe Exchange上的“量子度量”页](https://exchange.adobe.com/experiencecloud.details.101535.quantum-metric-extension-for-adobe-launch.html)。
