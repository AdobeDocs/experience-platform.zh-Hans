...
description: DialogTech扩展是Adobe实时客户数据平台中的分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
seo-description: DialogTech扩展是Adobe实时客户数据平台中的分析目标。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
...
# DialogTech扩展 {#dialogtech-extension}

## 概述 {#overview}

在Adobe Launch中包含DialogTech SourceTrak javascript代码片断

DialogTech是Adobe实时客户数据平台中的分析扩展。 有关扩展功能的详细信息，请参阅 [Dialogtech网站](https://www.dialogtech.com/)。
