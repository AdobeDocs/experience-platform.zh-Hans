...
description: Flashtalking OneTag扩展是Adobe实时客户数据平台中的一个广告目的地。 有关扩展功能的详细信息，请参阅Adobe Exchange上的扩展页面。
...
# Flashtalking OneTag扩展 {#flashtalking-extension}

## 概述 {#overview}

Experience Platform Launch的Flashtalking OneTag扩展使得可以轻松地将站点操作归因于显示、视频和移动广告活动。 使用Launch将Flashtalking OneTag部署到Web属性。

Flashtalking OneTag是Adobe实时客户数据平台中的广告扩展。 有关扩展功能的详细信息，请参阅 [Adobe Exchange上的扩展页](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html)。
