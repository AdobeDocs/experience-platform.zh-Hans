...
* 目标 {#destinations}
   ...
   * 目标目录 {#destinations-cat}
      ...
      * 云存储目标{#cloud-storage}
         ...
         * [创建云存储目标的工作流程](/help/rtcdp/destinations/cloud-storage-destinations-workflow.md)
   ...
   * 目标教程 {#dest-tutorials}
      ...
      * [将配置文件和区段激活到目标](destinations/activate-destinations.md)
* 隐私和数据管理 {#privacy}
   * [隐私概述](privacy/privacy-overview.md)
   * [数据管理概述](privacy/data-governance-overview.md)
* 实时客户档案 {#profile}
   * [个人资料概述](profile/profile-overview.md)
