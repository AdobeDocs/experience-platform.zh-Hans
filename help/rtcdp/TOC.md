...
* [Real-Time CDP B2B版本概述](b2b-overview.md)
* 快速入门{#intro}
   * Real-Time CDP {#rtcdp-intro}
      * [Real-Time CDP入门](get-started.md)
      * [主页](home-page-dashboards.md)
   * Real-Time CDP B2B 版 {#rtcdpb2b-intro}
      * [示例用例](./b2b-use-case.md)
      * [端到端教程](./b2b-tutorial.md)
      * [Real-Time CDP B2B版本护栏](b2b-guardrails.md)
* Audience Manager和实时CDP {#evolution}
   * [从Audience Manager演变](aam-to-rtcdp.md)
* 帐户配置文件 {#account}
...
* 数据集 {#datasets}
   ...
   * [Platform中的数据质量](datasets/data-quality.md)
* 目标 {#destinations}
   * [目标概述](destinations/overview.md)
   * [Real-Time CDP B2B版本中的目标](destinations/b2b.md)
* 标识 {#identity}
...
* Real-Time CDP B2B版AI/ML服务 {#b2b-cdp-ai-ml}
   * [相关帐户](b2b-ai-ml-services/related-accounts.md)
   * [商机帐户匹配](b2b-ai-ml-services/lead-to-account-matching.md)
