...
[!UICONTROL Getting started with Real-Time Customer Profile]构件分为四个部分：

* **将数据摄取到Experience Platform**：此构件会将您定向到源目录。 使用源目录选择源并将您的数据摄取到Experience Platform。 选择&#x200B;**[配置源]**&#x200B;以导航到源目录。 有关更多信息，请阅读[来源概述](../sources/home.md)。
* **模型数据结构**：此构件引导您查看架构概述。 使用架构概述浏览现有架构或创建描述数据结构的Blueprint。 选择&#x200B;**[!UICONTROL Create schema]**&#x200B;以导航到架构创建界面。 有关详细信息，请阅读[架构概述](../xdm/home.md)。
* **构建受众**：此构件会将您定向到UI中的区段生成器。 使用区段生成器可与配置文件数据元素交互并定义区段定义的标准。 选择&#x200B;**[!UICONTROL Create audience]**&#x200B;以导航到区段生成器。 有关详细信息，请阅读[分段服务概述](../segmentation/home.md)。
* **将数据发送到目标**：此构件会将您定向到目标目录。 使用目标目录选择一个目标，然后您可以连接到该目标并将受众发送到该目标。 选择&#x200B;**[!UICONTROL Set up destinations]**&#x200B;以导航到目标目录。 有关更多信息，请阅读[目标概述](../destinations/home.md)。
...
* **配置文件总数**： **配置文件**&#x200B;计数显示贵组织在Experience Platform中的配置文件总数。 它不包括配置文件片段。 这是您的总可寻址受众。 此计数使用在实时客户个人资料的合并策略配置中设置的默认[合并策略](profile/merge-policies.md)。 每24小时更新一次配置文件数。 选择&#x200B;**[!UICONTROL Profiles]**&#x200B;以导航到“配置文件概述”页面并查看所有配置文件量度。 有关个人资料的更多信息，请阅读[实时客户个人资料概述](../profile/home.md)。
...
* **最近的数据集**： **[!UICONTROL Recent datasets]**&#x200B;信息卡显示了在组织内创建的五个最近的数据集。 此列表会在创建新数据集时更新。 选择一个数据集以查看该项的详细信息，或为数据集列表选择&#x200B;**[!UICONTROL View all]**。 从该位置，您可以选择特定源以了解详细信息。 有关数据集的更多信息，请参阅[数据集概述](../catalog/datasets/overview.md)。
* **最近的源**： **[!UICONTROL Recent sources]**&#x200B;量度卡片显示了组织内创建的五个最近的源。 此列表会在创建新源时更新。 选择源以查看该项的详细信息，或选择&#x200B;**[!UICONTROL View all]**&#x200B;查看源列表。 从该位置，您可以选择特定源以了解详细信息。 有关源的更多信息，请参阅[源概述](../sources/home.md)。
* **最新受众**： **[!UICONTROL Recent audiences]**&#x200B;量度卡片显示了组织内创建的五个最新受众。 此列表会在创建新受众时更新。 选择一个受众以查看该项目的详细信息，或选择&#x200B;**[!UICONTROL View all]**&#x200B;以查看受众列表。 有关受众的详细信息，请参阅[分段服务概述](../segmentation/home.md)。
* **最近的目标**： **[!UICONTROL Recent destinations]**&#x200B;量度卡片显示了组织中创建的五个最近的目标。 此列表会在创建新目标时更新。 选择一个目标以查看该项目的详细信息，或选择&#x200B;**[!UICONTROL View all]**&#x200B;查看目标列表。 有关更多信息，请阅读[目标概述](../destinations/home.md)。
