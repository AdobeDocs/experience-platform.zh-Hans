...
Real-Time CDP B2B客户现在可以激活 [帐户受众](/help/segmentation/ui/account-audiences.md) 到特定目标。

[![图像](assets/do-not-localize/learn-more-button.svg)](/help/destinations/ui/activate-account-audiences.md)
