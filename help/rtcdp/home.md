...
description: 开始使用Adobe Real-Time CDP，了解它提供的丰富功能以及它如何帮助您的业务。 使用此页面作为了解产品的起点。
...
<table style="table-layout:fixed">
  <tr style="border: 0;">
    ...
    <div><strong>哪个Real-Time CDP版本适合我的公司</strong><br/>了解Real-Time CDP不同版本之间的差异，并确定哪个版本最适合您的公司。</div>
    </td>
    <td>
    <a href="/help/landing/ui-guide.md"><img src="assets/do-not-localize/start-interface.jpeg"></a>
    <div><strong>用户界面</strong><br/>了解Real-Time CDP UI主页的元素，以及如何导航和优化产品内体验。</div>
    </td>
    <td>
    <a href="/help/landing/end-to-end-tutorial.md"><img src="assets/do-not-localize/start-journey.jpeg"></a>
    <div><strong>探索端对端工作流程</strong><br/>了解从摄取、通过丰富用户档案和创建受众到激活的数据流。
    </div>
    </td>
    <td>
    <a href="/help/rtcdp/use-case-guides/overview.md"><img src="assets/do-not-localize/start-use-cases.jpeg"></a>
    <div><strong>示例Real-Time CDP用例</strong><br/>了解Real-Time CDP如何通过多种方式帮助您的公司获取新客户、丰富您的已知配置文件等。
    </div>
    </td>
  </tr>
  <tr style="border: 0;">
...
![幻灯片节选显示Adobe Real-Time CDP的四大支柱。](/help/rtcdp/assets/rtcdp-four-pillars.png)
...
<table style="table-layout:auto">
  <tr style="border: 0;">
    <td>
      ...
      <strong>数据摄取和管理</strong><br/>探索将数据导入Real-Time CDP的多种方式。 <br/><a href="/help/ingestion/batch-ingestion/overview.md">批次摄取</a> - <a href="/help/ingestion/streaming-ingestion/overview.md">流式摄取</a> - <a href="/help/sources/home.md">源</a> - <a href="/help/xdm/schema/composition.md">架构</a> - <a href="/help/catalog/datasets/overview.md">数据集</a> - <a href="/help/query-service/home.md">查询</a>
    </td>
    <td>
      <img src="assets/do-not-localize/icon_profile-audience.svg" width="35px"><br/>
      <strong>用户档案和受众</strong><br/>管理各种类型的用户档案，并根据共同的兴趣、行为或特征将其分组为受众。 <br/><a href="/help/segmentation/home.md">受众</a> - <a href="/help/profile/home.md">配置文件</a> - <a href="/help/identity-service/home.md">标识</a> - <a href="/help/dashboards/guides/license-usage.md">许可证使用情况</a> - <a href="/help/privacy-service/home.md">隐私管理</a>
    </td>
    <td>
      <img src="assets/do-not-localize/icon-lock.svg" width="35px"><br/>
      <strong>数据治理和信任</strong><br/>了解如何确保遵守适用于数据使用的各种法规、限制和策略。 <br/><a href="/help/data-governance/home.md">数据管理</a> - <a href="/help/data-governance/labels/overview.md">数据使用标签</a> - <a href="/help/data-governance/policies/overview.md">数据使用策略</a>
    </td>
    <td>
      <img src="assets/do-not-localize/icon-content.svg" width="35px"><br/>
      <strong>数据激活</strong><br/>跨渠道向您的客户进行营销，并将数据从Real-Time CDP导出到任何所需的存储位置。 <br/><a href="/help/destinations/catalog/overview.md">目标目录</a> - <a href="/help/destinations/destination-types.md">目标类型</a> - <a href="/help/destinations/ui/activation-overview.md">激活受众</a> - <a href="/help/destinations/ui/export-datasets.md">导出数据集</a>
    </td>
  </tr>
  <tr style="border: 0;">
    <td>
...
<tr>
  <td>
    <a href="https://experienceleague.adobe.com/docs/platform-learn/tutorials/intro-to-platform/native-applications.html?lang=zh-Hans">
  ...
  <td>
    <a href="https://experienceleague.adobe.com/docs/platform-learn/tutorials/intro-to-platform/interface-tour.html?lang=zh-Hans">
