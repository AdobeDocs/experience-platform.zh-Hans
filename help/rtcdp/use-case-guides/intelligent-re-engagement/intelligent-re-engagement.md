...
这个放弃的购物车历程面向已放入购物车但未同时在网站和应用程序上购买的产品。 用于启动和停止付费媒体营销活动
...
体验数据模型(XDM)资源在中管理 [!UICONTROL 架构] Adobe Experience Platform中的工作区。 您可以查看和浏览由 Adobe 提供的核心资源，并为贵组织创建自定义资源和架构。

要创建架构，请完成以下步骤：

1. 导航到 **[!UICONTROL 数据管理]** > **[!UICONTROL 架构]** 并选择 **[!UICONTROL 创建架构]**.
2. 选择 **[!UICONTROL XDM个人资料]/[!UICONTROL XDM ExperienceEvent]**.
3. 导航到 **[!UICONTROL 字段组]** 并选择 **[!UICONTROL 添加]**.
4. 使用搜索框查找并选择字段组，然后选择 **[!UICONTROL 添加字段组]**.
5. 为架构命名并指定描述（可选）。
6. 选择&#x200B;**[!UICONTROL 保存]**。

![创建模式的步骤的记录。](../intelligent-re-engagement/images/create-a-schema.gif)
...
客户属性架构是 [!UICONTROL XDM个人资料] 架构，包含以下字段组：
...
![突出显示字段组列表的客户属性架构。](../intelligent-re-engagement/images/customer-attributes.png)

#### 客户数字交易模式的字段组要求

客户数字交易模式是 [!UICONTROL XDM ExperienceEvent] 架构，包含以下字段组：
...
![突出显示字段组列表的客户数字交易模式。](../intelligent-re-engagement/images/customer-digital-transactions.png)

#### 客户离线交易架构的字段组要求

客户离线交易架构是 [!UICONTROL XDM ExperienceEvent] 架构，包含以下字段组：
...
![突出显示字段组列表的客户离线交易架构。](../intelligent-re-engagement/images/customer-offline-transactions.png)
...
1. 导航到 **[!UICONTROL 客户]** > **[!UICONTROL 受众]** 并选择 **[!UICONTROL 创建受众]**.
2. 选择 **[!UICONTROL 生成规则]** 并选择 **[!UICONTROL 创建]**.
3. 导航到 **[!UICONTROL 字段]** 并选择 **[!UICONTROL 活动]** 选项卡。
4. 导航或使用搜索框查找事件类型，然后将其拖动到生成器。 最后，通过拖动事件类型来添加事件规则。
5. 为架构命名并指定描述（可选）。
6. 选择&#x200B;**[!UICONTROL 保存]**。

![创建受众的步骤的录像。](../intelligent-re-engagement/images/create-an-audience.gif)

有关如何构建受众的更多信息，请参阅 [Audience Builder UI指南](/help/segmentation/ui/segment-builder.md).
