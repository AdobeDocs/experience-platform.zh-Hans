...
>[!IMPORTANT]
>
>为客户提供取消订阅接收品牌通信的能力是一项法律要求，同时这也是为了确保这一选择得到尊重。在 [Experience Platform 文档](https://experienceleague.adobe.com/docs/experience-platform/privacy/regulations/overview.html)中进一步了解适用的法规。

在创建重新接触路径时，应考虑以下同意政策：
...
### Adobe Journey Optimizer 中的历程设置

>[!NOTE]
>
>[!DNL Adobe Journey Optimizer] 不包含图中显示的所有内容。 所有付费媒体广告均在[!UICONTROL 目的地]中创建。
