...
![突出显示了select的“选择数据”对话框。](./images/user-defined-dashboards/select-a-table.png)
...
![用于从小部件中筛选值的筛选器对话框。](./images/user-defined-dashboards/filter-dialog.png)
...
![带有[!UICONTROL 最近日期]和[!UICONTROL 应用]的[!UICONTROL 筛选器： date_key]对话框突出显示。](./images/user-defined-dashboards/recent-date.png)
...
![带有单独日期复选框的[!UICONTROL 筛选器： date_key]对话框已选中和取消选中。](./images/user-defined-dashboards/select-dates.png)
...
![带有自定义小部件和突出显示“保存”按钮的用户定义仪表板。](./images/user-defined-dashboards/user-defined-dashboard.png)
...
![自定义仪表板中突出显示有椭圆和重复小部件的小组件。](./images/user-defined-dashboards/duplicate.png)
