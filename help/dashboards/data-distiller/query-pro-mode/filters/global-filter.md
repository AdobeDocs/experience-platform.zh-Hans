...
![[!UICONTROL 创建全局筛选器对话框]包含数据集下拉菜单、运行图标和突出显示的下一步。](../../../images/query-pro-mode/global-filter.png)
...
![[!UICONTROL 创建全局筛选器对话框]，其中的“选择”和“筛选器”标签文本输入突出显示。](../../../images/query-pro-mode/global-filter-label.png)
...
![带有全局筛选器切换的构件编辑器突出显示。](../../../images/query-pro-mode/global-filter-consent.png)
...
![突出显示筛选对话框的自定义仪表板。](../../../images/query-pro-mode/custom-filters.png)
