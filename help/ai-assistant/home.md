...
| 架构 | <ul><li>架构计数</li><li>创建/修改日期</li><li>架构类类型</li><li>架构 — 属性关系</li><li>架构 — 数据集关系</li><li>架构 — 受众关系</li><li>配置文件启用状态</li><li>名称查找</li><li>名称和ID查找</li></ul> | <ul><li>审核</li><li>创建/修改</li><li>创建者</li><li>字段组</li><li>标识</li><li>身份命名空间</li><li>标记</li><li>配置文件数</li></ul> |
