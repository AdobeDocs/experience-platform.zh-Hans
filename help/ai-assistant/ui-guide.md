...
要启动AI助手，请从Experience Platform UI的顶部标题中选择&#x200B;**[!UICONTROL AI Assistant icon]**。

![Experience Platform主页，选择AI助手图标并打开AI助手界面。](./images/ai-assistant-full-icon.png)

此时将显示AI Assistant界面，它立即为您提供开始使用的信息。 您可以使用[!UICONTROL Ideas to get started]下提供的选项来回答问题和命令，例如：
...
根据您的查询，AI Assistant会提供有关沙盒中数据的其他信息。 要查看查询的响应如何应用于您的特定沙盒，请选择&#x200B;**[!UICONTROL In your sandbox]。**
...
要查看引文并验证AI助理的响应，请选择&#x200B;**[!UICONTROL Show sources]**。
...
在收到操作分析问题的答案后，选择&#x200B;**[!UICONTROL Show sources]**，然后选择&#x200B;**[!UICONTROL View source query]**。
...
要重置，请选择AI Assistant界面上的省略号(**`...`**)，然后选择&#x200B;**[!UICONTROL Start new conversation]**。 这会告知AI助手，您打算更改主题，在对失败或引用不正确信息的查询进行故障诊断时尤其有用。
...
**注意**：默认情况下启用建议。 选择&#x200B;**[!UICONTROL Suggest ideas]**&#x200B;切换可禁用该功能。
