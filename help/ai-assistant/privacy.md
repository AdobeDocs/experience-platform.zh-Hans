...
* AI助手不知道消费者数据。
* AI助手将遵循所有现有的[访问控制](../access-control/home.md)策略。
   * 任何基于属性的新访问控制策略在最多24小时后反映在AI助手中*
* 必须向您授予显式权限才能与AI助手交互。
   * 您可以使用[权限UI](../access-control/abac/ui/permissions.md)为Experience Platform和Journey Optimizer设置不同的权限，也可以使用[Admin Console](../access-control/ui/browse.md)为Customer Journey Analytics分配权限。
...
**这意味着，如果向字段和对象添加任何新标签或创建任何新策略，则需要AI助手最多24小时才能遵循它们。 在这24小时内，新受限制访问的用户仍然可以访问这些字段和对象。*
