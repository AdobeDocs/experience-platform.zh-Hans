---
title: Adobe Experience Platform产品文档中的AI助手（旧版）
description: 开始使用Adobe Experience Platform中的AI助手（旧版）。
...
# Adobe Experience Platform产品文档中的AI助手（旧版）

Adobe Experience Platform中的AI助手（旧版）是一款对话工具，您可以使用Experience Platform应用程序和服务来加速您的工作流。 使用AI Assistant（旧版）提高您的整体工作效率，增强您对产品知识和运营见解的了解，并收集与查询和业务用例相关的建议。

AI助手（旧版）支持Experience Platform、Real-Time CDP、Adobe Journey Optimizer和Customer Journey Analytics。

## 快速入门

首先请阅读以下链接中的材料，以熟悉AI Assistant（旧版）的概念和功能。
...
大致了解AI助手（旧版）中的最新增强功能，包括当前处于Alpha或Beta阶段的功能。
...
您可以使用AI Assistant（旧版）来监控重大更改，并为受众和数据集大小提供增长预测。 然后，您可以使用此信息确保受众数据的完整性，并提供前瞻性预测以支持以数据为依据的决策。
...
您可以使用AI Assistant（旧版）的自然语言估计功能来估计受众规模并预测受众倾向，从而更轻松地访问有关受众的见解。
...
您可以使用AI助手（旧版）帮助发现Experience Data Model (XDM)字段，然后使用这些字段在Experience Platform中创建目标受众。
...
您可以使用AI助手（旧版）中的产品支持代理进行无缝故障排除，而无需离开您的工作流。 如果需要，支持管理员现在可以使用产品支持代理创建客户支持工单，以及您与AI助手（旧版）交互的上下文和会话详细信息。
...
浏览以下链接，以进一步了解AI Assistant（旧版）用例、功能等。
